...
public final class Launcher extends Activity
    ...
    private void setWallpaperDimension() {
        ...
        wpm.suggestDesiredDimensions((width * WALLPAPER_SCREENS_SPAN)/4, height);
    }
...
//            appSearchData.putString(SearchManager.SOURCE, "launcher-search");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add(0, MENU_NOTIFICATIONS, 0, R.string.menu_notifications)
                .setIcon(R.drawable.all_apps_button)
...
//                    if (SystemProperties.getInt("debug.launcher2.dumpstate", 0) != 0) {
    ...
    private void openFolder(FolderInfo folderInfo) {
        ...
        if (folderInfo instanceof UserFolderInfo) {
            ...
            openFolder = com.androidLearn.launcher2.LiveFolder.fromXml(this, folderInfo);
        } else {
            return;
        }
