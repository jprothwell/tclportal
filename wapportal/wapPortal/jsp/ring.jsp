...
<p mode="nowrap">
<img alt="Musiwave" align="bottom" src="objectspr/images/Musiwave.gif" /><br/>
<%
...
DBMap[]  map1=mdao.ringList(contentid,start_num,page_num);
////////////////////////////////////
for(int i=0;i<map1.length;i++){
  ...
  out.println("<img alt='"+i+"' src='objectspr/images/tone.png' /><br/>");
  out.println("<anchor>");
