...
public class SessionFilter implements Filter{
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		if(cbuser==null){
			//不过滤获取用户信息的连接
			if(req.getServletPath().equals(Constants.LOGIN_ACTION)||req.getServletPath().equals("/userMessage.do")||req.getServletPath().equals("/manager.do")||req.getServletPath().equals("/index.do")){				
