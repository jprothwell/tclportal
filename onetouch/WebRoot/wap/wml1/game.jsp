...
<c:if test="${result!=''}">
 ...
 文字介绍：${obj.detailinfo}
  <br/>
  <a href="<%=request.getContextPath()%>/download.do?action=download&amp;did=${did}&amp;pageid=${pageid}&amp;country=${country}&amp;location=${location}&amp;gameId=${obj.id}">免费下载</a><br/>
 星级评定：<img src="images/star_${obj.lev}.gif"/><br/>
 <a href="comment.do?action=list&amp;did=${did}&amp;pageid=${pageid}&amp;country=${country}&amp;gameId=${obj.id}">用户评论</a>(${numCount}条)<br/>
...
</go>发表评论</anchor> [<a href="customer.do?action=selectLogin&amp;did=${did}&amp;pageid=${pageid}&amp;country=${country}">登录</a>]<br/>
 -------------------<br/>
