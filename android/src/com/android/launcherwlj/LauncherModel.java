...
public class LauncherModel extends BroadcastReceiver {
    ...
    static void addOrMoveItemInDatabase(Context context, ItemInfo item, long container,
        ...
        if (item.container == ItemInfo.NO_ID) {
        	Log.d(TAG,"addOrMoveItemInDatabase..");
            // From all apps
            addItemToDatabase(context, item, container, screen, cellX, cellY, false);
        } else {
        	Log.d(TAG,"addOrMoveItemInDatabase..false");
            // From somewhere else
    ...
    static void moveItemInDatabase(Context context, ItemInfo item, long container, int screen,
        ...
        item.cellX = cellX;
        item.cellY = cellY;
        Log.d(TAG,"moveItemInDatabase..false");
    ...
    static void deleteUserFolderContentsFromDatabase(Context context, UserFolderInfo info) {
    	Log.d(TAG,"deleteUserFolderContentsFromDatabase..");
        final ContentResolver cr = context.getContentResolver();
    ...
    private class LoaderTask implements Runnable {
        ...
        private void loadAndBindWorkspace() {
        	Log.d(TAG,"loadAndBindWorkspace..");
            // Load the workspace
