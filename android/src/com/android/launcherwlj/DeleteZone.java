...
/*	
        ...
        //拖曳应用程序的图标时将热键中的中间的ICON换成垃圾回收站ICON
        ImageView mhotseat_center = (ImageView)mHandle.findViewById(R.id.all_apps_button);
	    mhotseat_center.setImageResource(R.drawable.delete_zone_selector);
    ...
    public void onDragEnd() {
      ...
      //wisky@wanglijuan20110624
	//拖曳结束时将热键中的中间的ICON换回主菜单ICON
       ImageView mhotseat_center = (ImageView)mHandle.findViewById(R.id.all_apps_button);
       mhotseat_center.setImageResource(R.drawable.all_apps_button);
     //end wisky@wanglijuan20110624
    }
