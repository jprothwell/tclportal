...
DBMap[]  map1=mdao.imageList(contentid,start_num,page_num);
////////////////////////////////////
for(int i=0;i<map1.length;i++){
  urlName="main?action=download&amp;groupid="+groupid;
  urlName=urlName+"&amp;spname=TCL";
  urlName=urlName+"&amp;resourcename="+map1[i].get("name");
  urlName=urlName+"&amp;urlname=objectsdw/"+map1[i].get("file2");
  out.println("<img  src='objectsdw/"+map1[i].get("file1")+"' /><br/>");
  out.println("<anchor>");
