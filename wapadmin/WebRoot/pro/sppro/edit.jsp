...
<%@ page import="cn.ta.wap.db.dao.*"%>
<%@ page import="cn.ta.wap.db.*"%>
...
<input type="checkbox" name="role" value="2" <%if(tick2==1)out.print("checked");%>>游戏统计<br>
<input type="checkbox" name="role" value="3" <%if(tick3==1)out.print("checked");%>>图片统计<br>
<input type="checkbox" name="role" value="4" <%if(tick4==1)out.print("checked");%>>栏目统计<br>
<input type="checkbox" name="role" value="5" <%if(tick5==1)out.print("checked");%>>国家统计<br>
<input type="checkbox" name="role" value="6" <%if(tick6==1)out.print("checked");%>>系统管理
</td>
</tr>
<tr>
<td>&nbsp;</td>
