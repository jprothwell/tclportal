...
function fChangeDateFormat(iYear, iMonth, iDay) { 

var MonthDisp = new Array("一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"); 

var newDateFormatStr = ""; 

if ((iYear > 0) && (iMonth > 0) && (iDay > 0)) { 

newDateFormatStr = iYear + " 年 " + MonthDisp[iMonth - 1] + " " + iDay; 
...
//gdCtrl.value = fChangeDateFormat(iYear, iMonth, iDay); 

}else{ 

gdCtrl.innerText = fChangeDateFormat(iYear, iMonth, iDay); 
...
write("<table width='200' border='0' bgcolor='#cccccc'>"); 
...
write("<B style='cursor:hand' onclick='fSetDate(giYear,giMonth,giDay)' onMouseOver='this.style.color=gcToggle' onMouseOut='this.style.color=0'>今天: " + fChangeDateFormat(giYear, giMonth, giDay) + "</B>"); 
