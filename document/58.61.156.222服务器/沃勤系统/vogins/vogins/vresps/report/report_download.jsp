	...
	<tr>
		...
		<b><%=LangPage.langPage.getSearch("search_conditions")%></b><br/><%=LangPage.langPage.getSearch("search_mf")%>&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" class="input_edit"  name="SelMFText" readonly>
			...
			&nbsp;&nbsp;&nbsp;&nbsp;<%=LangPage.langPage.getSearch("search_mobile")%><input type="text" class="input_edit"  name="SelMobileText" readonly>
		     ...
		     <br/><%=LangPage.langPage.getSearch("search_cp")%><input type="text" class="input_edit"  name="SelCPText" readonly>
			...
			&nbsp;&nbsp;&nbsp;&nbsp;<%=LangPage.langPage.getSearch("search_app")%><input type="text" class="input_edit"  name="SelAppText" readonly>
		     ...
		     <br/><%=LangPage.langPage.getSearch("search_startdate")%>&nbsp;&nbsp;&nbsp;&nbsp;<input class="input_edit" type="text" name="StartDate" style="width:80;" value="">&nbsp;<a href="#" onclick="LtCalendar.create('StartDate',68,165);"><img src="../buttons/point_001.gif" width="18" height="18" border="0" align="top" vspace="1" /></a>
			&nbsp;&nbsp;<%=LangPage.langPage.getSearch("search_enddate")%><input class="input_edit" type="text" name="EndDate" style="width:80;" value="">&nbsp;<a href="#" onclick="LtCalendar.create('EndDate',68,345);"><img src="../buttons/point_001.gif" width="18" height="18" border="0" align="top" vspace="1" /></a><br>
			<%=LangPage.langPage.getSearch("search_type")%>&nbsp;&nbsp;&nbsp;&nbsp;<select name="reporttype"><option value="1"><%=LangPage.langPage.getSearch("search_bycp")%></option><option value="2"><%=LangPage.langPage.getSearch("search_byapp")%></option><option value="3"><%=LangPage.langPage.getSearch("search_bymobile")%></option></select>
