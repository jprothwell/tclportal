...
<body onload="init();">
	...
	<tr>
		<td valign="middle" style="font-size:9pt;color:#4796ee;">
			...
			<b><%=LangPage.langPage.getSearch("search_conditions")%></b><br/><%=LangPage.langPage.getSearch("search_cp")%><input type="text" class="input_edit"  name="SelCPText" readonly>
			...
			<%=LangPage.langPage.getSearch("search_type")%>&nbsp;&nbsp;&nbsp;&nbsp;<select name="reporttype"><option value="3"><%=LangPage.langPage.getSearch("search_bycp")%></option><option value="4"><%=LangPage.langPage.getSearch("search_byapp")%></option></select>
