	...
	if(strEdit.equals("1"))
	{
		...
		if(folderName.equals("")){
			...
			if(!myContentFile.isMissing())
			{
				...
				if(level<=0){
					RecommendDefFolder subs[] = more.getSubFolder(parentId);
					if(subs.length<20){
	...
	<table id="tb_new" class="table_edit" cellpadding="0" cellspacing="0" align="center">
		<tr>
			<td>
				...
				<form method="POST" action="newRecommendDef.jsp?ParentId=<%=parentId%>&edit=1" name="NewForm" ENCTYPE="multipart/form-data">
					<tr>
