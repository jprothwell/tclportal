...
<% 
	...
	if(strEdit.equals("1"))
	{
		...
		freeApp = myRequest.getParameter("FreeApp");
		...
		if(freeApp == null || freeApp.equals("")) freeApp = "1";
		...
		if(appId.equals("")){
			...
			if(packVersion.equals("3.0") || packVersion.equals("3.4") || packVersion.equals("AS3.0")){
				tagInfo.setAppNameBig5(appNameBig5);
				tagInfo.setAppNameEn(appNameEn);
				tagInfo.setBgRun(bgRun);
//				tagInfo.setFreeAppFlag(freeApp);
...
<TITLE><%=LangPage.langPage.getPageTitle("apppack")%></TITLE>
	...
	<script language=javascript>
		...
		function showForm(){
			...
			}else if(document.all["PackageVersion"].value == "3.4"){
				document.all["div_form"].innerHTML = app34HTML;
		...
		function init(){
			app34HTML = document.all["form_app_34"].innerHTML;
			document.all["form_app_34"].innerHTML = "";
...
<body onload="init();">
					...
					<tr>
						<td colspan="4" class="td_detailcontent1" style="color:red;">
							选择打包版本：<select name="PackageVersion" onchange="showForm();">
								<option<%if(packVersion.equals("3.4")){%> selected<%}%> value="3.4">App 3.4</option>
	...
	<div align="center" id="form_app_34" class="datainfo">
	<table id="tb_new" class="table_edit" cellpadding="0" cellspacing="0" align="center">
		<tr>
			<td>
				<table class="table_detaillist" cellpadding="0" cellspacing="1" align="center">
				<form method="POST" action="pack.jsp?edit=1" name="NewForm" ENCTYPE="multipart/form-data">
					<tr>
						...
						<td class="td_detailcontent0">
							<input type="hidden" name="PackVersion" value="3.4">
					...
					<tr>
						...
						<td width="35%" class="td_detailcontent0" width="200">
							<select name="Memery">
								<option<%if(memery.equals("50")){%> selected<%}%> value="50">50K</option>
								<option<%if(memery.equals("100")){%> selected<%}%> value="100">100K</option>
								<option<%if(memery.equals("150")){%> selected<%}%> value="150">150K</option>
								...
								<option<%if(memery.equals("2048")){%> selected<%}%> value="2048">2M</option>
					...
					<tr>
						<td class="td_detailcontent1" align="center">免费标志</td>
						<td  class="td_detailcontent0">
							<input class="input_edit" style="width:100%;" onkeydown="enterUnsigned();" type="text" name="FreeApp" value="<%=freeApp%>">
						</td>
						<td class="td_detailcontent1" align="center"></td>
						<td class="td_detailcontent0">
						</td>
					</tr>
					<tr>
