...
<head>
	...
	<TITLE><%=LangPage.langPage.getPageTitle("cp_dld")%></TITLE>
	...
	<!-----------------------显示汇总结果--------------------------->
	function showReport(){
		listPageURL.put('reportlist','../CPReport_Dld.do?'+getP(SearchForm)+'&index=#index#');
...
<body onload="init();">
	...
	<tr>
		<td class="td_pagetitle" valign="middle"><%=LangPage.langPage.getPageTitle("cp_dld")%></td>
	</tr>
	</table>
	...
	<tr>
		<td valign="middle" style="font-size:9pt;color:#4796ee;">
			...
			<b><%=LangPage.langPage.getSearch("search_conditions")%></b><%=LangPage.langPage.getSearch("search_app")%><select name="SelApp"><option value="0"><%=LangPage.langPage.getSelect("status_all")%></option></select><br>
			<b>　　　　　</b><%=LangPage.langPage.getSearch("search_startdate")%><input class="input_edit" type="text" name="StartDate" style="width:80;" value="" readonly>&nbsp;<a href="#" onclick="LtCalendar.create('StartDate',68,165);"><img src="../buttons/point_001.gif" width="18" height="18" border="0" align="top" vspace="1" /></a>
			&nbsp;&nbsp;<%=LangPage.langPage.getSearch("search_enddate")%><input class="input_edit" type="text" name="EndDate" style="width:80;" value="" readonly>&nbsp;<a href="#" onclick="LtCalendar.create('EndDate',68,345);"><img src="../buttons/point_001.gif" width="18" height="18" border="0" align="top" vspace="1" /></a>
