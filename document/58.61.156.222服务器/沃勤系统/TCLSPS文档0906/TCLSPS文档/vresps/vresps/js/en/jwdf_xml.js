...
function checkL(cartXML,cb,area){
	...
	if(code=="9"){
		alert("No login or timeout,Please login!");
...
function showWaiting(){
	...
	if((window.location.href.indexOf('/login.jsp')>0) || (window.location.href.indexOf('/index.jsp')>0)){
		strInfo = "<table style='color:red;font-size:9pt;'><tr><td><img src='images/jwdf-loader.gif'></img></td><td>Please Wait...</td></tr></table>";
	}else{
		strInfo = "<table style='color:red;font-size:9pt;'><tr><td><img src='../images/jwdf-loader.gif'></img></td><td>Please Wait...</td></tr></table>";
	}
