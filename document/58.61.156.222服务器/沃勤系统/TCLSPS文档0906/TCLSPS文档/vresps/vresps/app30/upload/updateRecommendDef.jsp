...
<%@ page import="com.vogins.sps.db.app30.RecommendDefFolder"%>
<%@ page import="com.vogins.sps.util.StringUtil"%>
<%@ page import="java.io.File"%>
<%@ page import="com.jspsmart.upload.*"%>
<jsp:useBean id="mySmartUpload" scope="page" class="com.jspsmart.upload.SmartUpload" />
<%
	RecommendDefFolder rec = new RecommendDefFolder();
	...
	else if(strEdit.equals("1"))
	{
		...
		if(folderName.equals("")){
			...
			if(!myContentFile.isMissing())
			{
				...
				RecommendDefFolder more = new RecommendDefFolder();
		...
		RecommendDefFolder mfolder = new RecommendDefFolder();
...
<head>
<TITLE><%=LangPage.langPage.getPageTitle("updateRecommend")%></TITLE>
	...
	<table id="tb_new" class="table_edit" cellpadding="0" cellspacing="0" align="center">
		<tr>
			<td>
				...
				<form method="POST" action="updateRecommendDef.jsp?FolderId=<%=folderId%>&edit=1" name="NewForm" ENCTYPE="multipart/form-data">
					<tr>
						<td height="20" colspan="1" bgcolor="#8acef5"><b><%=LangPage.langPage.getPageTitle("updateRecommend")%></b></td>
