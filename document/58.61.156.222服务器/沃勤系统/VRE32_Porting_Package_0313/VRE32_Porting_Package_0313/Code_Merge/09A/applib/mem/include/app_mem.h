...
/* Vogins Start */
#ifdef __VRE__
    APPLIB_MEM_AP_ID_VRE,
    APPLIB_MEM_AP_ID_VRE_APP1,
    APPLIB_MEM_AP_ID_VRE_APP2,
    APPLIB_MEM_AP_ID_VRE_APP3,
    APPLIB_MEM_AP_ID_VRE_APP4,
    APPLIB_MEM_AP_ID_VRE_APP5,
    APPLIB_MEM_AP_ID_VRE_APP6,
    APPLIB_MEM_AP_ID_VRE_APP7,
    APPLIB_MEM_AP_ID_VRE_APP8,
    APPLIB_MEM_AP_ID_VRE_APP9,
    APPLIB_MEM_AP_ID_VRE_APP10,
    APPLIB_MEM_AP_ID_VRE_APP11,
    APPLIB_MEM_AP_ID_VRE_APP12,
    APPLIB_MEM_AP_ID_VRE_APP13,
    APPLIB_MEM_AP_ID_VRE_APP14,
    APPLIB_MEM_AP_ID_VRE_APP15,
    APPLIB_MEM_AP_ID_VRE_APP16,
#endif
#ifdef __VRE30_AM__
    APPLIB_MEM_AP_ID_AM,
#endif
...
#define applib_mem_ap_alloc(app_id, mem_size) applib_mem_ap_alloc_int(app_id, mem_size, KAL_FALSE, __LINE__)
#define applib_mem_ap_alloc_framebuffer(app_id, mem_size) applib_mem_ap_alloc_int(app_id, mem_size, KAL_TRUE, __LINE__)
...
#define applib_mem_ap_free(mem_ptr) applib_mem_ap_free_thread_safe(mem_ptr, __LINE__);
...
/* alloc/free */
extern void *applib_mem_ap_alloc_int(kal_uint32 app_id, kal_uint32 mem_size, kal_bool is_framebuffer, kal_uint32 line);
extern void *applib_mem_ap_alloc_full_pool_int(kal_uint32 app_id, kal_uint32 *pool_size, kal_uint32 line);
extern void applib_mem_ap_free_thread_safe(void *mem_ptr, kal_uint32 line);
