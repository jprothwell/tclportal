...
mmi_dtcnt_deletion_notify_registration_struct g_mmi_dtcnt_del_registration[CBM_MAX_BEARER_LIST_NUM];
U8 g_mmi_dtcnt_deletion_registration_num;
...
static void mmi_dtcnt_deletion_registration_by_primitive(void *info, int mod_id, void *peer_buf);
static void mmi_dtcnt_send_acct_deletion_notification(U8 app_id, U32 reg_acct_id, dtcnt_list_bearer_enum bearer_type, module_type mod_id);
MMI_BOOL mmi_dtcnt_get_deletion_notify_callback(U32 ori_acct_id, U8 *app_id, U32 *reg_acct_id, FuncPtrDtcntDeletion *p_callback, U8 index);
dtcnt_deletion_registration_error_enum mmi_dtcnt_add_del_to_deletion_registration_primitive(U8 app_id,U32 desired_acct_id, module_type mod_id, U8 register_flag);
MMI_BOOL mmi_dtcnt_get_deletion_notify_primitive(U32 ori_acct_id, U8 *app_id, U32 *reg_acct_id, module_type *mod_id, U8 index);

void mmi_dtcnt_rectify_GSM_account_buffer(void);

static void mmi_dtcnt_list_callback_csd(U32 index);
void mmi_dtcnt_send_register_deletion_notification_cnf(U8 app_id, U32 reg_acct_id, U8 register_flag, module_type mod_id, MMI_BOOL register_result);
void mmi_dtcnt_delete_notify(dtcnt_list_bearer_enum bearer_type, U8 disp_index);

#ifdef __MMI_GPRS_FEATURES__
static void mmi_dtcnt_list_callback_gprs(U32 index);
void mmi_dtcnt_GPRS_exit_add_account(void);
void mmi_dtcnt_rectify_GPRS_account_buffer(void);
void mmi_dtcnt_add_GPRS_account(void);
void mmi_dtcnt_add_GPRS_account_confirm(void);
...
void mmi_dtcnt_delete_pre_acct_selection_screen(void);
...
static void mmi_dtcnt_entry_second_account_bearer_list(FuncPtrU32 callback, 
                                                        U16 AppMenuID, 
                                                        U8 bearers, 
...
void mmi_dtcnt_entry_account_bearer_list(void);
void mmi_dtcnt_entry_account_bearer_list_with_option(void);
void mmi_dtcnt_entry_account_bearer_list_with_option_CBM(void);
U16 mmi_dtcnt_is_sim_valid(void);
U32 mmi_dtcnt_get_ori_acct_id(U32 index_id, dtcnt_list_bearer_enum bearer_type);
...
U8 g_set_by_project_mode;
#ifdef __MMI_GPRS_FEATURES__
FuncPtrSetRsp g_set_GPRS_callback;
#endif
...
extern MMI_BOOL mmi_idle_is_main_menu(void);

/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_pre_entry_app_csd_list_with_UCM_check
 * DESCRIPTION
 *  
 * PARAMETERS
 *  void
 ...
 *  void
 *****************************************************************************/
void mmi_dtcnt_pre_entry_app_csd_list_with_UCM_check(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    DataAccountReadyCheck(EntryAppDTCNTListUCM);
}
...
U32 mmi_dtcnt_get_dcd_acct_id(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    return custom_get_dcd_profile_id();
}
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_pre_entry_app_gprs_list_with_UCM_check
 * DESCRIPTION
 *  
 * PARAMETERS
 *  void
 ...
 *  void
 *****************************************************************************/
void mmi_dtcnt_pre_entry_app_gprs_list_with_UCM_check(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
	DataAccountReadyCheck(EntryGPRSAppDTCNTListUCM);
}
...
void mmi_dtcnt_always_ask_wlan_select_ext(void)
{
    ...
    mmi_display_popup((UI_string_type) GetString(STR_GLOBAL_NOT_SUPPORT_AT_PC_SIMULATOR), MMI_EVENT_FAILURE);
    return;
	...
	if (g_mmi_dtcnt_always_ask.app_callback_ext)
    {
        ...
        {/* block connection initiated by always-ask if previous connection is suspending */
            ...
            mmi_display_popup((UI_string_type) GetString(STR_GLOBAL_BUSY_TRY_LATER), MMI_EVENT_FAILURE);
        }
        else
        {
...
#endif
 #ifdef __MMI_GPRS_FEATURES__
    {DATA_ACCOUNT_BEARER_GPRS, ABM_E_SOCKET_BEARER_GSM_GPRS, STR_GLOBAL_GPRS,
     mmi_dtcnt_pre_entry_app_gprs_list},
 #endif /* __MMI_GPRS_FEATURES__ */ 
 #ifdef __MMI_WLAN_FEATURES__
    {DATA_ACCOUNT_BEARER_WIFI, ABM_E_SOCKET_BEARER_WIFI, SERVICES_DATA_CONNECT_WLAN_STRING_ID,
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_get_gprs_display_index
 * DESCRIPTION
 *  
 * PARAMETERS
 *  ori_acct_id      [IN]        
 ...
 *  U8
 *****************************************************************************/
U8 mmi_dtcnt_get_GPRS_display_index(U32 ori_acct_id)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    {
    	if (ori_acct_id == g_GPRS_DataAccount[i].org_acct_id)
    	{
    		return i;
    	}
    }
    return g_DataAccount_Display.GPRS_acct_num < MAX_DATA_ACCOUNT_GPRS_LIMIT ? g_DataAccount_Display.GPRS_acct_num : MAX_DATA_ACCOUNT_GPRS_LIMIT;
#else
    return 0;
#endif
}
    ...
    if (abm_nw2bearer_id(account_id, &bearer, &id) == KAL_TRUE)
    {
        if(bearer == ABM_E_SOCKET_BEARER_GSM_GPRS)
        {
            for(i = 0; i < g_DataAccount_Display.GPRS_acct_num; i++)
            {
            	...
            	{
                    mmi_ucs2ncpy(dest, (S8*) g_GPRS_DataAccount[i].APN, length_str);
                    return TRUE;
            	}
            }
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_get_CSD_display_index
 * DESCRIPTION
 *  
 * PARAMETERS
 *  ori_acct_id      [IN]        
 ...
 *  U8
 *****************************************************************************/
U8 mmi_dtcnt_get_CSD_display_index(U32 ori_acct_id)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    for(i = 0; i < g_DataAccount_Display.GSM_acct_num; i++)
    {
    	if (ori_acct_id == g_DataAccount[i].org_acct_id)
    	{
            return i;
    	}
    }
    return g_DataAccount_Display.GSM_acct_num < MAX_DATA_ACCOUNT_GSM_LIMIT ? g_DataAccount_Display.GSM_acct_num : MAX_DATA_ACCOUNT_GSM_LIMIT;
...
BOOL mmi_dtcnt_get_csd_number(U32 account_id, S8 *dest, U8 len)
{
    ...
    if (abm_nw2bearer_id(account_id, &bearer, &id) == KAL_TRUE)
    {
        if(bearer == ABM_E_SOCKET_BEARER_GSM_CSD)
        {
            for(i = 0; i < g_DataAccount_Display.GSM_acct_num; i++)
            {
            	if (id == g_DataAccount[i].org_acct_id)
            	{
                    mmi_ucs2ncpy(dest, (S8*) g_DataAccount[i].DialNumber, length);
                    return TRUE;
...
BOOL mmi_dtcnt_get_account_name(U32 account_id, S8 *dest, U8 len)
{
...
#endif /* __MMI_CBM_BEARER_FALLBACK__ */
    {
    ...
    #ifdef __MMI_CBM_ALWAYS_ASK__
        else if(cbm_is_always_ask_account(account_id))
        {
        ...
        {
            account_id = cbm_get_original_account(account_id);
                ...
                switch (bearer)
                {
                    case ABM_E_SOCKET_BEARER_GSM_CSD:
                        for(i = 0; i < g_DataAccount_Display.GSM_acct_num; i++)
                        {
                            if (id == g_DataAccount[i].org_acct_id)
                            {
                                mmi_ucs2ncpy(dest, (S8*) g_DataAccount[i].DataAccountName, length);
                                break;
                            }
                        }
                        if (i == g_DataAccount_Display.GSM_acct_num)
                        {
                            mmi_ucs2cpy((S8*)dest, (S8*)L"");
                            ret_val = FALSE;
                        }
                    ...
                    case ABM_E_SOCKET_BEARER_GSM_GPRS:
                        for(i = 0; i < g_DataAccount_Display.GPRS_acct_num; i++)
                        {
                            if (id - 1 == g_GPRS_DataAccount[i].org_acct_id)
                            {
                                mmi_ucs2ncpy(dest, (S8*) g_GPRS_DataAccount[i].DataAccountName, length);
                                break;
                            }
                        }
                        if (i == g_DataAccount_Display.GPRS_acct_num)
                        {
                            mmi_ucs2cpy((S8*)dest, (S8*)L"");
                            ret_val = FALSE;
                        }
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_get_account_name_ext
 * DESCRIPTION
 *  Display bearers info included within a data-account ID.
 * PARAMETERS
 *  account_id      [IN]        
...
MMI_BOOL mmi_dtcnt_get_account_name_ext(U32 account_id, S8 *dest, U8 len)
{
    /*----------------------------------------------------------------*/
    /* Local Variables												  */
    /*----------------------------------------------------------------*/
    kal_uint8 primary_acct_id, secondary_acct_id;
    kal_int8 ret_val;
	MMI_BOOL return_value = MMI_FALSE;

    cbm_account_info_struct acct_info;
	S8 temp[3 * ENCODING_LENGTH];
    S8 secondary_acct_name[(MAX_DATA_ACCOUNT_NAME_LEN + 1) * ENCODING_LENGTH] = {0};
    ...
    ret_val = cbm_decode_data_account_id_ext(account_id, &acct_info);

    if (CBM_OK == ret_val)
    {
        primary_acct_id = cbm_encode_data_account_id(acct_info.account[0].account_id, acct_info.account[0].sim_id, 0, acct_info.account[0].is_always_ask);
		secondary_acct_id = cbm_encode_data_account_id(acct_info.account[1].account_id, acct_info.account[1].sim_id, 0, acct_info.account[1].is_always_ask);
        if (acct_info.acct_num == 1)
        {
            return_value = mmi_dtcnt_get_account_name(account_id, dest, len);
			return return_value;
        }
		else if (acct_info.acct_num > 1)
        {
            return_value = mmi_dtcnt_get_single_account_name((U32)primary_acct_id, dest, len / 2);
			if (!return_value)
                return return_value;
			mmi_asc_to_ucs2((S8*) temp, "/");
			
            mmi_ucs2cat(dest, temp);
			return_value = mmi_dtcnt_get_single_account_name((U32)secondary_acct_id, secondary_acct_name, len / 2);
            if (!return_value)
                return return_value;

			mmi_ucs2cat(dest, secondary_acct_name);
            return MMI_TRUE;
        }
        else if (acct_info.acct_num == 0)
        {
            mmi_dtcnt_get_account_name(account_id, dest, len);
            return MMI_TRUE;
        }
...
BOOL mmi_dtcnt_get_single_account_name(U32 account_id, S8 *dest, U8 len)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    ori_id = cbm_get_original_account(account_id);
    is_always_ask = cbm_is_always_ask_account(account_id);
    sim_id = cbm_get_sim_id(account_id);
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_entry_account_bearer_list
 * DESCRIPTION
...
void mmi_dtcnt_entry_account_bearer_list(void)
{
    ...
    EntryNewScreen(SCR_ID_DTCNT_MAIN, NULL, mmi_dtcnt_entry_account_bearer_list, NULL);
    ...
    for (i = 0; g_dtcnt_selections[i].bearer > 0; i++)
    {
        ...
        {
#ifdef __MMI_DUAL_SIM__
            if((g_dtcnt_selections[i].bearer == DATA_ACCOUNT_SIM1) && ((MTPNP_AD_Get_UsableSide() != MTPNP_AD_SIMCARD1_USABLE) && 
                                                                        (MTPNP_AD_Get_UsableSide() != MTPNP_AD_DUALSIM_USABLE)))
            {
            	continue;
            }
            if((g_dtcnt_selections[i].bearer == DATA_ACCOUNT_SIM2) && ((MTPNP_AD_Get_UsableSide() != MTPNP_AD_SIMCARD2_USABLE) && 
                                                                       (MTPNP_AD_Get_UsableSide() != MTPNP_AD_DUALSIM_USABLE)))
            {
            	continue;
            }
...
void InitDataAccountApp(void)
{
    ...
    for (i = 0; i < MAX_INLINE_ITEM_DATA_ACCOUNT_LIST; i++)
    {
        if (i % 2)
        {
            g_DataAccount_Display.IconList[i] = 0;
        }
        else
        {
...
#else
            g_DataAccount_Display.IconList[i] = IMG_GLOBAL_L1 + ImageLocation;
#endif
...
#ifndef __LOW_COST_SUPPORT_COMMON__
    g_DataAccount_Display.IconList[MAX_INLINE_ITEM_DATA_ACCOUNT_LIST - 2] = IMG_ID_DTCNT_DNS_ADDRESS;
#endif
...
/* under construction !*/
    ...
    for (i = 0; i < MAX_INLINE_ITEM_GPRSDATA_ACCOUNT_LIST; i++)
    {
        if (i % 2)
        {
            g_DataAccount_Display.GPRSIconList[i] = 0;
        }
        else
        {
#ifndef __LOW_COST_SUPPORT_COMMON__
            g_DataAccount_Display.GPRSIconList[i] = IMG_ID_DTCNT_GPRS_AC_NAME + ImageLocation;
#else
            g_DataAccount_Display.GPRSIconList[i] = IMG_GLOBAL_L1 + ImageLocation;
#endif
            ImageLocation++;
        }
    }
#ifndef __LOW_COST_SUPPORT_COMMON__
	g_DataAccount_Display.GPRSIconList[MAX_INLINE_ITEM_GPRSDATA_ACCOUNT_LIST - 2] = IMG_ID_DTCNT_DNS_ADDRESS;
	g_DataAccount_Display.GPRSIconList[MAX_INLINE_ITEM_GPRSDATA_ACCOUNT_LIST - 4] = IMG_ID_DTCNT_DNS_ADDRESS;
#endif
    ...
    SetProtocolEventHandler((PsFuncPtr)mmi_dtcnt_deletion_registration_by_primitive, MSG_ID_MMI_DTCNT_REGISTER_DELETION_NOTIFY_REQ);
}
 ...
 *  void
 *****************************************************************************/
void mmi_dtcnt_ready_check_on_background_new(FuncPtr ready_callback)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
#endif /* __MMI_CBM_CONNECTION_MANAGER__ */
    EntryNewScreen(SCR_ID_DTCNT_DUMMY, NULL, NULL, NULL);
 ...
 *  void
 *****************************************************************************/
void DataAccountReadyCheckNew(FuncPtr ready_callback)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    mmi_dtcnt_ready_check_on_background_new(ready_callback);
}
...
void mmi_dtcnt_always_ask_entry_csd_list(void)
{
    ...
    if (g_DataAccount_Display.GSM_acct_num)
    {
        ShowCategory53Screen(
            ...
            STR_GLOBAL_BACK,
            IMG_GLOBAL_BACK,
            g_DataAccount_Display.GSM_acct_num,
            (U8 **) DataAccountName,
...
void mmi_dtcnt_always_ask_csd_list_select_ok(void)
{
    ...
    if (g_mmi_dtcnt_always_ask.app_callback_ext)
    {
        ...
        abm_bearer2nw_id(ABM_E_SOCKET_BEARER_GSM_CSD, g_DataAccount[g_mmi_dtcnt_always_ask.CurrAASelectItem].org_acct_id, &id);
 ...
 *  void
 *****************************************************************************/
void EntryAppDTCNTListUCM(void)

{
    ...
    else
    {
        ...
        currHistory.scrnID = SCR_ID_DTCNT_LIST;
        currHistory.entryFuncPtr = EntryAppDTCNTList;
...
static void mmi_dtcnt_list_go_back_gprs(void)
{
    ...
    if(g_dtcnt_list_cnt.switch_bearer_flag) 
    {
        DeleteScreenIfPresent(SCR_ID_DTCNT_LIST_CONFIRM);
#ifdef __MMI_GPRS_FEATURES__
        mmi_dtcnt_list_by_app_confirm(STR_ID_DTCNT_SELECT_GPRS, mmi_dtcnt_list_by_app_confirm_gprs/*mmi_dtcnt_list_back_handler*/);
#endif /* __MMI_GPRS_FEATURES__ */
    }
    else
    {
...
void AppDTCNTSelectOK(void)
{
    ...
    if (g_mmi_dtcnt_account_selection.app_callback)
    {
        ...
        abm_bearer2nw_id(ABM_E_SOCKET_BEARER_GSM_CSD, g_DataAccount[g_mmi_dtcnt_account_selection.CurrAppSelectItem].org_acct_id, &id);
...
void EntryDTCNTList(void)
{
    ...
    EntryNewScreen(SCR_ID_DTCNT_EDIT_LIST, NULL, EntryDTCNTList, NULL);

    if (g_DataAccount_Display.profile_setted)
    {
        guiBuffer = NULL;
        g_DataAccount_Display.profile_setted = 0;
    }
    else
    {
        guiBuffer = GetCurrGuiBuffer(SCR_ID_DTCNT_EDIT_LIST);
    }
    ...
    SetLeftSoftkeyFunction(mmi_dtcnt_entry_GSM_option, KEY_EVENT_UP);
    SetKeyHandler(mmi_dtcnt_entry_GSM_option, KEY_RIGHT_ARROW, KEY_EVENT_DOWN);

    SetRightSoftkeyFunction(GoBackHistory, KEY_EVENT_UP);
    SetKeyHandler(GoBackHistory, KEY_LEFT_ARROW, KEY_EVENT_DOWN);

    SetDelScrnIDCallbackHandler(SCR_ID_DTCNT_EDIT_LIST, mmi_dtcnt_exit_list_hdlr);
}
 ...
 *  void
 *****************************************************************************/
void mmi_dtcnt_exit_add_account(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    CloseCategory57Screen();
    h.scrnID = SCR_ID_DTCNT_EDIT;
    h.entryFuncPtr = mmi_dtcnt_entry_add_account;
    GetCategoryHistory(h.guiBuffer);
    inputBufferSize = (U16) GetCategory57DataSize();
    GetCategory57Data((U8*) h.inputBuffer);
    AddNHistory(h, inputBufferSize);
...
void InitInLineDataAccount(void)
{
    ...
    ReturnThreeDigitString(g_DataAccount_Display.IP5, g_DataAccount[i].ViceDnsAddress[0]);
    ReturnThreeDigitString(g_DataAccount_Display.IP6, g_DataAccount[i].ViceDnsAddress[1]);
    ReturnThreeDigitString(g_DataAccount_Display.IP7, g_DataAccount[i].ViceDnsAddress[2]);
    ReturnThreeDigitString(g_DataAccount_Display.IP8, g_DataAccount[i].ViceDnsAddress[3]);
...
void DataAccountFillInlineStruct(void)
{
    ...
    if (!g_DataAccount_Display.readonly)
    {
        ...
        SetInlineItemActivation((wgui_inline_items + DATA_ACCOUNT_DNS_ADDRESS1), INLINE_ITEM_ACTIVATE_WITHOUT_KEY_EVENT, 0);
        SetInlineItemActivation((wgui_inline_items + DATA_ACCOUNT_DNS_ADDRESS2), INLINE_ITEM_ACTIVATE_WITHOUT_KEY_EVENT, 0);
    ...
    SetInlineItemCaption((wgui_inline_items + DATA_ACCOUNT_USER_NAME_STR), (U8*) GetString(STR_GLOBAL_USERNAME));
    SetInlineItemCaption((wgui_inline_items + DATA_ACCOUNT_PASSWD_STR), (U8*) GetString(STR_GLOBAL_PASSWORD));
    ...
    SetInlineItemCaption((wgui_inline_items + DATA_ACCOUNT_DNS_ADDRESS_STR1), (U8*) GetString(STR_ID_DTCNT_DNS_ADDRESS1));
    SetInlineItemCaption((wgui_inline_items + DATA_ACCOUNT_DNS_ADDRESS_STR2), (U8*) GetString(STR_ID_DTCNT_DNS_ADDRESS2));
    ...
    {
        SetInlineItemIP4(
            (wgui_inline_items + DATA_ACCOUNT_DNS_ADDRESS1),
    ...
    {
        PreparedIPAddressString(g_DataAccount_Display.ip_address_display1, 
                                g_DataAccount_Display.IP1, 
                                g_DataAccount_Display.IP2, 
                                g_DataAccount_Display.IP3, 
                                g_DataAccount_Display.IP4);
        SetInlineItemDisplayOnly((wgui_inline_items + DATA_ACCOUNT_DNS_ADDRESS1), 
                                g_DataAccount_Display.ip_address_display1);
    }

	if (!g_DataAccount_Display.readonly)
    {
        SetInlineItemIP4(
            (wgui_inline_items + DATA_ACCOUNT_DNS_ADDRESS2),
            (U8*) g_DataAccount_Display.IP5,
            (U8*) g_DataAccount_Display.IP6,
            (U8*) g_DataAccount_Display.IP7,
            (U8*) g_DataAccount_Display.IP8,
            PreparedIPAddressString);
    }
    else
    {
        PreparedIPAddressString(g_DataAccount_Display.ip_address_display2, 
                                g_DataAccount_Display.IP5, 
                                g_DataAccount_Display.IP6, 
                                g_DataAccount_Display.IP7, 
                                g_DataAccount_Display.IP8);
        SetInlineItemDisplayOnly((wgui_inline_items + DATA_ACCOUNT_DNS_ADDRESS2), 
                                g_DataAccount_Display.ip_address_display2);
    }
}
...
void mmi_dtcnt_add_account_req(U8 org_index, U8 disp_index);
...
void DataAccountSaveChanges(void)
{
    ...
    /*----------------------------------------------------------------*/
    U8 i = g_DataAccount_Display.CurrSelectItem;
    U8 j = g_DataAccount[i].org_acct_id;
    U8 StrDigit[MAX_IPADDRES_LEN * ENCODING_LENGTH];
    S8 AccountNameStr[30 * ENCODING_LENGTH];
    S32 WordCount = 0;
    ...
    g_DataAccount_Display.set_type = MMI_DTCNT_CSD_PROFILE_EDIT;
    ...
    SetDynaDataAccountName(AccountNameStr, j);
    ...
    mmi_ucs2_to_asc((PS8) StrDigit, (PS8) g_DataAccount_Display.IP5);
    g_DataAccount[i].ViceDnsAddress[0] = (U8) atoi((S8*) StrDigit);
    mmi_ucs2_to_asc((PS8) StrDigit, (PS8) g_DataAccount_Display.IP6);
    g_DataAccount[i].ViceDnsAddress[1] = (U8) atoi((S8*) StrDigit);
    mmi_ucs2_to_asc((PS8) StrDigit, (PS8) g_DataAccount_Display.IP7);
    g_DataAccount[i].ViceDnsAddress[2] = (U8) atoi((S8*) StrDigit);
    mmi_ucs2_to_asc((PS8) StrDigit, (PS8) g_DataAccount_Display.IP8);
    g_DataAccount[i].ViceDnsAddress[3] = (U8) atoi((S8*) StrDigit);
    /* change the second DNS to first if first is empty and second is not empty */	
    if ((g_DataAccount[i].DnsAddress[0] == 0 &&
         g_DataAccount[i].DnsAddress[1] == 0 &&
         g_DataAccount[i].DnsAddress[2] == 0 &&
         g_DataAccount[i].DnsAddress[3] == 0) && 
        (g_DataAccount[i].ViceDnsAddress[0] != 0 ||
         g_DataAccount[i].ViceDnsAddress[1] != 0 ||
         g_DataAccount[i].ViceDnsAddress[2] != 0 ||
         g_DataAccount[i].ViceDnsAddress[3] != 0))
    {
        g_DataAccount[i].DnsAddress[0] = g_DataAccount[i].ViceDnsAddress[0];
        g_DataAccount[i].DnsAddress[1] = g_DataAccount[i].ViceDnsAddress[1];
        g_DataAccount[i].DnsAddress[2] = g_DataAccount[i].ViceDnsAddress[2];
        g_DataAccount[i].DnsAddress[3] = g_DataAccount[i].ViceDnsAddress[3];
        g_DataAccount[i].ViceDnsAddress[0] = 0;
        g_DataAccount[i].ViceDnsAddress[1] = 0;
        g_DataAccount[i].ViceDnsAddress[2] = 0;
        g_DataAccount[i].ViceDnsAddress[3] = 0;
    ...
    g_DataAccount[i].org_acct_id = j;
    ///MMI_TRACE(MMI_CONN_TRC_INFO, 
    ///          MMI_DTCNT_EDIT_ACCOUNT, 
   ///           g_DataAccount_Display.GSM_acct_num,
   ///           g_DataAccount[i].org_acct_id,
   ///           i);
    mmi_dtcnt_add_account_req(g_DataAccount[i].org_acct_id, i);
}
...
void EntryDTCNTSave(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    if (mmi_ucs2strlen((PS8) g_DataAccount_Display.DialNumber) == 0)
    {    
        mmi_display_popup_confirm(
            ...
            (UI_string_type)GetString(STR_ID_DTCNT_CSD_INPUT_LACK),
            MMI_EVENT_QUERY);
        SetLeftSoftkeyFunction(GoBackHistory, KEY_EVENT_UP);
        SetRightSoftkeyFunction(GoToMainDataAccountScreen1, KEY_EVENT_UP);
        return;
    }
    mmi_display_popup_confirm(
        (UI_string_type)GetString(STR_GLOBAL_YES),
 ...
 *  void
 *****************************************************************************/
void GoToMainDataAccountScreen1(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    DeleteScreenIfPresent(SCR_ID_DTCNT_OPTION);
#ifdef	__MMI_GPRS_FEATURES__
    DeleteScreenIfPresent(SCR_ID_DTCNT_GPRS_EDIT);
    DeleteScreenIfPresent(SCR_ID_DTCNT_GPRS_OPTION);
#endif
    GoBackHistory();
}
 ...
 *  void
 *****************************************************************************/
void mmi_dtcnt_add_ok_popup(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_display_popup((UI_string_type) GetString(STR_ID_DTCNT_ACCOUNT_ADDED), MMI_EVENT_SUCCESS);
 ...
 *  void
 *****************************************************************************/
void mmi_dtcnt_delete_ok_popup(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_delete_account_req
 * DESCRIPTION
 *  Send set CSD profile primitive to L4C
 * PARAMETERS
 *  org_index     [IN]    original ID to save to NVRAM slot
 *  disp_index    [IN]    Displayed index at data account CSD list
 * RETURNS
 *  void
 *****************************************************************************/
void mmi_dtcnt_delete_account_req(U8 org_index, U8 disp_index)
{
    /*----------------------------------------------------------------*/
    /* Local Variables												  */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body													  */
    /*----------------------------------------------------------------*/
    if (disp_index >= MAX_DATA_ACCOUNT_GSM_LIMIT || org_index >= MAX_DATA_ACCOUNT_GSM_LIMIT)
    {
    	return;
    }
    ...
    {
    	myMsgPtr->dns[i] = 0;
    	myMsgPtr->sec_dns[i] = 0;
    }
    
    myMsgPtr->name.name_dcs = DATA_ACCOUNT_ASCII;
    myMsgPtr->name.name_length = 0;
    memset(myMsgPtr->name.name, 0, sizeof(myMsgPtr->name.name));

    memset(myMsgPtr->user_id, 0, sizeof(myMsgPtr->user_id));
    
    memset(myMsgPtr->passwd, 0, sizeof(myMsgPtr->passwd));
   
    myMsgPtr->dest.type = 0;
    myMsgPtr->dest.length = 0;
    memset(myMsgPtr->dest.number, 0, sizeof(myMsgPtr->dest.number));
    
    #ifdef __MMI_CCA_OMACP_BOOTSTRAP_UPDATE_SUPPORT__
    /* 4 fields new added for csd account(g_DataAccount[ItemNum]-->L4C) */
    memset(myMsgPtr->prov_url, 0, sizeof(myMsgPtr->prov_url));
    memset(myMsgPtr->napid, 0, sizeof(myMsgPtr->napid));
    myMsgPtr->account_type = 0;
    #endif /* __MMI_CCA_OMACP_BOOTSTRAP_UPDATE_SUPPORT__ */
    myMsgPtr->read_only = 0;
...
void mmi_dtcnt_add_account_req(U8 org_index, U8 disp_index)
{
    ...
    if (g_DataAccount[disp_index].DialType == DIAL_TYPE_ANALOGUE)
    {
    ...
    if (g_DataAccount[disp_index].DataRate == DATA_RATE_FOUR_EIGHT - 1)
    {
        myMsgPtr->rate = (U8) CSD_PROF_RATE_4800;
    }
    else if (g_DataAccount[disp_index].DataRate == DATA_RATE_NINE_SIX - 1)
    {
        myMsgPtr->rate = (U8) CSD_PROF_RATE_9600;
    }
    else if (g_DataAccount[disp_index].DataRate == DATA_RATE_FOURTEEN_FOUR - 1)
    {
    ...
    for (i = 0; i < 4; i++)
    {
        myMsgPtr->dns[i] = (U8) g_DataAccount[disp_index].DnsAddress[i];
        myMsgPtr->sec_dns[i] = (U8) g_DataAccount[disp_index].ViceDnsAddress[i];
    }

    if (g_DataAccount[disp_index].iFdcs > 0)
    {
        g_DataAccount[disp_index].iFdcs = mmi_ucs2strlen((PS8) g_DataAccount[disp_index].DataAccountName) * ENCODING_LENGTH;
        myMsgPtr->name.name_length = g_DataAccount[disp_index].iFdcs;
        myMsgPtr->name.name_dcs = DATA_ACCOUNT_UCS; /* 0x8 */
        i = 0;
        while (i != g_DataAccount[disp_index].iFdcs)
        {
            myMsgPtr->name.name[i] = g_DataAccount[disp_index].DataAccountName[i + 1];
            myMsgPtr->name.name[i + 1] = g_DataAccount[disp_index].DataAccountName[i];
            i += 2;
        }
    ...
    {
        myMsgPtr->name.name_dcs = DATA_ACCOUNT_ASCII;
        mmi_ucs2_to_asc((PS8) DataAccountName_ASCII, (PS8) g_DataAccount[disp_index].DataAccountName);
        ...
        g_DataAccount[disp_index].iFdcs = 0;
    }

    memcpy(myMsgPtr->user_id, g_DataAccount[disp_index].UserName, strlen((PS8) g_DataAccount[disp_index].UserName) + 1);

    memcpy(myMsgPtr->passwd, g_DataAccount[disp_index].Passwd, strlen((PS8) g_DataAccount[disp_index].Passwd) + 1);

    if (g_DataAccount[disp_index].DialNumber[0] == '+')
    {
        mmi_ucs2_to_asc((PS8) pbNumber_ASCII, (PS8) g_DataAccount[disp_index].DialNumber + ENCODING_LENGTH);
    ...
    {
        mmi_ucs2_to_asc((PS8) pbNumber_ASCII, (PS8) g_DataAccount[disp_index].DialNumber);
...
#ifdef __MMI_CCA_OMACP_BOOTSTRAP_UPDATE_SUPPORT__
    /* 4 fields new added for csd account(g_DataAccount[ItemNum]-->L4C) */
    memcpy(myMsgPtr->prov_url, g_DataAccount[disp_index].provurl_hash_val, MMI_DTCNT_PROVURL_HASH_LEN);
    memcpy(myMsgPtr->napid, g_DataAccount[disp_index].napid_hash_val, MMI_DTCNT_NAPID_HASH_LEN);
    myMsgPtr->account_type = g_DataAccount[disp_index].acct_type;
#endif /* __MMI_CCA_OMACP_BOOTSTRAP_UPDATE_SUPPORT__ */
    myMsgPtr->read_only = g_DataAccount[disp_index].readonly;
...
void DTCNTSetAccountReq(U8 ItemNum)
{
    ...
    for (i = 0; i < 4; i++)
    {
		...
		myMsgPtr->sec_dns[i] = (U8) g_DataAccount[ItemNum].ViceDnsAddress[i];
    }
...
void EntryDTCNTProgress(void)
{
    ...
    ShowCategory66Screen
        (SERVICES_DATA_CONNECT_WLAN_STRING_ID, GetRootTitleIcon(MAIN_MENU_WLAN_WIZARD_MENUID), 0, 0, 0, 0,
         (PU8) GetString(STR_GLOBAL_SAVING), mmi_get_event_based_image(MMI_EVENT_PROGRESS), NULL);
#else
    ShowCategory66Screen
        (SERVICES_DATA_CONNECT_WLAN_STRING_ID, GetRootTitleIcon(SERVICES_DATA_CONNECT_MAIN_MENU_ID), 0, 0, 0, 0,
         (PU8) GetString(STR_GLOBAL_SAVING), mmi_get_event_based_image(MMI_EVENT_PROGRESS), NULL);
#endif
#else
    ShowCategory66Screen
...
#ifdef __MMI_GPRS_FEATURES__
void mmi_dtcnt_arrange_acct_list(DataAccountNode * GSM_list, GPRSDataAccountNode *GPRS_list, DATA_ACCOUNT_ARRANGE_TYPE_ENUM type);
#else
void mmi_dtcnt_arrange_acct_list(DataAccountNode * GSM_list, DataAccountNode *GPRS_list, DATA_ACCOUNT_ARRANGE_TYPE_ENUM type);
#endif
...
void DTCNTSetAccountRsp(void *info)
{
    ...
    if (g_DataAccount_Display.set_type == MMI_DTCNT_CSD_PROFILE_EDIT)
    {
        if (localPtr->result == KAL_TRUE /* OK */ )
        {
            g_DataAccount[g_DataAccount_Display.CurrSelectItem].Present = 'P';
            mmi_dtcnt_arrange_acct_list(g_DataAccount, NULL, ARRANGE_ACCT_TYPE_ALPHABET);
            g_DataAccount_Display.CurrSelectItem = 0;
            ShowDataAccountOKMessage();
        }
        else
        {
            ...
            DataAccountReadyCheck(DTCNTReenterList);
        }
    }
    else if (g_DataAccount_Display.set_type == MMI_DTCNT_CSD_PROFILE_ADD)
    {
        if (localPtr->result == KAL_TRUE /* OK */ )
        {
            g_DataAccount[g_DataAccount_Display.GSM_acct_num].Present = 'P';
            g_DataAccount_Display.GSM_acct_num++;
            mmi_dtcnt_arrange_acct_list(g_DataAccount, NULL, ARRANGE_ACCT_TYPE_ALPHABET);
            g_DataAccount_Display.CurrSelectItem = 0;
            mmi_dtcnt_add_ok_popup();
    ...
    else if (g_DataAccount_Display.set_type == MMI_DTCNT_CSD_PROFILE_DELETE)
    {
        if (localPtr->result == KAL_TRUE /* OK */ )
        {
            mmi_dtcnt_delete_notify(DTCNT_LIST_BEARER_CSD, g_DataAccount_Display.CurrSelectItem);
            memset(&g_DataAccount[g_DataAccount_Display.CurrSelectItem], 0, sizeof(DataAccountNode));  
            g_DataAccount[g_DataAccount_Display.CurrSelectItem].Present = 'E';
            mmi_dtcnt_rectify_GSM_account_buffer();
            g_DataAccount_Display.GSM_acct_num--;
            mmi_dtcnt_arrange_acct_list(g_DataAccount, NULL, ARRANGE_ACCT_TYPE_ALPHABET);
            g_DataAccount_Display.CurrSelectItem = 0;
            mmi_dtcnt_delete_ok_popup();
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_GSM_allocate_acct_id
 * DESCRIPTION
 *  Allocate the CSD profile original ID
 * PARAMETERS
 *  void    
 * RETURNS
 *  void
 *****************************************************************************/
U8 mmi_dtcnt_GSM_allocate_acct_id(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    for(i = 0; i < MAX_DATA_ACCOUNT_GSM_LIMIT; i++)
    {    
        for(j = 0; j < g_DataAccount_Display.GSM_acct_num; j++)
        {
            if (i == g_DataAccount[j].org_acct_id)
            {
                break;
            }
        }
        if (j == g_DataAccount_Display.GSM_acct_num)
        {
            return i;
        }
    }
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_add_account_fill_inline_struct
 * DESCRIPTION
 *  To initialized inline struce for adding screen for CSD
 * PARAMETERS
 *  void    
 * RETURNS
 *  void
 *****************************************************************************/
void mmi_dtcnt_add_account_fill_inline_struct(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
void mmi_dtcnt_init_display_context(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    memset(g_DataAccount_Display.DataAccountName, 0, sizeof(g_DataAccount_Display.DataAccountName));
    memset(g_DataAccount_Display.DialNumber, 0, sizeof(g_DataAccount_Display.DialNumber));
    memset(g_DataAccount_Display.UserName, 0, sizeof(g_DataAccount_Display.UserName));
    memset(g_DataAccount_Display.Passwd, 0, sizeof(g_DataAccount_Display.Passwd));

    ReturnThreeDigitString(g_DataAccount_Display.IP1, 0);
    ReturnThreeDigitString(g_DataAccount_Display.IP2, 0);
    ReturnThreeDigitString(g_DataAccount_Display.IP3, 0);
    ReturnThreeDigitString(g_DataAccount_Display.IP4, 0);
    
    ReturnThreeDigitString(g_DataAccount_Display.IP5, 0);
    ReturnThreeDigitString(g_DataAccount_Display.IP6, 0);
    ReturnThreeDigitString(g_DataAccount_Display.IP7, 0);
    ReturnThreeDigitString(g_DataAccount_Display.IP8, 0);

    g_DataAccount_Display.DialType = 0;
    g_DataAccount_Display.DataRate = 0;
 ...
 * DESCRIPTION
 *  To set CSD profile to L4C
 * PARAMETERS
 *  void    
 * RETURNS
 *  void
 *****************************************************************************/
void mmi_dtcnt_add_account(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables 											   */
    /*----------------------------------------------------------------*/
    ...
    /*----------------------------------------------------------------*/
    /*max account ID */ 
    j = mmi_dtcnt_GSM_allocate_acct_id();
    if (j == DTCNT_MAX_ACCT_ALLOCATED)
    {
        return;
    }
    i = g_DataAccount_Display.GSM_acct_num;

    g_DataAccount_Display.set_type = MMI_DTCNT_CSD_PROFILE_ADD;
    stopRequestedTone(WARNING_TONE);
    ...
    memcpy(g_DataAccount[i].napid_hash_val, g_DataAccount_Display.napid_hash_val, MMI_DTCNT_NAPID_HASH_LEN);
    g_DataAccount[i].acct_type = g_DataAccount_Display.acct_type;
    g_DataAccount[i].readonly = 0;
    g_DataAccount_Display.cur_profile_id = i;
    g_DataAccount[i].org_acct_id = j;
 ///   MMI_TRACE(MMI_CONN_TRC_INFO, 
 ///             MMI_DTCNT_ADD_ACCOUNT, 
 ///             g_DataAccount_Display.GSM_acct_num,
 ...
 *  void
 *****************************************************************************/
void mmi_dtcnt_add_account_confirm(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    mmi_display_popup_confirm(
        ...
        (UI_string_type)GetString(STR_GLOBAL_NO),
        (PU8)GetImage(IMG_GLOBAL_NO), 
        (UI_string_type)GetString(STR_ID_DTCNT_ADD_CONFIRM),
        MMI_EVENT_QUERY);

    SetLeftSoftkeyFunction(mmi_dtcnt_add_account, KEY_EVENT_UP);
    SetRightSoftkeyFunction(GoToMainDataAccountScreen1, KEY_EVENT_UP);
}
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_entry_add_account
 * DESCRIPTION
 *  To enter add CSD profile screen
 * PARAMETERS
 *  void    
 * RETURNS
 *  void
 *****************************************************************************/
void mmi_dtcnt_entry_add_account(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    if (g_DataAccount_Display.GSM_acct_num == MAX_DATA_ACCOUNT_GSM_LIMIT)
    {
        mmi_dtcnt_arrange_acct_list(g_DataAccount, NULL, ARRANGE_ACCT_TYPE_ALPHABET);
        g_DataAccount_Display.CurrSelectItem = 0;
        mmi_display_popup((UI_string_type) GetString(STR_ID_DTCNT_MAX_CSD_ACCOUNT_REACHED), MMI_EVENT_FAILURE);
        DeleteScreenIfPresent(SCR_ID_DTCNT_OPTION);
        return;
    }
	EntryNewScreen(SCR_ID_DTCNT_EDIT, mmi_dtcnt_exit_add_account, NULL, NULL);
    mmi_dtcnt_init_display_context();
    InitializeCategory57Screen();
    guiBuffer = GetCurrGuiBuffer(SCR_ID_DTCNT_EDIT);
    inputBuffer = GetCurrNInputBuffer(SCR_ID_DTCNT_EDIT, &inputBufferSize);     /* added for inline edit history */
    ...
    g_DataAccount_Display.readonly = 0;
    ...
    SetCategory57RightSoftkeyFunctions(mmi_dtcnt_add_account_confirm, GoBackHistory);
...
void DTCNTGetAccountReq(U8 ItemNum)
{
    ...
    if (ItemNum == 0) 
    {
        g_DataAccount_Display.GSM_acct_num = 0;
    }
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_arrange_acct_list
 * DESCRIPTION
 *  To sort the profile by profile name
 * PARAMETERS
 *  GSM_list     [IN]    CSD profile list
 *  GPRS_list    [IN]    GPRS profile list
 *  type           [IN]     Sort type
 * RETURNS
 *  void
 *****************************************************************************/
void mmi_dtcnt_arrange_acct_list(DataAccountNode * GSM_list, GPRSDataAccountNode *GPRS_list, DATA_ACCOUNT_ARRANGE_TYPE_ENUM type)
{
    ...
    /*----------------------------------------------------------------*/
    U8 i, j;
    DataAccountNode GSM_list_temp;
    GPRSDataAccountNode GPRS_list_temp;
...
/* Vogins Start */
#if !defined(__VRE__)
    if (type == ARRANGE_ACCT_TYPE_ALPHABET)
    {
        if (GSM_list)
        {
            for(i = 0; i < g_DataAccount_Display.GSM_acct_num - 1; i++)
            {    
                for(j = i; j < g_DataAccount_Display.GSM_acct_num; j++)
                {
                    if (mmi_ucs2cmp((S8*)GSM_list[i].DataAccountName, (S8*)GSM_list[j].DataAccountName) > 0 ||
						(mmi_ucs2cmp((S8*)GSM_list[i].DataAccountName, (S8*)GSM_list[j].DataAccountName) == 0 && GSM_list[i].org_acct_id > GSM_list[j].org_acct_id))
                    {
                        memcpy(&GSM_list_temp, &GSM_list[i], sizeof(DataAccountNode));
                        memcpy(&GSM_list[i], &GSM_list[j], sizeof(DataAccountNode));
                        memcpy(&GSM_list[j], &GSM_list_temp, sizeof(DataAccountNode));
                    }
                }
            }
        }
        if (GPRS_list)
        {
            for(i = 0; i < g_DataAccount_Display.GPRS_acct_num - 1; i++)
            {    
                for(j = i; j < g_DataAccount_Display.GPRS_acct_num; j++)
                {
                    if (mmi_ucs2cmp((S8*)GPRS_list[i].DataAccountName, (S8*)GPRS_list[j].DataAccountName) > 0 ||
                        (mmi_ucs2cmp((S8*)GPRS_list[i].DataAccountName, (S8*)GPRS_list[j].DataAccountName) == 0 && GPRS_list[i].org_acct_id > GPRS_list[j].org_acct_id))
                    {
                        memcpy(&GPRS_list_temp, &GPRS_list[i], sizeof(GPRSDataAccountNode));
                        memcpy(&GPRS_list[i], &GPRS_list[j], sizeof(GPRSDataAccountNode));
                        memcpy(&GPRS_list[j], &GPRS_list_temp, sizeof(GPRSDataAccountNode));
                    }
                }
            }
        }		
...
void DTCNTGetAccountRsp(void *info)
{
    ...
    U8 ItemNum = 0, i = 0;
    U8 id, bearer, buffer_num = MAX_ACCOUNT_NUM;
    U8 array_buffer[MAX_ACCOUNT_NUM];
...
/* note */
    if (localPtr->dest.length || (localPtr->dest.type == MMI_CSMCC_INTERNATIONAL_ADDR && localPtr->dest.length == 0))
    {
        ItemNum = g_DataAccount_Display.GSM_acct_num;
        ...
        for (i = 0; i < 4; i++)
        {
    		...
    		g_DataAccount[ItemNum].ViceDnsAddress[i] = (U8) localPtr->sec_dns[i];
        }
        ...
        /* To set WAP CSD always read - only */ 
#ifdef __MMI_WAP_PROF__
        mmi_wap_prof_get_read_only_dtcnt_list(array_buffer, &buffer_num);
        for (i = 0; i < buffer_num; i++)
        {
            abm_nw2bearer_id(array_buffer[i], &bearer, &id);
            if (g_DataAccount_Display.CurrGetIndex == id && bearer == ABM_E_SOCKET_BEARER_GSM_CSD) 
            {
            	g_DataAccount[ItemNum].readonly = 1;
            }
        }
#endif
        ...
        g_DataAccount[ItemNum].org_acct_id = g_DataAccount_Display.CurrGetIndex;
    }
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_entry_GSM_option
 * DESCRIPTION
 *  Entry the GSM option screen
 * PARAMETERS
 *  void    
 * RETURNS
 *  void
 *****************************************************************************/
void mmi_dtcnt_entry_GSM_option(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables												  */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body													  */
    /*----------------------------------------------------------------*/
    EntryNewScreen(SCR_ID_DTCNT_OPTION, NULL, mmi_dtcnt_entry_GSM_option, NULL);
    guiBuffer = GetCurrGuiBuffer(SCR_ID_DTCNT_OPTION);
    if (g_DataAccount_Display.GSM_acct_num == 0)
    {
        SetParentHandler(MENU_ID_DTCNT_ACCOUNT_OPTION2);
        nNumofItem = GetNumOfChild_Ext(MENU_ID_DTCNT_ACCOUNT_OPTION2);
        GetSequenceStringIds_Ext(MENU_ID_DTCNT_ACCOUNT_OPTION2, nStrItemList);
        GetSequenceImageIds_Ext(MENU_ID_DTCNT_ACCOUNT_OPTION2, nImgIltemList);
        ConstructHintsList(MENU_ID_DTCNT_ACCOUNT_OPTION2, hintList);
    }
    else if (g_DataAccount[g_DataAccount_Display.CurrSelectItem].readonly)
    {
        SetParentHandler(MENU_ID_DTCNT_ACCOUNT_OPTION1);
        nNumofItem = GetNumOfChild_Ext(MENU_ID_DTCNT_ACCOUNT_OPTION1);
        GetSequenceStringIds_Ext(MENU_ID_DTCNT_ACCOUNT_OPTION1, nStrItemList);
        GetSequenceImageIds_Ext(MENU_ID_DTCNT_ACCOUNT_OPTION1, nImgIltemList);
        ConstructHintsList(MENU_ID_DTCNT_ACCOUNT_OPTION1, hintList);
    }
    else
    {
        SetParentHandler(MENU_ID_DTCNT_ACCOUNT_OPTION);
        nNumofItem = GetNumOfChild_Ext(MENU_ID_DTCNT_ACCOUNT_OPTION);
        GetSequenceStringIds_Ext(MENU_ID_DTCNT_ACCOUNT_OPTION, nStrItemList);
        GetSequenceImageIds_Ext(MENU_ID_DTCNT_ACCOUNT_OPTION, nImgIltemList);
        ConstructHintsList(MENU_ID_DTCNT_ACCOUNT_OPTION, hintList);
    }
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_deletion_registration_by_primitive
 * DESCRIPTION
 *  To set CSD profile to L4C
 * PARAMETERS
 *  void    
...
static void mmi_dtcnt_deletion_registration_by_primitive(void *info, int mod_id, void *peer_buf)
{
    ...
    /* Local Variables												  */
    /*----------------------------------------------------------------*/
    mmi_dtcnt_register_deletion_notify_req_struct *localPtr;
    dtcnt_deletion_registration_error_enum ret_val; 
	
    /*----------------------------------------------------------------*/
    /* Code Body													  */
    /*----------------------------------------------------------------*/
    localPtr = (mmi_dtcnt_register_deletion_notify_req_struct*) info;

    //MMI_TRACE(MMI_CONN_TRC_G6_DTCNT, MMI_DTCNT_DELETION_REGISTRATION_REQ, localPtr->app_id, localPtr->desired_acct_id, localPtr->register_flag);
  
    ret_val = mmi_dtcnt_add_del_to_deletion_registration_primitive(localPtr->app_id, localPtr->desired_acct_id, (module_type)mod_id, localPtr->register_flag);
    if (ret_val == MMI_DTCNT_REGISTER_OK || ret_val == MMI_DTCNT_DEREGISTER_OK)
    {
        mmi_dtcnt_send_register_deletion_notification_cnf(localPtr->app_id, localPtr->desired_acct_id, localPtr->register_flag, (module_type)mod_id, MMI_TRUE);
    }
    else
    {
        mmi_dtcnt_send_register_deletion_notification_cnf(localPtr->app_id, localPtr->desired_acct_id, localPtr->register_flag, (module_type)mod_id, MMI_FALSE);
    }
}
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_GPRS_delete_account_req
 * DESCRIPTION
 *  Send set GPRS profile primitive to L4C
 * PARAMETERS
 *  org_index     [IN]    original ID to save to NVRAM slot
 *  disp_index    [IN]    Displayed index at data account CSD list
 * RETURNS
 *  void
 *****************************************************************************/
void mmi_dtcnt_GPRS_delete_account_req(U8 org_index, U8 disp_index)
{
    /*----------------------------------------------------------------*/
    /* Local Variables												  */
    /*----------------------------------------------------------------*/    
    ...
    myMsgPtr->gprs_account.name_length = 0;
    memset(myMsgPtr->gprs_account.name, 0, sizeof(myMsgPtr->gprs_account.name));
    /* micha0202 */
    memset(myMsgPtr->gprs_account.apn, 0, sizeof(myMsgPtr->gprs_account.apn));
    myMsgPtr->gprs_account.apn_length = 0;
    ...
    memset(myMsgPtr->gprs_account.provurl, 0, sizeof(myMsgPtr->gprs_account.provurl));
    memset(myMsgPtr->gprs_account.napid, 0, sizeof(myMsgPtr->gprs_account.napid));
    myMsgPtr->gprs_account.account_type = DTCNT_OTA_CONFIGURED_ACCT;
#endif /* __MMI_CCA_OMACP_BOOTSTRAP_UPDATE_SUPPORT__ */
 ...
 *  void
 *****************************************************************************/
void mmi_dtcnt_add_GPRS_account_req(U8 org_index, U8 disp_index)
{
    /*----------------------------------------------------------------*/
    /* Local Variables												  */
    /*----------------------------------------------------------------*/
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_GPRS_allocate_acct_id
 * DESCRIPTION
 *  Allocate the CSD profile original ID
 * PARAMETERS
 *  void    
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_GPRS_add_account_fill_inline_struct
 * DESCRIPTION
 *  To initialized inline struce for adding screen for GPRS
 * PARAMETERS
 *  void    
 * RETURNS
 *  void
 *****************************************************************************/
void mmi_dtcnt_GPRS_add_account_fill_inline_struct(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    SetInlineItemActivation((wgui_inline_items + GPRS_DATA_ACCOUNT_DNS_ADDRESS1), INLINE_ITEM_ACTIVATE_WITHOUT_KEY_EVENT, 0);
    SetInlineItemActivation((wgui_inline_items + GPRS_DATA_ACCOUNT_DNS_ADDRESS2), INLINE_ITEM_ACTIVATE_WITHOUT_KEY_EVENT, 0);
    ...
    SetInlineItemCaption((wgui_inline_items + GPRS_DATA_ACCOUNT_PASSWD_STR), (U8*) GetString(STR_GLOBAL_PASSWORD));
    SetInlineItemCaption(
        (wgui_inline_items + GPRS_DATA_ACCOUNT_AUTH_TYPE_STR),
        (U8*) GetString(STR_ID_DTCNT_GPRS_AUTH_TYP));
    SetInlineItemCaption((wgui_inline_items + GPRS_DATA_ACCOUNT_DNS_ADDRESS_STR1),(U8*)GetString(STR_ID_DTCNT_DNS_ADDRESS1)); 
    SetInlineItemCaption((wgui_inline_items + GPRS_DATA_ACCOUNT_DNS_ADDRESS_STR2),(U8*)GetString(STR_ID_DTCNT_DNS_ADDRESS2));
    ...
    SetInlineItemIP4(
        (wgui_inline_items + GPRS_DATA_ACCOUNT_DNS_ADDRESS1),
        (U8*) g_DataAccount_Display.GPRSIP1,
        (U8*) g_DataAccount_Display.GPRSIP2,
        (U8*) g_DataAccount_Display.GPRSIP3,
        (U8*) g_DataAccount_Display.GPRSIP4,
        PreparedIPAddressString);

    SetInlineItemIP4(
        (wgui_inline_items + GPRS_DATA_ACCOUNT_DNS_ADDRESS2),
        (U8*) g_DataAccount_Display.GPRSIP5,
        (U8*) g_DataAccount_Display.GPRSIP6,
        (U8*) g_DataAccount_Display.GPRSIP7,
        (U8*) g_DataAccount_Display.GPRSIP8,
        PreparedIPAddressString);
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_GPRS_init_display_context
 * DESCRIPTION
 *  To enter add GPRS profile screen
 * PARAMETERS
 *  void    
 * RETURNS
 *  void
 *****************************************************************************/
void mmi_dtcnt_GPRS_init_display_context(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /*----------------------------------------------------------------*/
    memset(g_DataAccount_Display.DataAccountName, 0, sizeof(g_DataAccount_Display.DataAccountName));
    memset(g_DataAccount_Display.APN, 0, sizeof(g_DataAccount_Display.APN));
    memset(g_DataAccount_Display.UserName, 0, sizeof(g_DataAccount_Display.UserName));
    memset(g_DataAccount_Display.Passwd, 0, sizeof(g_DataAccount_Display.Passwd));
    
    ReturnThreeDigitString(g_DataAccount_Display.GPRSIP1, 0);
    ReturnThreeDigitString(g_DataAccount_Display.GPRSIP2, 0);
    ReturnThreeDigitString(g_DataAccount_Display.GPRSIP3, 0);
    ReturnThreeDigitString(g_DataAccount_Display.GPRSIP4, 0);
    
    ReturnThreeDigitString(g_DataAccount_Display.GPRSIP5, 0);
    ReturnThreeDigitString(g_DataAccount_Display.GPRSIP6, 0);
    ReturnThreeDigitString(g_DataAccount_Display.GPRSIP7, 0);
    ReturnThreeDigitString(g_DataAccount_Display.GPRSIP8, 0);


    g_DataAccount_Display.AuthType = 0;
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_GPRS_entry_add_account
 * DESCRIPTION
 *  To enter add GPRS profile screen
 * PARAMETERS
 *  void    
 ...
 *  void
 *****************************************************************************/
void mmi_dtcnt_GPRS_entry_add_account(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
/* under construction !*/
#else
    if (g_DataAccount_Display.GPRS_acct_num == MAX_DATA_ACCOUNT_GPRS_LIMIT)
#endif
    {
        mmi_dtcnt_arrange_acct_list(NULL, g_GPRS_DataAccount, ARRANGE_ACCT_TYPE_ALPHABET);
        g_DataAccount_Display.GPRSCurrSelectItem = 0;
        mmi_display_popup((UI_string_type) GetString(STR_ID_DTCNT_MAX_GPRS_ACCOUNT_REACHED), MMI_EVENT_FAILURE);
        DeleteScreenIfPresent(SCR_ID_DTCNT_GPRS_OPTION);
        return;
    }

    EntryNewScreen(SCR_ID_DTCNT_GPRS_EDIT, mmi_dtcnt_GPRS_exit_add_account, NULL, NULL);
    mmi_dtcnt_GPRS_init_display_context();
    InitializeCategory57Screen();
    ...
    ShowCategory57Screen(
        ...
        g_DataAccount_Display.GPRSIconList,
        wgui_inline_items,
        DATA_ACCOUNT_HILITED_ITEM,
        guiBuffer);
    
    SetCategory57RightSoftkeyFunctions(mmi_dtcnt_add_GPRS_account_confirm, GoBackHistory);
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_entry_GPRS_option
 * DESCRIPTION
 *  Entry the GPRS option screen
 * PARAMETERS
 *  void    
 * RETURNS
 *  void
 *****************************************************************************/
void mmi_dtcnt_entry_GPRS_option(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables												  */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body													  */
    /*----------------------------------------------------------------*/
    EntryNewScreen(SCR_ID_DTCNT_GPRS_OPTION, NULL, mmi_dtcnt_entry_GPRS_option, NULL);
    guiBuffer = GetCurrGuiBuffer(SCR_ID_DTCNT_GPRS_OPTION);

    if (g_DataAccount_Display.GPRS_acct_num == 0)
    {
        SetParentHandler(MENU_ID_DTCNT_GPRS_ACCOUNT_OPTION2);
        nNumofItem = GetNumOfChild_Ext(MENU_ID_DTCNT_GPRS_ACCOUNT_OPTION2);
        GetSequenceStringIds_Ext(MENU_ID_DTCNT_GPRS_ACCOUNT_OPTION2, nStrItemList);
        GetSequenceImageIds_Ext(MENU_ID_DTCNT_GPRS_ACCOUNT_OPTION2, nImgIltemList);
        ConstructHintsList(MENU_ID_DTCNT_GPRS_ACCOUNT_OPTION2, hintList);
    }
    else if (g_GPRS_DataAccount[g_DataAccount_Display.GPRSCurrSelectItem].readonly)
    {
        SetParentHandler(MENU_ID_DTCNT_GPRS_ACCOUNT_OPTION1);
        nNumofItem = GetNumOfChild_Ext(MENU_ID_DTCNT_GPRS_ACCOUNT_OPTION1);
        GetSequenceStringIds_Ext(MENU_ID_DTCNT_GPRS_ACCOUNT_OPTION1, nStrItemList);
        GetSequenceImageIds_Ext(MENU_ID_DTCNT_GPRS_ACCOUNT_OPTION1, nImgIltemList);
        ConstructHintsList(MENU_ID_DTCNT_GPRS_ACCOUNT_OPTION1, hintList);
    }
    else
    {
        SetParentHandler(MENU_ID_DTCNT_GPRS_ACCOUNT_OPTION);
        nNumofItem = GetNumOfChild_Ext(MENU_ID_DTCNT_GPRS_ACCOUNT_OPTION);
        GetSequenceStringIds_Ext(MENU_ID_DTCNT_GPRS_ACCOUNT_OPTION, nStrItemList);
        GetSequenceImageIds_Ext(MENU_ID_DTCNT_GPRS_ACCOUNT_OPTION, nImgIltemList);
        ConstructHintsList(MENU_ID_DTCNT_GPRS_ACCOUNT_OPTION, hintList);
    }
    RegisterHighlightHandler(ExecuteCurrHiliteHandler);
...
void mmi_dtcnt_add_GPRS_account(void)
{
    ...
    j = mmi_dtcnt_GPRS_allocate_acct_id();
    if (j == DTCNT_MAX_ACCT_ALLOCATED)
    {
        return;
    }
    ...
    mmi_ucs2_to_asc((PS8)StrDigit, (PS8)g_DataAccount_Display.GPRSIP1);
    g_GPRS_DataAccount[i].DnsAddress[0] = (U8) atoi((S8*)StrDigit);
    
    mmi_ucs2_to_asc((PS8)StrDigit, (PS8)g_DataAccount_Display.GPRSIP2);
    g_GPRS_DataAccount[i].DnsAddress[1] = (U8) atoi((S8*)StrDigit);
    
    mmi_ucs2_to_asc((PS8)StrDigit, (PS8)g_DataAccount_Display.GPRSIP3);
    g_GPRS_DataAccount[i].DnsAddress[2] = (U8) atoi((S8*)StrDigit);
    
    mmi_ucs2_to_asc((PS8)StrDigit, (PS8)g_DataAccount_Display.GPRSIP4);
    g_GPRS_DataAccount[i].DnsAddress[3] = (U8) atoi((S8*)StrDigit);
    
    mmi_ucs2_to_asc((PS8)StrDigit, (PS8)g_DataAccount_Display.GPRSIP5);
    g_GPRS_DataAccount[i].ViceDnsAddress[0] = (U8) atoi((S8*)StrDigit);
    
    mmi_ucs2_to_asc((PS8)StrDigit, (PS8)g_DataAccount_Display.GPRSIP6);
    g_GPRS_DataAccount[i].ViceDnsAddress[1] = (U8) atoi((S8*)StrDigit);
    
    mmi_ucs2_to_asc((PS8)StrDigit, (PS8)g_DataAccount_Display.GPRSIP7);
    g_GPRS_DataAccount[i].ViceDnsAddress[2] = (U8) atoi((S8*)StrDigit);
    
    mmi_ucs2_to_asc((PS8)StrDigit, (PS8)g_DataAccount_Display.GPRSIP8);
    g_GPRS_DataAccount[i].ViceDnsAddress[3] = (U8) atoi((S8*)StrDigit);
    
    /* change the second DNS to first if first is empty and second is not empty */	
    if ((g_GPRS_DataAccount[i].DnsAddress[0] == 0 &&
    	 g_GPRS_DataAccount[i].DnsAddress[1] == 0 &&
    	 g_GPRS_DataAccount[i].DnsAddress[2] == 0 &&
    	 g_GPRS_DataAccount[i].DnsAddress[3] == 0) && 
    	(g_GPRS_DataAccount[i].ViceDnsAddress[0] != 0 ||
    	 g_GPRS_DataAccount[i].ViceDnsAddress[1] != 0 ||
    	 g_GPRS_DataAccount[i].ViceDnsAddress[2] != 0 ||
    	 g_GPRS_DataAccount[i].ViceDnsAddress[3] != 0))
    {
    	g_GPRS_DataAccount[i].DnsAddress[0] = g_GPRS_DataAccount[i].ViceDnsAddress[0];
    	g_GPRS_DataAccount[i].DnsAddress[1] = g_GPRS_DataAccount[i].ViceDnsAddress[1];
    	g_GPRS_DataAccount[i].DnsAddress[2] = g_GPRS_DataAccount[i].ViceDnsAddress[2];
    	g_GPRS_DataAccount[i].DnsAddress[3] = g_GPRS_DataAccount[i].ViceDnsAddress[3];
    	g_GPRS_DataAccount[i].ViceDnsAddress[0] = 0;
    	g_GPRS_DataAccount[i].ViceDnsAddress[1] = 0;
    	g_GPRS_DataAccount[i].ViceDnsAddress[2] = 0;
    	g_GPRS_DataAccount[i].ViceDnsAddress[3] = 0;
    ...
    g_GPRS_DataAccount[i].readonly = 0;
    g_GPRS_DataAccount[i].org_acct_id = j;
 ///   MMI_TRACE(MMI_CONN_TRC_INFO, 
 ///             MMI_DTCNT_ADD_GPRS_ACCOUNT, 
 ///             g_DataAccount_Display.GPRS_acct_num,
 ///             j,
 ///             i);
    mmi_dtcnt_add_GPRS_account_req(j, i);
}


/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_add_GPRS_account_confirm
 * DESCRIPTION
...
void mmi_dtcnt_add_GPRS_account_confirm(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    if (mmi_ucs2strlen((PS8) g_DataAccount_Display.APN) == 0)
    {
    ...
    mmi_display_popup_confirm(
        ...
        (UI_string_type)GetString(STR_GLOBAL_NO),
        (PU8)GetImage(IMG_GLOBAL_NO), 
        (UI_string_type)GetString(STR_ID_DTCNT_GPRS_INPUT_LACK),
        MMI_EVENT_QUERY);
    ...
    mmi_display_popup_confirm(
        ...
        (UI_string_type)GetString(STR_GLOBAL_NO),
        (PU8)GetImage(IMG_GLOBAL_NO), 
        (UI_string_type)GetString(STR_ID_DTCNT_GPRS_ADD_CONFIRM),
        MMI_EVENT_QUERY);

    SetLeftSoftkeyFunction(mmi_dtcnt_add_GPRS_account, KEY_EVENT_UP);
...
void DTCNTGPRSGetAccountRsp(void *info)
{
    ...
    if (localPtr->gprs_account.apn_length != 0 || localPtr->gprs_account.name_length != 0)
    {

        ItemNum = g_DataAccount_Display.GPRS_acct_num;
        g_DataAccount_Display.GPRS_acct_num++;
#ifdef __MMI_OP01_GPRS_DATACFG__
/* under construction !*/
/* under construction !*/
...
/* under construction !*/
        ...
        for (i = 0; i < 4; i++)
        {
            ...
            g_GPRS_DataAccount[ItemNum].ViceDnsAddress[i] = (U8) localPtr->gprs_account.sec_dns[i];
        ...
        /* To set 1st GPRS always read - only */ 
#ifdef __MMI_WAP_PROF__
        mmi_wap_prof_get_read_only_dtcnt_list(array_buffer, &buffer_num);
        for (i = 0; i < buffer_num; i++)
        {
            abm_nw2bearer_id(array_buffer[i], &bearer, &id);
            if (g_DataAccount_Display.GPRSCurrGetIndex == id - 1 && bearer == ABM_E_SOCKET_BEARER_GSM_GPRS) 
            {
            	g_GPRS_DataAccount[ItemNum].readonly = 1;
            }
        }
#endif
...
/* under construction !*/
    ...
    #endif /* 0 */
    g_GPRS_DataAccount[ItemNum].org_acct_id = g_DataAccount_Display.GPRSCurrGetIndex;
    }
...
void mmi_dtcnt_always_ask_entry_gprs_list(void)
{
    ...
    if (g_DataAccount_Display.GPRS_acct_num)
    {
        ShowCategory53Screen(
            STR_GLOBAL_DATA_ACCOUNT,
            GetRootTitleIcon(SERVICES_DATA_CONNECT_MAIN_MENU_ID),
...
void mmi_dtcnt_always_ask_gprs_list_select_ok(void)
{
    ...
    if(g_mmi_dtcnt_always_ask.app_callback_ext)
    {
        ...
        abm_bearer2nw_id(ABM_E_SOCKET_BEARER_GSM_GPRS, g_GPRS_DataAccount[g_mmi_dtcnt_always_ask.GPRSCurrAASelectItem].org_acct_id + 1, &id);
        id = cbm_encode_data_account_id(id, 0, 0, 0);
    #ifdef __MMI_DUAL_SIM__
        /* id = cbm_encode_data_account_id(id, g_always_ask_sim_info, 0, 0); */
    #else /* __MMI_DUAL_SIM__ */
 ...
 *  void
 *****************************************************************************/
void EntryGPRSAppDTCNTListUCM(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    else
    {
        ...
        currHistory.scrnID = SCR_ID_DTCNT_GPRS_LIST;
        currHistory.entryFuncPtr = EntryGPRSAppDTCNTList;
        mmi_ucs2cpy((S8*)currHistory.inputBuffer, (S8*)&ucs2InputBuffer);
        InsertHistoryBeforeThisScrn(GetCmMarkerScrnID(), currHistory);
...
void GPRSAppDTCNTSelectOK(void)
{
    ...
    if (g_mmi_dtcnt_account_selection.app_callback)
    {
        ...
        abm_bearer2nw_id(ABM_E_SOCKET_BEARER_GSM_GPRS, g_GPRS_DataAccount[g_mmi_dtcnt_account_selection.GPRSCurrAppSelectItem].org_acct_id + 1, &id);
#ifdef __MMI_DUAL_SIM__
        id = cbm_encode_data_account_id(id, g_sim_info, 0, 0);
#else /* __MMI_DUAL_SIM__ */
        id = cbm_encode_data_account_id(id, 0, 0, 0);
...
void EntryDTCNTGPRSList(void)
{
    ...
    EntryNewScreen(SCR_ID_DTCNT_GPRS_EDIT_LIST, NULL, EntryDTCNTGPRSList, NULL);
    ...
    {
        guiBuffer = GetCurrGuiBuffer(SCR_ID_DTCNT_GPRS_EDIT_LIST);
    }
    ...
    /* Register function for left soft key */
    SetLeftSoftkeyFunction(mmi_dtcnt_entry_GPRS_option, KEY_EVENT_UP);
    SetKeyHandler(mmi_dtcnt_entry_GPRS_option, KEY_RIGHT_ARROW, KEY_EVENT_DOWN);
    /* Register function for right soft key */
    SetRightSoftkeyFunction(GoBackHistory, KEY_EVENT_UP);
    SetKeyHandler(GoBackHistory, KEY_LEFT_ARROW, KEY_EVENT_DOWN);

    SetDelScrnIDCallbackHandler(SCR_ID_DTCNT_GPRS_EDIT_LIST, mmi_dtcnt_exit_list_hdlr);
}
...
void InitInLineGPRSDataAccount(void)
{
    ...
    ReturnThreeDigitString(g_DataAccount_Display.GPRSIP1, g_GPRS_DataAccount[i].DnsAddress[0]);
    ReturnThreeDigitString(g_DataAccount_Display.GPRSIP2, g_GPRS_DataAccount[i].DnsAddress[1]);
    ReturnThreeDigitString(g_DataAccount_Display.GPRSIP3, g_GPRS_DataAccount[i].DnsAddress[2]);
    ReturnThreeDigitString(g_DataAccount_Display.GPRSIP4, g_GPRS_DataAccount[i].DnsAddress[3]);

    ReturnThreeDigitString(g_DataAccount_Display.GPRSIP5, g_GPRS_DataAccount[i].ViceDnsAddress[0]);
    ReturnThreeDigitString(g_DataAccount_Display.GPRSIP6, g_GPRS_DataAccount[i].ViceDnsAddress[1]);
    ReturnThreeDigitString(g_DataAccount_Display.GPRSIP7, g_GPRS_DataAccount[i].ViceDnsAddress[2]);
    ReturnThreeDigitString(g_DataAccount_Display.GPRSIP8, g_GPRS_DataAccount[i].ViceDnsAddress[3]);
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_GPRS_exit_add_account
 * DESCRIPTION
 *  exit handler for GPRS account add screen
 * PARAMETERS
 *  void
 * RETURNS
 *  void
...
void mmi_dtcnt_GPRS_exit_add_account(void)
{
    ...
    h.entryFuncPtr = mmi_dtcnt_GPRS_entry_add_account;
    GetCategoryHistory(h.guiBuffer);
    inputBufferSize = (U16) GetCategory57DataSize();
    GetCategory57Data((U8*) h.inputBuffer);
    AddNHistory(h, inputBufferSize);
...
void GPRSDataAccountFillInlineStruct(void)
{
    ...
    {
        PreparedIPAddressString(g_DataAccount_Display.GPRS_ip_address_display1, 
                                g_DataAccount_Display.GPRSIP1, 
                                g_DataAccount_Display.GPRSIP2, 
                                g_DataAccount_Display.GPRSIP3, 
                                g_DataAccount_Display.GPRSIP4);
        SetInlineItemDisplayOnly((wgui_inline_items + GPRS_DATA_ACCOUNT_DNS_ADDRESS1), 
                                g_DataAccount_Display.GPRS_ip_address_display1);
    }
    ...
    {
        PreparedIPAddressString(g_DataAccount_Display.GPRS_ip_address_display2, 
                                g_DataAccount_Display.GPRSIP5, 
                                g_DataAccount_Display.GPRSIP6, 
                                g_DataAccount_Display.GPRSIP7, 
                                g_DataAccount_Display.GPRSIP8);
        SetInlineItemDisplayOnly((wgui_inline_items + GPRS_DATA_ACCOUNT_DNS_ADDRESS2), 
                                g_DataAccount_Display.GPRS_ip_address_display2);
    }
...
void GPRSDataAccountSaveChanges(void)
{
    ...
    /*----------------------------------------------------------------*/
    U8 i = g_DataAccount_Display.GPRSCurrSelectItem;
    U8 j = g_GPRS_DataAccount[i].org_acct_id;
    S8 AccountNameStr[30 * ENCODING_LENGTH];    /* Assumption:  string "Data Account " length < 30 */
	U8 StrDigit[MAX_IPADDRES_LEN * ENCODING_LENGTH];
...
/* under construction !*/
  ...
  ///            g_DataAccount_Display.GPRS_acct_num,
  ///            g_GPRS_DataAccount[i].org_acct_id,
  ///            i);
    mmi_dtcnt_add_GPRS_account_req(g_GPRS_DataAccount[i].org_acct_id, i);
...
void DTCNTGPRSSetAccountReq(U8 ItemNum)
{
    ...
    for (i = 0; i < 4; i++)
    {
        myMsgPtr->gprs_account.dns[i] = (U8) g_GPRS_DataAccount[ItemNum].DnsAddress[i];
		myMsgPtr->gprs_account.sec_dns[i] = (U8) g_GPRS_DataAccount[ItemNum].ViceDnsAddress[i];
    }
...
void DTCNTGPRSSetAccountRsp(void *info)
{
    ...
    else
    {
        ...
        if (g_set_GPRS_callback)
        {
            g_set_GPRS_callback(*localPtr);
			g_set_GPRS_callback = NULL;
        }
        g_set_by_project_mode = 0;
    }
#endif /* __MMI_GPRS_FEATURES__ */ 
}
...
void mmi_dtcnt_rectify_GPRS_account_buffer(void)
{
    ...
    /* Code Body													  */
    /*----------------------------------------------------------------*/
    k = g_DataAccount_Display.GPRS_acct_num;
    for(i = 0; i < k; i++)
    {	 
        if (g_GPRS_DataAccount[i].Present == 'E' && 
            g_GPRS_DataAccount[i].APN[0] == 0 &&
            g_GPRS_DataAccount[i].APN[1] == 0)
        	{
                for(j = i; j < k - 1; j++)
                {
                    g_GPRS_DataAccount[j] = g_GPRS_DataAccount[j + 1];
                }
                memset(&g_GPRS_DataAccount[j], 0, sizeof(GPRSDataAccountNode)); 
                k--;
            }
    }
 ...
 *  void
 *****************************************************************************/
void mmi_dtcnt_GPRS_delete_account()
{
    /*----------------------------------------------------------------*/
    /* Local Variables												  */
    /*----------------------------------------------------------------*/
    ...
    U8 j = g_GPRS_DataAccount[i].org_acct_id;
    U32 acct_id;
    cbm_connect_status_enum status = CBM_CONNECT_STATUS_DEACTIVE;
    cbm_connect_status_enum active_status = CBM_CONNECT_STATUS_DEACTIVE;
	
    /*----------------------------------------------------------------*/
    /* Code Body													  */
    /*----------------------------------------------------------------*/
    acct_id = mmi_dtcnt_get_ori_acct_id(g_GPRS_DataAccount[i].org_acct_id, DTCNT_LIST_BEARER_GPRS);
	
#ifdef __MMI_CBM_CONNECTION_MANAGER__
    status = mmi_cbm_get_bearer_status(acct_id);
    active_status = mmi_cbm_get_bearer_active_status(acct_id);

	
    if (status == CBM_CONNECT_STATUS_ACTIVE || 
        status == CBM_CONNECT_STATUS_ACTIVATING ||
        active_status == CBM_CONNECT_STATUS_ACTIVE ||
        active_status == CBM_CONNECT_STATUS_ACTIVATING)
    {
        mmi_display_popup((UI_string_type) GetString(STR_ID_DTCNT_NOT_ALLOW_DELETE), MMI_EVENT_FAILURE);
...
if (status == CBM_CONNECT_STATUS_ACTIVE || 
	status == CBM_CONNECT_STATUS_ACTIVATING ||
    status == CBM_CONNECT_STATUS_DEACTIVATING)
{
	mmi_display_popup((UI_string_type) GetString(STR_ID_DTCNT_NOT_ALLOW_DELETE), MMI_EVENT_FAILURE);
	return;
}
    ...
    g_DataAccount_Display.set_type = MMI_DTCNT_GPRS_PROFILE_DELETE;
    mmi_dtcnt_GPRS_delete_account_req(j, i);
 ...
 * DESCRIPTION
 *  Popup the delete CSD account confirm popup
 * PARAMETERS
 *  void
 * RETURNS
 *  void
 *****************************************************************************/
void mmi_dtcnt_GPRS_delete_account_confirm(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    index = g_DataAccount_Display.GPRSCurrSelectItem;
    acct_id = mmi_dtcnt_get_ori_acct_id(g_GPRS_DataAccount[index].org_acct_id, DTCNT_LIST_BEARER_GPRS);
    #ifdef __MMI_CBM_CONNECTION_MANAGER__
    status = mmi_cbm_get_bearer_status(acct_id);
    active_status = mmi_cbm_get_bearer_active_status(acct_id);
    ...
    status == CBM_CONNECT_STATUS_DEACTIVATING)
{
    ...
    mmi_display_popup_confirm(
        ...
        (UI_string_type)GetString(STR_GLOBAL_NO),
        (PU8)GetImage(IMG_GLOBAL_NO), 
        (UI_string_type)GetString(STR_ID_DTCNT_GPRS_DELETE_CONFIRM),
        MMI_EVENT_QUERY);

    SetLeftSoftkeyFunction(mmi_dtcnt_GPRS_delete_account, KEY_EVENT_UP);
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_GPRS_option_add_account_highlight_hdlr
 * DESCRIPTION
 *  Add new GPRS profile highlight handler
 * PARAMETERS
 *  void
 * RETURNS
 *  void
 *****************************************************************************/
void mmi_dtcnt_GPRS_option_add_account_highlight_hdlr(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    SetLeftSoftkeyFunction(mmi_dtcnt_GPRS_entry_add_account, KEY_EVENT_UP);
    SetKeyHandler(mmi_dtcnt_GPRS_entry_add_account, KEY_RIGHT_ARROW, KEY_EVENT_DOWN);
    SetRightSoftkeyFunction(GoBackHistory, KEY_EVENT_UP);
    SetKeyHandler(GoBackHistory, KEY_LEFT_ARROW, KEY_EVENT_DOWN);
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_GPRS_option_delete_account_highlight_hdlr
 * DESCRIPTION
 *  Delete existing GPRS profile highlight handler
 * PARAMETERS
 *  void
 * RETURNS
 *  void
 *****************************************************************************/
void mmi_dtcnt_GPRS_option_delete_account_highlight_hdlr(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    SetLeftSoftkeyFunction(mmi_dtcnt_GPRS_delete_account_confirm, KEY_EVENT_UP);
    SetKeyHandler(mmi_dtcnt_GPRS_delete_account_confirm, KEY_RIGHT_ARROW, KEY_EVENT_DOWN);
    SetRightSoftkeyFunction(GoBackHistory, KEY_EVENT_UP);
    SetKeyHandler(GoBackHistory, KEY_LEFT_ARROW, KEY_EVENT_DOWN);
}
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_GPRS_option_edit_account_highlight_hdlr
 * DESCRIPTION
 *  Edit existing GPRS profile highlight handler
 * PARAMETERS
 *  void
 * RETURNS
 *  void
 *****************************************************************************/
void mmi_dtcnt_GPRS_option_edit_account_highlight_hdlr(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_GPRS_option_view_account_highlight_hdlr
 * DESCRIPTION
 *  Edit existing GPRS profile highlight handler
 * PARAMETERS
 *  void
 ...
 *  void
 *****************************************************************************/
void mmi_dtcnt_GPRS_option_view_account_highlight_hdlr(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
static void mmi_ps_dtcnt_list_ind_handler(void *info)
{
    ...
    if(g_dtcnt_list_cnt.bearer_type[0] == DATA_ACCOUNT_BEARER_CSD)
    {
        ...
        g_dtcnt_list_cnt.sim_info = cbm_get_sim_id(localPtr->net_id[0]);
        g_dtcnt_list_cnt.app_id = cbm_get_app_id(localPtr->net_id[0]);
    }
    else if(g_dtcnt_list_cnt.bearer_type[1] == DATA_ACCOUNT_BEARER_CSD)
    {
        ...
        g_dtcnt_list_cnt.sim_info = cbm_get_sim_id(localPtr->net_id[1]);
        g_dtcnt_list_cnt.app_id = cbm_get_app_id(localPtr->net_id[1]);
    }
...
#endif /* (defined __CSD_NT__) || (defined __CSD_T__) */
...
#endif /* __MMI_WLAN_FEATURES__ */
    {
        nStrItemList[list_num] = STR_GLOBAL_GPRS;
...
static void mmi_dtcnt_list_show(void)
{
    ...
    case DTCNT_LIST_BEARER_ALWAYS_ASK:
        ...
        g_dtcnt_list_cnt.csd_bearer_flag = FALSE;
        g_dtcnt_list_cnt.gprs_bearer_flag = FALSE;
        g_dtcnt_list_cnt.switch_bearer_flag = FALSE;
        g_dtcnt_list_cnt.wifi_bearer_flag = FALSE;
        /**/
        acct_id = 0;
    ...
    case DTCNT_LIST_BEARER_CSD:
        ...
        g_dtcnt_list_cnt.always_ask_flag = FALSE;
        g_dtcnt_list_cnt.gprs_bearer_flag = FALSE;
        g_dtcnt_list_cnt.switch_bearer_flag = FALSE;
        g_dtcnt_list_cnt.wifi_bearer_flag = FALSE;
        if(g_dtcnt_list_cnt.highlight_csd)
        {
            ...
            mmi_dtcnt_select_account(mmi_dtcnt_list_callback_csd, 
    ...
    case DTCNT_LIST_BEARER_GPRS:
        ...
        if(g_dtcnt_list_cnt.highlight_gprs)
        {
            ...
            mmi_dtcnt_select_account(mmi_dtcnt_list_callback_gprs, 
                                            g_dtcnt_list_cnt.menu_id, 
...
static void mmi_dtcnt_list_confirm(void)
{
    ...
    if (is_forward)
    {
        playRequestedTone(mmi_get_event_based_sound(MMI_EVENT_INFO));
    }
}
...
static void mmi_dtcnt_list_by_app_confirm_csd(void)
{
    ...
    {
        mmi_dtcnt_select_highlight_handler(0, DATA_ACCOUNT_BEARER_CSD);
        mmi_dtcnt_select_account(mmi_dtcnt_list_callback_csd, g_dtcnt_list_cnt.menu_id, DATA_ACCOUNT_BEARER_CSD, 0, MMI_DTCNT_INVALID_ID, 0);
    }
}
 ...
 *  
 *****************************************************************************/
void mmi_dtcnt_delete_select_screen(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    DeleteScreenIfPresent(SCR_ID_DTCNT_SELECT_BEARER_SWITCH_ACCOUNT);
    DeleteScreenIfPresent(SCR_ID_DTCNT_LIST_DUAL_SIM);
...
static void mmi_dtcnt_entry_select_account_without_bearer_switch(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    g_mmi_dtcnt_select_account.option &= ~(DTCNT_SELECT_BEARER_SWITCH); 

    mmi_dtcnt_select_account(g_mmi_dtcnt_select_account.app_callback, 
                                           g_mmi_dtcnt_select_account.AppMenuID,
                                           g_mmi_dtcnt_select_account.bearers,
                                 0,
                                 MMI_DTCNT_INVALID_ID,
                                 g_mmi_dtcnt_select_account.option);
...
void mmi_dtcnt_rectify_GSM_account_buffer(void)
{
    ...
    /* Code Body													  */
    /*----------------------------------------------------------------*/
    k = g_DataAccount_Display.GSM_acct_num;
    for(i = 0; i < k; i++)
    {	 
        if (g_DataAccount[i].Present == 'E' && 
            g_DataAccount[i].DialNumber[0] == 0 &&
            g_DataAccount[i].DialNumber[1] == 0)
        	{
                for(j = i; j < k - 1; j++)
                {
                    g_DataAccount[j] = g_DataAccount[j + 1];
                }
                memset(&g_DataAccount[j], 0, sizeof(DataAccountNode)); 
                k--;
            }
    }
...
void mmi_dtcnt_delete_account(void)
{
    ...
    /* Code Body													  */
    /*----------------------------------------------------------------*/
    acct_id = mmi_dtcnt_get_ori_acct_id(g_DataAccount[i].org_acct_id, DTCNT_LIST_BEARER_CSD);
...
#endif
    g_DataAccount_Display.set_type = MMI_DTCNT_CSD_PROFILE_DELETE;
    mmi_dtcnt_delete_account_req(j, i);
...
void mmi_dtcnt_delete_account_confirm(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    index = g_DataAccount_Display.CurrSelectItem;
    acct_id = mmi_dtcnt_get_ori_acct_id(g_DataAccount[index].org_acct_id, DTCNT_LIST_BEARER_CSD);
#ifdef __MMI_CBM_CONNECTION_MANAGER__
    status = mmi_cbm_get_bearer_status(acct_id);
    active_status = mmi_cbm_get_bearer_active_status(acct_id);
    ...
    mmi_display_popup_confirm(
        ...
        (UI_string_type)GetString(STR_GLOBAL_NO),
        (PU8)GetImage(IMG_GLOBAL_NO), 
        (UI_string_type)GetString(STR_ID_DTCNT_DELETE_CONFIRM),
        MMI_EVENT_QUERY);

    SetLeftSoftkeyFunction(mmi_dtcnt_delete_account, KEY_EVENT_UP);
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_option_add_account_highlight_hdlr
 * DESCRIPTION
 *  Add new CSD profile highlight handler
 * PARAMETERS
 *  void
 * RETURNS
 *  void
 *****************************************************************************/
void mmi_dtcnt_option_add_account_highlight_hdlr(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    SetLeftSoftkeyFunction(mmi_dtcnt_entry_add_account, KEY_EVENT_UP);
    SetKeyHandler(mmi_dtcnt_entry_add_account, KEY_RIGHT_ARROW, KEY_EVENT_DOWN);
    SetRightSoftkeyFunction(GoBackHistory, KEY_EVENT_UP);
    SetKeyHandler(GoBackHistory, KEY_LEFT_ARROW, KEY_EVENT_DOWN);
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_option_delete_account_highlight_hdlr
 * DESCRIPTION
 *  Delete existing CSD profile highlight handler
 * PARAMETERS
 *  void
 * RETURNS
 *  void
 *****************************************************************************/
void mmi_dtcnt_option_delete_account_highlight_hdlr(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    SetLeftSoftkeyFunction(mmi_dtcnt_delete_account_confirm, KEY_EVENT_UP);
    SetKeyHandler(mmi_dtcnt_delete_account_confirm, KEY_RIGHT_ARROW, KEY_EVENT_DOWN);
    SetRightSoftkeyFunction(GoBackHistory, KEY_EVENT_UP);
    SetKeyHandler(GoBackHistory, KEY_LEFT_ARROW, KEY_EVENT_DOWN);
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_option_edit_account_highlight_hdlr
 * DESCRIPTION
 *  Edit existing CSD profile highlight handler
 * PARAMETERS
 *  void
 * RETURNS
 *  void
 *****************************************************************************/
void mmi_dtcnt_option_edit_account_highlight_hdlr(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_option_view_account_highlight_hdlr
 * DESCRIPTION
 *  Edit existing CSD profile highlight handler
 * PARAMETERS
 *  void
 ...
 *  void
 *****************************************************************************/
void mmi_dtcnt_option_view_account_highlight_hdlr(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
static void mmi_dtcnt_select_bearers_account_option_done(void)
{
    ...
    if (!abm_check_app_id(g_mmi_dtcnt_select_account.app_id))
    {
        acct_info_ptr->app_id = g_mmi_dtcnt_select_account.app_id;
    }
    else
    {
    ...
    acct_info_ptr->account[MMI_DTCNT_BEARER_FALLBACK_PRIMARY_ACCTOUNT].account_id = 
        cbm_get_original_account(g_mmi_dtcnt_select_account.primary_account_id);
    acct_info_ptr->account[MMI_DTCNT_BEARER_FALLBACK_PRIMARY_ACCTOUNT].is_always_ask = 
        cbm_is_always_ask_account(g_mmi_dtcnt_select_account.primary_account_id);
    acct_info_ptr->account[MMI_DTCNT_BEARER_FALLBACK_PRIMARY_ACCTOUNT].sim_id = 
        cbm_get_sim_id(g_mmi_dtcnt_select_account.primary_account_id);
    acct_info_ptr->acct_num++;
    /* secondary */
    if (g_mmi_dtcnt_select_account.secondary_account_exist)
    {
        acct_info_ptr->account[MMI_DTCNT_BEARER_FALLBACK_SECONDARY_ACCOUNT].account_id = 
            cbm_get_original_account(g_mmi_dtcnt_select_account.secondary_account_id);
        acct_info_ptr->account[MMI_DTCNT_BEARER_FALLBACK_SECONDARY_ACCOUNT].is_always_ask = 
            cbm_is_always_ask_account(g_mmi_dtcnt_select_account.secondary_account_id);
        acct_info_ptr->account[MMI_DTCNT_BEARER_FALLBACK_SECONDARY_ACCOUNT].sim_id = 
        cbm_get_sim_id(g_mmi_dtcnt_select_account.secondary_account_id);
        acct_info_ptr->acct_num++;
    }
    ...
    {
        g_mmi_dtcnt_select_account.bearer_fallback_account_id = MMI_DTCNT_INVALID_ID;
...
static void mmi_dtcnt_select_primary_account(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_dtcnt_entry_primary_account_bearer_list(mmi_dtcnt_primary_account_callback_hdlr, 
        MENU_ID_PROF_DATA_ACCOUNT,
        g_mmi_dtcnt_select_account.bearers,
        (g_mmi_dtcnt_select_account.option & DTCNT_SELECT_SIM) ? 1 : 0,
        (g_mmi_dtcnt_select_account.option & DTCNT_SELECT_ALWAYS_ASK) ? 1 : 0,
        g_mmi_dtcnt_select_account.primary_account_id);  
}
...
static void mmi_dtcnt_primary_account_callback_hdlr(U32 primary_id)
{
    ...
    if (g_mmi_dtcnt_select_account.option & DTCNT_SELECT_ALLOW_SAME_BEARER_SWITCH)
    {
        ...
        {/* DTCNT_SELECT_ALLOW_SAME_BEARER_SWITCH is allowed, only wifi account should not duplicate */
            ...
            {
                if (cbm_is_always_ask_account(g_mmi_dtcnt_select_account.primary_account_id) || 
                    cbm_is_always_ask_account(g_mmi_dtcnt_select_account.secondary_account_id))
                {/* always ask */
                    /* do nothing */
                }
                /*
                else if (cbm_get_sim_id(g_mmi_dtcnt_select_account.primary_account_id) != 
                        cbm_get_sim_id(g_mmi_dtcnt_select_account.secondary_account_id))
                {
                    ;
                }
...
static void mmi_dtcnt_select_secondary_account(void)
{
    ...
    mmi_dtcnt_entry_second_account_bearer_list(mmi_dtcnt_secondary_account_callback_hdlr, 
        MENU_ID_PROF_DATA_ACCOUNT,
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_entry_second_account_bearer_list
 * DESCRIPTION
 *  
 * PARAMETERS
 *  bearers     [IN]        
 ...
 *  
 *****************************************************************************/
static void mmi_dtcnt_entry_second_account_bearer_list(FuncPtrU32 callback, U16 AppMenuID, U8 bearers, dtcnt_select_type_enum sim_info, dtcnt_select_type_enum always_ask, U32 account_id)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    mmi_dtcnt_entry_account_bearer_list_with_option();
}
 ...
 *  
 *****************************************************************************/
void mmi_dtcnt_select_account(FuncPtrU32 callback, U16 AppMenuID, U8 bearers, U8 app_id, U32 account_id, dtcnt_select_type_enum option)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /*----------------------------------------------------------------*/
    g_dtcnt_list_cnt.switch_bearer_flag = FALSE;
    if (((option & DTCNT_SELECT_BEARER_SWITCH) == 0) && option == DTCNT_SELECT_DEFAULT)
    {
	...
	if ((option & DTCNT_SELECT_BEARER_SWITCH) == 0)
    {
    g_mmi_dtcnt_account_selection.app_callback = callback;
    g_mmi_dtcnt_account_selection.AppMenuID = AppMenuID;
    g_mmi_dtcnt_account_selection.CurrAppMainSelectItem = 0;
    ...
    g_mmi_dtcnt_account_selection.select_none_option = MMI_FALSE;
        g_mmi_dtcnt_account_selection.sim_info = (option & DTCNT_SELECT_SIM) ? 1 : 0;
        g_mmi_dtcnt_account_selection.always_ask = (option & DTCNT_SELECT_ALWAYS_ASK) ? 1 : 0;
    ...
    if ((option & DTCNT_SELECT_BEARER_SWITCH) != 0)
    {
        ...
        acct_info = OslMalloc(sizeof(cbm_account_info_struct));
        cbm_decode_data_account_id_ext(account_id, acct_info);
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_entry_primary_account_bearer_list
 * DESCRIPTION
 *  
 * PARAMETERS
 *  bearers     [IN]        
 ...
 *  
 *****************************************************************************/
void mmi_dtcnt_entry_primary_account_bearer_list(FuncPtrU32 callback, U16 AppMenuID, U8 bearers, dtcnt_select_type_enum sim_info, dtcnt_select_type_enum always_ask, U32 account_id)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
void mmi_dtcnt_entry_account_bearer_list_with_option(void)
{
    ...
    sim_info = cbm_get_sim_id(g_mmi_dtcnt_account_selection.account_id);
    is_always_ask = cbm_is_always_ask_account(g_mmi_dtcnt_account_selection.account_id);
    g_entry_option_back_flag = FALSE;

#ifndef __MMI_CBM_ALWAYS_ASK__
        g_mmi_dtcnt_account_selection.always_ask = 0;
#endif /* __MMI_CBM_ALWAYS_ASK__ */

#ifndef __MMI_DUAL_SIM__
        g_mmi_dtcnt_account_selection.sim_info = 0;
#endif /* __MMI_DUAL_SIM__ */
    ...
    if(g_mmi_dtcnt_account_selection.sim_info == DTCNT_SELECT_SIM)
    {
        for (i = 0; g_dtcnt_selections_ext_sim[i].bearer > 0; i++)
        {
            ...
            {
                if (g_mmi_dtcnt_account_selection.always_ask == 0)
                {
                    continue;
                }
                if (is_always_ask)
                {
                    hilighted_item = (U8)nNumofItem;
                }
            }
        #ifdef __MMI_DUAL_SIM__
    ...
    EntryNewScreen(SCR_ID_DTCNT_LIST_ACCOUNT_SELECTION, NULL, mmi_dtcnt_entry_account_bearer_list_with_option, NULL);
    ...
    title_id = STR_GLOBAL_DATA_ACCOUNT;
 ...
 *  
 *****************************************************************************/
void mmi_dtcnt_CBM_select_account(FuncPtrU32Ext callback, U16 AppStrID, U16 AppIconID, U8 bearers, dtcnt_select_type_enum sim_info, dtcnt_select_type_enum always_ask)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* To always show always ask screen */
    mmi_dtcnt_entry_account_bearer_list_with_option_CBM();
...
void mmi_dtcnt_entry_account_bearer_list_with_option_CBM(void)
{
...
#ifndef __MMI_CBM_ALWAYS_ASK__
    g_mmi_dtcnt_always_ask.always_ask = 0;
#endif /* __MMI_CBM_ALWAYS_ASK__ */
#ifndef __MMI_DUAL_SIM__
    g_mmi_dtcnt_always_ask.sim_info = 0;
#endif /* __MMI_DUAL_SIM__ */
    ...
    if(g_mmi_dtcnt_always_ask.sim_info == DTCNT_SELECT_SIM)
    {
        for (i = 0; g_dtcnt_always_ask_selections_sim[i].bearer > 0; i++)
        {
            ...
            if (g_dtcnt_always_ask_selections_sim[i].bearer == DATA_ACCOUNT_BEARER_WIFI)
            {
                ...
                if (IsScreenPresent(SCR_ID_DTCNT_WLAN_MAIN) || IsScreenPresent(SCR_ID_DTCNT_WLAN_WIZARD))
                {
                    continue;
                }
            }
    ...
    EntryNewScreen(SCR_ID_DTCNT_LIST_ALWAYS_ASK, NULL, mmi_dtcnt_entry_account_bearer_list_with_option_CBM, NULL);
    ...
    if(nNumofItem == 0)
    {
        mmi_display_popup((UI_string_type) GetString(STR_ID_DTCNT_NO_AVAIABLE_ACCT), MMI_EVENT_FAILURE);
        DeleteScreenIfPresent(SCR_ID_DTCNT_LIST_ALWAYS_ASK);
        return;
    }
...
static void mmi_dtcnt_csd_viewer(void)
{
    ...
    InitializeCategory57Screen();
    guiBuffer = GetCurrGuiBuffer(SCR_ID_DTCNT_EDIT);
    if (g_DataAccount_Display.is_switch_screen)
    {
        g_DataAccount_Display.is_switch_screen = MMI_FALSE;
        guiBuffer = NULL;
    }
...
static void mmi_dtcnt_show_an_account_rsp(void *info)
{
    ...
    if (bearer_type == CBM_CSD)
    {
        ...
        ReturnThreeDigitString(g_DataAccount_Display.IP5, csd_ptr->sec_dns[0]);
        ReturnThreeDigitString(g_DataAccount_Display.IP6, csd_ptr->sec_dns[1]);
        ReturnThreeDigitString(g_DataAccount_Display.IP7, csd_ptr->sec_dns[2]);
        ReturnThreeDigitString(g_DataAccount_Display.IP8, csd_ptr->sec_dns[3]);
    ...
    else if(bearer_type == CBM_PS)
    {
		...
		g_DataAccount_Display.APN[gprs_ptr->gprs_account.apn_length * ENCODING_LENGTH] = 0x00;
		g_DataAccount_Display.APN[gprs_ptr->gprs_account.apn_length * ENCODING_LENGTH + 1] = 0x00;

        /* Authentication Type */
        g_DataAccount_Display.AuthType = gprs_ptr->gprs_account.authentication_type;

        /* Dns Address */
        ReturnThreeDigitString(g_DataAccount_Display.GPRSIP1, (U8)gprs_ptr->gprs_account.dns[0]);
        ReturnThreeDigitString(g_DataAccount_Display.GPRSIP2, (U8)gprs_ptr->gprs_account.dns[1]);
        ReturnThreeDigitString(g_DataAccount_Display.GPRSIP3, (U8)gprs_ptr->gprs_account.dns[2]);
        ReturnThreeDigitString(g_DataAccount_Display.GPRSIP4, (U8)gprs_ptr->gprs_account.dns[3]);
        ReturnThreeDigitString(g_DataAccount_Display.GPRSIP5, (U8)gprs_ptr->gprs_account.sec_dns[0]);
        ReturnThreeDigitString(g_DataAccount_Display.GPRSIP6, (U8)gprs_ptr->gprs_account.sec_dns[1]);
        ReturnThreeDigitString(g_DataAccount_Display.GPRSIP7, (U8)gprs_ptr->gprs_account.sec_dns[2]);
        ReturnThreeDigitString(g_DataAccount_Display.GPRSIP8, (U8)gprs_ptr->gprs_account.sec_dns[3]);
...
static void mmi_dtcnt_switch_acct_view(void)
{
    ...
    if (g_DataAccount_Display.is_fallback_bearer)
    {
        ...
        g_DataAccount_Display.is_switch_screen = MMI_TRUE;
    }
    else
    {
        mmi_display_popup((UI_string_type) GetString(STR_GLOBAL_ERROR), MMI_EVENT_FAILURE);
...
static void mmi_dtcnt_display_one_acct(void)
{
    ...
    else if (bearer_type == CBM_CSD && profile_id > MAX_DATA_ACCOUNT_GSM_LIMIT)
    {
        /* Invalid CSD account id */
		mmi_display_popup((UI_string_type) GetString(STR_ID_DTCNT_NO_AVAIABLE_ACCT), MMI_EVENT_FAILURE);
    }
#ifdef __MMI_GPRS_FEATURES__
    else if (bearer_type == CBM_PS && profile_id > MAX_DATA_ACCOUNT_GPRS_LIMIT)
    {
 ...
 *  void
 *****************************************************************************/
void mmi_dtcnt_set_GPRS_APN_for_project_mode(S8 *APN, U32 account_id, FuncPtrSetRsp callback)
{
#ifdef __MMI_GPRS_FEATURES__
    ...
    /*----------------------------------------------------------------*/
    cbm_account_info_struct* acct_info = OslMalloc(sizeof(cbm_account_info_struct));
    U8 original_id, bearer, id, index;
    /*----------------------------------------------------------------*/
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    cbm_decode_data_account_id_ext(account_id, acct_info);
    original_id = acct_info->account[0].account_id;
    abm_nw2bearer_id(account_id, &bearer, &id);
    index = mmi_dtcnt_get_GPRS_display_index(id - 1);
    mmi_ucs2cpy((S8*)g_GPRS_DataAccount[index].APN, APN);
    mmi_dtcnt_add_GPRS_account_req(id - 1, index);
    g_set_by_project_mode = 1;
    g_set_GPRS_callback = callback;
    OslMfree(acct_info);
#endif
}
#define DELETE_NOTIFY_INTERFACE
#endif


/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_get_ori_acct_id
 * DESCRIPTION
 *  to get the original account ID
 * PARAMETERS
 *  index_id     
 * RETURNS
 *  U32
...
U32 mmi_dtcnt_get_ori_acct_id(U32 index_id, dtcnt_list_bearer_enum bearer_type)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    if (bearer_type == DTCNT_LIST_BEARER_CSD)
    {
        return index_id;
    }
    else if (bearer_type == DTCNT_LIST_BEARER_GPRS)
    {

        return (U32)(MAX_DATA_ACCOUNT_GSM_LIMIT + index_id);
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_add_del_to_deletion_registration
 * DESCRIPTION
 *  add/delete the context to registration list
 * PARAMETERS
 *  app_id     [in]    registered APP ID
 *  desired_acct_id  [in]  registered account ID
...
dtcnt_deletion_registration_error_enum mmi_dtcnt_add_del_to_deletion_registration_primitive(U8 app_id,U32 desired_acct_id, module_type mod_id, U8 register_flag)
{
    ...
    /*----------------------------------------------------------------*/   
    U8 i, j, k;
    U8 primary_id = 0, secondary_id = 0;
    cbm_account_info_struct acct_info1;
    ...
    if (register_flag)
    {
        /* check the same app_id item, add to array */
        cbm_decode_data_account_id_ext(desired_acct_id, &acct_info1);
        primary_id = acct_info1.account[0].account_id;
    #ifdef __MMI_CBM_BEARER_FALLBACK__
        if (acct_info1.acct_num > 1)
        {
            secondary_id = acct_info1.account[1].account_id;
        }
    #endif        
        for (i = 0; i < CBM_MAX_BEARER_LIST_NUM; i++)
        {
            if ((g_mmi_dtcnt_del_registration[i].valid) && 
                (g_mmi_dtcnt_del_registration[i].app_id == app_id))
            {
                if (desired_acct_id == DTCNT_ALL_NOTIFICATION)
                {
                    memset(g_mmi_dtcnt_del_registration[i].desired_account_id, 0, sizeof(acct_id_struct) * MAX_ACCOUNT_NUM);
                    g_mmi_dtcnt_del_registration[i].desired_account_id[0].acct_complex_flag = 0;
                    g_mmi_dtcnt_del_registration[i].desired_account_id[0].acct_id = DTCNT_ALL_NOTIFICATION;
                    g_mmi_dtcnt_del_registration[i].register_num = 1;
                    g_mmi_dtcnt_del_registration[i].register_type = MMI_DTCNT_PRIMITIVE_NOTIFICATION;
                    return MMI_DTCNT_REGISTER_OK;
                }
                else
                {
                    for (j = 0; j < g_mmi_dtcnt_del_registration[i].register_num; j++)
                    {
                        if (g_mmi_dtcnt_del_registration[i].desired_account_id[j].acct_id == desired_acct_id)
                        {
                            return MMI_DTCNT_REGISTER_OK;
                        }
                    
                    }
                    if (j >= MAX_ACCOUNT_NUM)
                    {
                        return MMI_DTCNT_MAX_NUM_REGISTER;
                    }
                    g_mmi_dtcnt_del_registration[i].desired_account_id[j].acct_id = desired_acct_id;
                    if (acct_info1.acct_num > 1)
                    {
                        g_mmi_dtcnt_del_registration[i].desired_account_id[g_mmi_dtcnt_del_registration[i].register_num].acct_complex_flag = 1;
                    }
                    else
                    {
                        g_mmi_dtcnt_del_registration[i].desired_account_id[g_mmi_dtcnt_del_registration[i].register_num].acct_complex_flag = 0;
                    }
                    g_mmi_dtcnt_del_registration[i].register_num++;
                    g_mmi_dtcnt_del_registration[i].register_type = MMI_DTCNT_PRIMITIVE_NOTIFICATION;
                }
            }
        }
        ...
        for (i = 0; i < CBM_MAX_BEARER_LIST_NUM; i++)
        {
            if (!g_mmi_dtcnt_del_registration[i].valid)
            {
                if (desired_acct_id == DTCNT_ALL_NOTIFICATION)
                {
                    g_mmi_dtcnt_del_registration[i].valid = 1;
                    g_mmi_dtcnt_del_registration[i].app_id = app_id;
                    g_mmi_dtcnt_del_registration[i].mod_id = mod_id;
                    g_mmi_dtcnt_del_registration[i].desired_account_id[0].acct_complex_flag = 0;
                    g_mmi_dtcnt_del_registration[i].desired_account_id[0].acct_id = DTCNT_ALL_NOTIFICATION;
                    g_mmi_dtcnt_del_registration[i].register_num = 1;
                    g_mmi_dtcnt_del_registration[i].register_type = MMI_DTCNT_PRIMITIVE_NOTIFICATION;
                ...
                else
                {
                    ...
                    g_mmi_dtcnt_del_registration[i].app_id = app_id;
                    g_mmi_dtcnt_del_registration[i].mod_id = mod_id;
                    g_mmi_dtcnt_del_registration[i].desired_account_id[g_mmi_dtcnt_del_registration[i].register_num].acct_id = desired_acct_id;
                    if (acct_info1.acct_num > 1)
                    {
                        g_mmi_dtcnt_del_registration[i].desired_account_id[g_mmi_dtcnt_del_registration[i].register_num].acct_complex_flag = 1;
                    }
                    ...
                    g_mmi_dtcnt_del_registration[i].register_num++;
                    g_mmi_dtcnt_deletion_registration_num++;
                    g_mmi_dtcnt_del_registration[i].register_type = MMI_DTCNT_PRIMITIVE_NOTIFICATION;
                    return MMI_DTCNT_REGISTER_OK;
                }
            }
    ...
    else
    {
        for (i = 0; i < CBM_MAX_BEARER_LIST_NUM; i++)
        {
                ...
                (g_mmi_dtcnt_del_registration[i].app_id == app_id))
            {
                if (desired_acct_id == DTCNT_ALL_NOTIFICATION)
                {
                    memset(&g_mmi_dtcnt_del_registration[i], 0, sizeof(mmi_dtcnt_deletion_notify_registration_struct));
                    g_mmi_dtcnt_deletion_registration_num--;
                    return MMI_DTCNT_DEREGISTER_OK;
                }
                else
                {
                    for (j = 0; j < g_mmi_dtcnt_del_registration[i].register_num; j++)
                    {
                        if (g_mmi_dtcnt_del_registration[i].desired_account_id[j].acct_id == desired_acct_id)
                        {
                            for(k = j; k < g_mmi_dtcnt_del_registration[i].register_num - 1; k++)
                            {
                                g_mmi_dtcnt_del_registration[i].desired_account_id[k] = g_mmi_dtcnt_del_registration[i].desired_account_id[k + 1];
                            }
                            memset(&g_mmi_dtcnt_del_registration[i].desired_account_id[k], 0 , sizeof(acct_id_struct)); 
                            g_mmi_dtcnt_del_registration[i].register_num--;
                            if (g_mmi_dtcnt_del_registration[i].register_num == 0)
                            {
                                g_mmi_dtcnt_del_registration[i].app_id = 0;
                                g_mmi_dtcnt_del_registration[i].callback = 0;
                                g_mmi_dtcnt_del_registration[i].mod_id = 0;
                                g_mmi_dtcnt_del_registration[i].register_type = 0;
                                g_mmi_dtcnt_del_registration[i].valid = 0;
                                g_mmi_dtcnt_deletion_registration_num--;
                            }
                            return MMI_DTCNT_DEREGISTER_OK;
                        }
                    }
                    return MMI_DTCNT_DEREGISTER_ERROR;
                }
            }
        }
        return MMI_DTCNT_DEREGISTER_ERROR;
 ...
 *  dtcnt_deletion_registration_error_enum
 *****************************************************************************/
dtcnt_deletion_registration_error_enum mmi_dtcnt_add_del_to_deletion_registration(U8 app_id,U32 desired_acct_id, FuncPtrDtcntDeletion callback)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/   
        ...
        for (i = 0; i < CBM_MAX_BEARER_LIST_NUM; i++)
        {
                ...
                (g_mmi_dtcnt_del_registration[i].app_id == app_id))
            {
                if (desired_acct_id == DTCNT_ALL_NOTIFICATION)
                {
                    ...
                    g_mmi_dtcnt_del_registration[i].desired_account_id[0].acct_id = DTCNT_ALL_NOTIFICATION;
                    g_mmi_dtcnt_del_registration[i].register_num = 1;
                    g_mmi_dtcnt_del_registration[i].register_type = MMI_DTCNT_CALLBACK_NOTIFICATION;
                    if (g_mmi_dtcnt_del_registration[i].callback != callback)
                    {
                        return MMI_DTCNT_REGISTER_CALLBACK_ALREADY;
                    }
                    else
                    {
                        return MMI_DTCNT_REGISTER_OK;
        ...
        for (i = 0; i < CBM_MAX_BEARER_LIST_NUM; i++)
        {
            if (!g_mmi_dtcnt_del_registration[i].valid)
            {
                if (desired_acct_id == DTCNT_ALL_NOTIFICATION)
                {
                    g_mmi_dtcnt_del_registration[i].valid = 1;
                    g_mmi_dtcnt_del_registration[i].app_id = app_id;
                    g_mmi_dtcnt_del_registration[i].callback = callback;
                    g_mmi_dtcnt_del_registration[i].desired_account_id[0].acct_complex_flag = 0;
                    g_mmi_dtcnt_del_registration[i].desired_account_id[0].acct_id = DTCNT_ALL_NOTIFICATION;
                    g_mmi_dtcnt_del_registration[i].register_num = 1;
                    g_mmi_dtcnt_del_registration[i].register_type = MMI_DTCNT_CALLBACK_NOTIFICATION;
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_delete_notify
 * DESCRIPTION
 *  To notify all the application that registerred 
 * PARAMETERS
 *  bearer_type     [in]    Bearer type only used for DTCNT_LIST_BEARER_CSD and DTCNT_LIST_BEARER_GPRS,
 *  disp_index  [in]  The highlighted index
 * RETURNS
 *  void
 *****************************************************************************/
void mmi_dtcnt_delete_notify(dtcnt_list_bearer_enum bearer_type, U8 disp_index)
{
    ...
    /*----------------------------------------------------------------*/   
    U8 i = 0;
    FuncPtrDtcntDeletion notification_callback = NULL;
    U8 app_id = 0;
    U32 reg_acct_id = 0;
    U32 ori_acct_id = 0;
    module_type mod_id = 0;
    MMI_BOOL ret_val;
    ...
    if (bearer_type == DTCNT_LIST_BEARER_CSD)
    {
        ori_acct_id = mmi_dtcnt_get_ori_acct_id(g_DataAccount[disp_index].org_acct_id, DTCNT_LIST_BEARER_CSD);    
        for (i = 0; i < CBM_MAX_BEARER_LIST_NUM; i++)
        {
            if (g_mmi_dtcnt_del_registration[i].valid)
            {
                if (g_mmi_dtcnt_del_registration[i].register_type == MMI_DTCNT_CALLBACK_NOTIFICATION)
                {
                    ret_val = mmi_dtcnt_get_deletion_notify_callback(ori_acct_id, &app_id, &reg_acct_id, &notification_callback, i);
                    if (notification_callback && ret_val == MMI_TRUE)
                    {
                        notification_callback(app_id, reg_acct_id, DATA_ACCOUNT_BEARER_CSD);
                    }
                }
                else if (g_mmi_dtcnt_del_registration[i].register_type == MMI_DTCNT_PRIMITIVE_NOTIFICATION)
                {
                    ret_val = mmi_dtcnt_get_deletion_notify_primitive(ori_acct_id, &app_id, &reg_acct_id, &mod_id, i);
                    if (ret_val == MMI_TRUE)
                    {
                        mmi_dtcnt_send_acct_deletion_notification(app_id, reg_acct_id, (dtcnt_list_bearer_enum)DATA_ACCOUNT_BEARER_CSD, mod_id);
                    }
                }
            }
        }
    ...
    {
        ori_acct_id = mmi_dtcnt_get_ori_acct_id(g_GPRS_DataAccount[disp_index].org_acct_id, DTCNT_LIST_BEARER_GPRS);    
        for (i = 0; i < CBM_MAX_BEARER_LIST_NUM; i++)
        {
            if (g_mmi_dtcnt_del_registration[i].valid)
            {
                if (g_mmi_dtcnt_del_registration[i].register_type == MMI_DTCNT_CALLBACK_NOTIFICATION)
                {
                    ...
                    if (notification_callback && ret_val == MMI_TRUE)
                    {
                        notification_callback(app_id, reg_acct_id, DATA_ACCOUNT_BEARER_GPRS);
                    }
                }
                else if (g_mmi_dtcnt_del_registration[i].register_type == MMI_DTCNT_PRIMITIVE_NOTIFICATION)
                {
                    ...
                    if (ret_val == MMI_TRUE)
                    {
                        mmi_dtcnt_send_acct_deletion_notification(app_id, reg_acct_id, (dtcnt_list_bearer_enum)DATA_ACCOUNT_BEARER_GPRS, mod_id);
                    }
                }
            }
        }
...
#endif
	mmi_dtcnt_register_deletion_notify(app_id, reg_acct_id, NULL);
}


/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_get_deletion_notify_callback
 * DESCRIPTION
 *  To get all the callback by acct_id 
 * PARAMETERS
 *  ori_acct_id     [in]    original account ID
 *  app_id  [out]  app ID
 *  reg_acct_id  [out]  the registerred account ID
...
MMI_BOOL mmi_dtcnt_get_deletion_notify_callback(U32 ori_acct_id, U8 *app_id, U32 *reg_acct_id, FuncPtrDtcntDeletion *p_callback, U8 index)
{
    ...
    if (g_mmi_dtcnt_del_registration[index].valid)
    {
        for (j = 0; j < g_mmi_dtcnt_del_registration[index].register_num; j++)
        {
            desired_acct_id = g_mmi_dtcnt_del_registration[index].desired_account_id[j].acct_id;
            cbm_decode_data_account_id_ext(desired_acct_id, &acct_info1);
            primary_id = acct_info1.account[0].account_id;
    #ifdef __MMI_CBM_BEARER_FALLBACK__
            if (acct_info1.acct_num > 1)
    ...
    #endif		 
            if (primary_id == ori_acct_id || 
                (secondary_id == ori_acct_id && acct_info1.acct_num > 1) ||
                g_mmi_dtcnt_del_registration[index].desired_account_id[j].acct_id == DTCNT_ALL_NOTIFICATION)
            {
                /* if not register by callback continue search */                
                if (g_mmi_dtcnt_del_registration[index].register_type == MMI_DTCNT_PRIMITIVE_NOTIFICATION)
                {
                    continue;
                }
                *app_id = g_mmi_dtcnt_del_registration[index].app_id;
                *reg_acct_id = g_mmi_dtcnt_del_registration[index].desired_account_id[j].acct_id;
                 if (g_mmi_dtcnt_del_registration[index].desired_account_id[j].acct_id == DTCNT_ALL_NOTIFICATION)
                 {
                     *reg_acct_id = ori_acct_id;
                 }
                *p_callback = g_mmi_dtcnt_del_registration[index].callback;
                return MMI_TRUE;
            }
        }
        return MMI_FALSE;
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_get_deletion_notify_primitive
 * DESCRIPTION
 *  To get all the primitive by acct_id 
 * PARAMETERS
 *  ori_acct_id     [in]    original account ID
 *  app_id  [out]  app ID
 *  reg_acct_id  [out]  the registerred account ID
 *  mod_id    [out]  the mod ID
 * RETURNS
 *  MMI_BOOL
 *****************************************************************************/
MMI_BOOL mmi_dtcnt_get_deletion_notify_primitive(U32 ori_acct_id, U8 *app_id, U32 *reg_acct_id, module_type *mod_id, U8 index)
    ...
    if (g_mmi_dtcnt_del_registration[index].valid)
    {
        for (j = 0; j < g_mmi_dtcnt_del_registration[index].register_num; j++)
        {
            ...
            if (primary_id == ori_acct_id || 
                ...
                g_mmi_dtcnt_del_registration[index].desired_account_id[j].acct_id == DTCNT_ALL_NOTIFICATION)
            {
                /* if not register by primitive continue search */
                if (g_mmi_dtcnt_del_registration[index].register_type == MMI_DTCNT_CALLBACK_NOTIFICATION)
                {
                    continue;
                }
                *app_id = g_mmi_dtcnt_del_registration[index].app_id;
                ...
                *mod_id = g_mmi_dtcnt_del_registration[index].mod_id;
                return MMI_TRUE;
            }
        }
        return MMI_FALSE;
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_send_register_deletion_notification_cnf
 * DESCRIPTION
 *  To send the register deletion notification confirm
 * PARAMETERS
 *  app_id     [in]    registerred app_id
 *  app_id  [out]  app ID
 *  reg_acct_id  [out]  the registerred account ID
 *  mod_id    [out]  the mod ID
 * RETURNS
...
void mmi_dtcnt_send_register_deletion_notification_cnf(U8 app_id, U32 reg_acct_id, U8 register_flag, module_type mod_id, MMI_BOOL register_result)
{
    ...
    /*----------------------------------------------------------------*/
    MYQUEUE Message;
    mmi_dtcnt_register_deletion_notify_cnf_struct *register_cnf;
    
    /*----------------------------------------------------------------*/
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    register_cnf = (mmi_dtcnt_register_deletion_notify_cnf_struct*) OslConstructDataPtr(sizeof(mmi_dtcnt_register_deletion_notify_cnf_struct));
...
///              register_result);
    ...
    register_cnf->app_id = app_id;
    register_cnf->desired_acct_id = reg_acct_id;
    register_cnf->register_flag = register_flag;
    register_cnf->result = register_result;
	
    Message.oslSrcId  = MOD_MMI;
    Message.oslDestId = mod_id;
    Message.oslMsgId  = MSG_ID_MMI_DTCNT_REGISTER_DELETION_NOTIFY_CNF;
    Message.oslDataPtr = (oslParaType*)register_cnf;
    Message.oslPeerBuffPtr = NULL;
    OslMsgSendExtQueue(&Message);
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_send_acct_deletion_notification
 * DESCRIPTION
 *  To get all the primitive by acct_id 
 * PARAMETERS
 *  ori_acct_id     [in]    original account ID
 ...
 *  void
 *****************************************************************************/
void mmi_dtcnt_send_acct_deletion_notification(U8 app_id, U32 reg_acct_id, dtcnt_list_bearer_enum bearer_type, module_type mod_id)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    MYQUEUE Message;
    mmi_dtcnt_deletion_notify_ind_struct *deletion_notification;
    
    /*----------------------------------------------------------------*/
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    deletion_notification = (mmi_dtcnt_deletion_notify_ind_struct*) OslConstructDataPtr(sizeof(mmi_dtcnt_deletion_notify_ind_struct));
    
///    MMI_TRACE(MMI_CONN_TRC_INFO, MMI_DTCNT_DELETION_NOTIFICATION_IND, 
///    	      app_id,
///    	      reg_acct_id,
///    	      bearer_type,
///    	      mod_id);
    
    deletion_notification->app_id = app_id;
    deletion_notification->desired_acct_id = reg_acct_id;
    deletion_notification->bearer_type = bearer_type;

    
    Message.oslSrcId  = MOD_MMI;
    Message.oslDestId = mod_id;
    Message.oslMsgId  = MSG_ID_MMI_DTCNT_DELETION_NOTIFY_IND;
    Message.oslDataPtr = (oslParaType*)deletion_notification;
    Message.oslPeerBuffPtr = NULL;
    OslMsgSendExtQueue(&Message);
...
/*****************************************************************************
 * FUNCTION
 *  mmi_dtcnt_register_deletion_notify
 * DESCRIPTION
 *  A interface for MMI task to register account deletion notify
 * PARAMETERS
 *  app_id     [in]    registered APP ID
 *  desired_acct_id  [in]  registered account ID
 *  callback    [in]  callback function
 ...
 *  MMI_BOOL
 *****************************************************************************/
MMI_BOOL mmi_dtcnt_register_deletion_notify(U8 app_id,U32 desired_acct_id, FuncPtrDtcntDeletion callback)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    ret_val = mmi_dtcnt_add_del_to_deletion_registration(app_id, desired_acct_id, callback);
    if (ret_val == MMI_DTCNT_REGISTER_OK || ret_val == MMI_DTCNT_DEREGISTER_OK)
    {
        return MMI_TRUE;
    }
