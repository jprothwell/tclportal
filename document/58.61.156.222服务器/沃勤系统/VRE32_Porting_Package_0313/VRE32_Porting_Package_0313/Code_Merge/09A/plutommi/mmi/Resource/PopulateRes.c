...
extern void PopulateMDIRes(void);
...
extern void PopulateWAPProfRes(void) ;
#endif
...
extern void PopulateWAPUriSchemeHdlrResource(void);
#endif
...
extern void PopulateFileMgrResource(void);
...
#if defined(__MMI_PROV_INBOX_SUPPORT__)
...
extern void PopulateConnectivity(void);
...
/* ipsec settings */
#ifdef __MMI_IPSEC__
extern void PopulateIPSecAppRes();
#endif /* __MMI_IPSEC__ */
...
extern void PopulateAnswerMachineRes(void);
#endif
...
extern void PopulateSoftwareTracerRes(void);
#endif  
...
#if defined(__GGLIVEE_SUPPORT__)
extern void PopulateGGLiveRes(void);    
#endif 
...
void PopulateResData(void)
{
    ...
    font_data_lis = fopen("vf_obj.txt", "w");
    //fprintf(font_data_lis, "COMPOBJS += \n");
    MYFCLOSE(font_data_lis, "vf_obj.txt");

    font_data_lis = fopen("vf_modis_obj.txt", "w");    
    MYFCLOSE(font_data_lis, "vf_modis_obj.txt");

    font_data_lis = fopen("vf_obj.txt", "a");
    font_data_modis_lis = fopen("vf_modis_obj.txt", "a");
    printf("[FONT]vf_obj.txt open\n");
   ...
   *****************************************************************************/
    ...
    ADD_APPLICATION(APP_ECOMPASS, "ECompass", ECOMPASS_BASE, ECOMPASS_BASE_MAX);
...
#ifdef __MMI_WAP_PROF__
	ADD_APPLICATION(APP_MMI_WAP_PROF, "Profile/Provisioning APP for WAP & MMS", MMI_WAP_PROF_BASE, MMI_WAP_PROF_BASE_MAX);
#endif
    ...
    ADD_APPLICATION(APP_AUTOAM,"Auto Answer Machine", AUTOAM_BASE, AUTOAM_BASE_MAX);
#endif

#if defined(__MMI_MEDIA_PLAYER__)
    ADD_APPLICATION(APP_MEDPLY,"Media Player", MEDPLY_BASE, MEDPLY_BASE_MAX);
#endif

#ifdef __MMI_UDX_SUPPORT__
    ADD_APPLICATION(APP_UDX, "UDX Agent", UDX_BASE, UDX_BASE_MAX);
#endif
    for (i = 0; i < MAX_IMAGE_IDS_SIZE; i++)
    {
        ImageIdMap[i].nImageNum = -1;
...
/* under construction !*/
    ...
    RES_PRINT_INFO("Populating Golbal Resources\n");
    PopulateGlobalData();

    RES_PRINT_INFO("Populating Main Menu Resources\n");
    PopulateMainMenuRes();

    RES_PRINT_INFO("Populating Idle Menu Resources\n");
    PopulateIdleMenuRes();

    RES_PRINT_INFO("Populating Phone Book Resources\n");
    PopulatePbResData();

    RES_PRINT_INFO("Populating Main Demo Resources\n");
    PopulateMainDemoRes();

    RES_PRINT_INFO("Populating Setting Resources\n");
    populateSettingMenu();

    RES_PRINT_INFO("Populating Fun & Games Resources\n");
    populateFunAndGamesMenu();

    RES_PRINT_INFO("Populating SIM Detect Resources\n");
    PopulateSimDetectionMenuRes();

    RES_PRINT_INFO("Populating Charger Power On Resources\n");
    PopulateChgrPwrOnScrRes();

    RES_PRINT_INFO("Populating Common Screen Resources\n");
    PopulateCommonScreensResData();

    RES_PRINT_INFO("Populating EMS object Resources\n");
    PopulateEMSObjectResources();

    RES_PRINT_INFO("Populating CM Resources\n");
    PopulateCmResData();

    RES_PRINT_INFO("Populating Quick Access Resources\n");
    PopulateQuickAccessData();


    RES_PRINT_INFO("Populating Profiles Resources\n");
    PopulateprofileMenu();

    RES_PRINT_INFO("Populating SSC Resources\n");
    PopulateSSCRes();

    RES_PRINT_INFO("Populating Call History Resources\n");
    PopulateCallHistoryRes();

    RES_PRINT_INFO("Populating Call History Resources\n");
    PopulateDataAccountMenuList();

    RES_PRINT_INFO("Populating MDI Resources\n");
    PopulateMDIRes();

#ifdef __MMI_IPSEC__
    RES_PRINT_INFO("Populating IPSec Settings Resources\n");
    PopulateIPSecAppRes();
#endif /* __MMI_IPSEC__ */

    RES_PRINT_INFO("Populating Organizer Resources\n");
    PopulateOrganizerRes();

#ifdef __MMI_HIJRI_CALENDAR__
    RES_PRINT_INFO("Populating hijri calendar resources\n");
    PopulateHijriCalendarRes();
#endif

#ifdef __MMI_INDICAL__
	RES_PRINT_INFO("Populating Indian Calendar Resources\n");
    PopulateIndianCalendarRes();
#endif
		
    RES_PRINT_INFO("Populating Extra Resources\n");
    PopulateExtraRes();

    RES_PRINT_INFO("Populating Alarm Resources\n");
    PopulateAlarmRes();

    RES_PRINT_INFO("Populating SPOF Resources\n");
    PopulateSpofRes();

    RES_PRINT_INFO("Populating Calendar Resources\n");
    PopulateResourcesCal();

    RES_PRINT_INFO("Populating ToDo Resources\n");
    PopulateToDoList();

    RES_PRINT_INFO("Populating vObjects Resource\n");
    PopulatevObjectRes();

    RES_PRINT_INFO("Populating Help Resources\n");
    PopulateHelpResources();

#if defined(__MMI_EM_MISC_SOFTWARE_TRACER__)
    RES_PRINT_INFO("Populating SWTR Resources\n");
    PopulateSoftwareTracerRes();
#endif

#if defined(__MMI_AUTO_ANSWER_MACHINE__)
    RES_PRINT_INFO(("Populating Auto Answer Machine Resource\n"));
    PopulateAnswerMachineRes();
#endif /*__MMI_AUTO_ANSWER_MACHINE__*/


#ifdef __CERTMAN_SUPPORT__
	RES_PRINT_INFO("Populating CertificateManager\n");
	PopulateCertManRes();
#endif /*__CERTMAN_SUPPORT__*/
...
/* under construction !*/
#endif /* 0 */ 
    RES_PRINT_INFO("Populating MMIAPI Resource\n");
    PopulateMmiapiRes();

#ifdef __MOD_SMSAL__
    RES_PRINT_INFO("Populating Messages Resources\n");
...
#ifdef __MMI_MMS_POSTCARD__
    PopulateMMSPostcardResData();
#endif

#ifdef __MMI_EMAIL__
    RES_PRINT_INFO("Populating Email Resources\n");
    EmailResourceData();
#endif /* __MMI_EMAIL__ */ 

#ifdef __MMI_IMPS__
    RES_PRINT_INFO("Populating IMPS Resources\n");
    PopulateIMPSData();
#endif /* __MMI_IMPS__ */ 

#ifdef __SAT__
    RES_PRINT_INFO("Populating SAT Resources\n");
    PopulateSATRes();
#endif /* __SAT__ */ 

#if defined(JATAAYU_SUPPORT)
    RES_PRINT_INFO("Populating Jataayu Browser Resources\n");
    PopulateJaatayuBrowserRes();
    RES_PRINT_INFO("Populating Jataayu Provisioning Resources\n");
    PopulateJaatayuProvisioningRes();
    RES_PRINT_INFO("Populating Jataayu JDD Resources\n");
    PopulateJataayuJDDRes();
#endif /* defined(JATAAYU_SUPPORT) */ 

#ifdef __MMI_WAP_PROF__
    RES_PRINT_INFO("Populating WAP PROF Resources\n");
    PopulateWAPProfRes();
#endif

#ifdef __MMI_BROWSER_2__
    RES_PRINT_INFO("Populating Browser Resources\n");
    PopulateBrowserRes();
#endif /* __MMI_BROWSER_2__ */
#ifdef __MMI_ENGINEER_MODE__
    RES_PRINT_INFO("Populating EM Resources\n");
    populateEngineerModeMenu();
#endif /* __MMI_ENGINEER_MODE__ */ 

#ifdef __MMI_FACTORY_MODE__
    RES_PRINT_INFO("Populating FM Resources\n");
    populateFactoryModeMenu();
#endif /* __MMI_FACTORY_MODE__ */ 

#ifdef __MMI_AUDIO_PLAYER__
    RES_PRINT_INFO("Populating Audio Player Resources\n");
    populateAudioPlayerMenu();
#else /* __MMI_AUDIO_PLAYER__ */ 
    RES_PRINT_INFO("Populating Audio Simple Player Resources\n");
    populateAudioPlayerMenu();
#endif /* __MMI_AUDIO_PLAYER__ */ 

#ifdef __MMI_AB_REPEATER__
    RES_PRINT_INFO("Populating AB Repeater Resources\n");
    populateABRepeaterMenu();
#endif /* __MMI_AB_REPEATER__ */ 

#ifdef __MMI_SOUND_RECORDER__
    RES_PRINT_INFO("Populating Sound Recorder Resources\n");
    populateSoundRecorderMenu();
#endif /* __MMI_SOUND_RECORDER__ */ 

#ifdef __MMI_FILE_MANAGER__
    RES_PRINT_INFO("Populating File Manager Resources\n");
    PopulateFileMgrResource();
    PopulateFileMgrServiceResource();
#endif /* __MMI_FILE_MANAGER__ */ 

#ifdef __MMI_VIDEO_PLAYER__
    RES_PRINT_INFO("Populating Video Player Resources\n");
    PopulateVdoPlyRes();
#endif /* __MMI_VIDEO_PLAYER__ */ 

#if defined(__MMI_STREAMING__)
    RES_PRINT_INFO("Populating Streaming Setting Resources\n");
    PopulateStreamingRes();
#endif /* __MMI_STREAMING__ */ 
#if defined(__MMI_VIDEO_RECORDER__) && !defined(__MMI_CAMCORDER__)
    RES_PRINT_INFO("Populating Video Recoder Resources\n");
    PopulateVdoRecRes();
#endif /* defined(__MMI_VIDEO_RECORDER__) && !defined(__MMI_CAMCORDER__) */

#ifdef __MMI_VIDEO_EDITOR__
    RES_PRINT_INFO("Populating Video Editor Resources\n");
    PopulateVdoEdtRes();
#endif

#if defined(__MMI_MEDIA_PLAYER__)
    RES_PRINT_INFO("Populating Media player Resources\n");
    PopulateMediaPlayerRes();
#endif

#ifdef __MMI_NITZ__
    RES_PRINT_INFO("Populating NITZ Resources\n");
    PopulateResourceNITZ();
#endif /* __MMI_NITZ__ */ 

#ifdef __MMI_PICTURE_EDITOR_SUPPORT__
    RES_PRINT_INFO("End Populating Image Editor\n");
    PopulatePictureEditor();
#endif /* __MMI_PICTURE_EDITOR_SUPPORT__ */ 

#ifdef __MMI_STOPWATCH__
    RES_PRINT_INFO("Populating StopWatch Resources\n");
    PopulateStopwatchRes();
#endif /* __MMI_STOPWATCH__ */ 

#if defined(__MMI_RING_COMPOSER__) && defined(__MMI_IMELODY_SUPPORT__)
    RES_PRINT_INFO("Populating Compose RingTone\n");
    PopulateComposeRingTone();
#endif /* defined(__MMI_RING_COMPOSER__) && defined(__MMI_IMELODY_SUPPORT__) */ 

#if defined (__MMI_CAMERA__) && !defined(__MMI_CAMCORDER__)
    RES_PRINT_INFO("Populating Camera Resource\n");
    PopulateCameraRes();
#endif /* defined (__MMI_CAMERA__) && !defined(__MMI_CAMCORDER__) */ 

#ifdef __MMI_BARCODEREADER__
    RES_PRINT_INFO("Populating Barcode Reader Resource\n");
    PopulateBarcodeReaderRes();
#endif /* __MMI_BARCODEREADER__ */ 

#ifdef __MMI_BCR__
    RES_PRINT_INFO("Populating bcr Resource\n");
    PopulateBCRRes();
#endif /* __MMI_BCR__ */ 

#if defined(__MMI_CAMCORDER__)
    RES_PRINT_INFO("Populating Camcorder Resource\n");
    PopulateCamcorderRes();
#endif

#ifdef __MMI_AVATAR__
    RES_PRINT_INFO("Populating Avatar Resource\n");
    PopulateAvatarRes();
#endif /* __MMI_AVATAR__ */

#ifdef __MMI_A2DP_SUPPORT__
    RES_PRINT_INFO("Populating AVBT Resource\n");
    PopulateAVBTRes();
#endif /*__MMI_A2DP_SUPPORT__*/

#ifdef __MMI_MOBILE_TV_PLAYER__
    RES_PRINT_INFO("Populating Mobile TV Player Resource\n");
    PopulateMobileTVPlayerRes();
#endif /* __MMI_MOBILE_TV_PLAYER__ */

#ifdef __MMI_IMAGE_VIEWER__
    RES_PRINT_INFO("Populating Image Viewer Resource\n");
    PopulateImageViewerRes();
#endif /* __MMI_IMAGE_VIEWER__ */ 

#ifdef __MMI_FM_RADIO__
    RES_PRINT_INFO("Populating FM Radio Resource\n");
    PopulateFMRadioRes();
#endif /* __MMI_FM_RADIO__ */ 

#ifdef __MMI_FM_RADIO_SCHEDULE_REC__
    RES_PRINT_INFO("Populating Schedule FM Radio Record Resource\n");
    PopulateFMScheduleRecRes();
#endif /* __MMI_FM_RADIO_SCHEDULE_REC__ */ 

#if defined(__MMI_PHOTOEDITOR__)
    RES_PRINT_INFO("Populating PhotoEditor Resource\n");
    PopulatePhotoEditorRes();
#endif /* defined(__MMI_PHOTOEDITOR__) */ 

#if defined(__MMI_SLIDESHOW__)
    RES_PRINT_INFO("Populating Slideshow Resource\n");
...
#if defined (__MMI_EXT_DEVICE__)
#ifdef __MMI_USB_SUPPORT__
    RES_PRINT_INFO("Populating USB Resource\n");
    PopulateExtDevUSBRes();
#endif /* __MMI_USB_SUPPORT__ */ 

#ifdef __MMI_IRDA_SUPPORT__
    RES_PRINT_INFO("Populating IRDA Resource\n");
    PopulateExtDevIrDARes();
#endif /* __MMI_IRDA_SUPPORT__ */ 


#ifdef __MMI_BT_SUPPORT__
    RES_PRINT_INFO("Populating Bluetooth Resource\n");
    PopulateExtDevBTRes();
#endif /* __MMI_BT_SUPPORT__ */ 
#endif /* defined (__MMI_EXT_DEVICE__) */ 

#if defined(__MMI_VRSD__)
    RES_PRINT_INFO("Populating Voice Recognition SD Resource\n");
    PopulateVRSDRes();
#endif /* defined(__MMI_VRSD__) */ 

#if defined(__MMI_VRSI__)
    RES_PRINT_INFO("Populating Voice Recognition SI Resource\n");
    PopulateVRSIRes();
#endif /* defined(__MMI_VRSI__) */ 

#if defined(__MMI_BG_SOUND_EFFECT__)
    RES_PRINT_INFO("Populating Background Sound Resource\n");
    PopulateBGSoundRes();
#endif /* defined(__MMI_BG_SOUND_EFFECT__) */ 

#if defined(WAP_SUPPORT) || defined(__MMI_MMS__)
    RES_PRINT_INFO("Populating WAP Resource\n");
    PopulateWapRes();
#endif /* defined(WAP_SUPPORT) || defined(__MMI_MMS__) */ 

#ifdef __MMI_POC__
    RES_PRINT_INFO("Populating PoC Resources\n");
    PoCResourceData();
#endif /* __MMI_POC__ */ 

#ifdef __MMI_VOIP__
    RES_PRINT_INFO("Populating VoIP Resources\n");
    VoIPResourceData();
#endif /* __MMI_VOIP__ */

#ifdef __MMI_UCM__
    RES_PRINT_INFO("Populating UCM Resources\n");
    UCMResourceData();
#endif /* __MMI_UCM__ */

#ifdef __MMI_VIDEO_TELEPHONY__
    RES_PRINT_INFO("Populating VT Resources\n");
    VTResourceData();
#endif /* __MMI_VIDEO_TELEPHONY__ */

#ifdef __SYNCML_SUPPORT__
    RES_PRINT_INFO("Populating SyncML Resources\n");
    SyncMLResourceData();
#endif /* __SYNCML_SUPPORT__ */ 

#ifdef __MMI_CSB_BROWSER__
	RES_PRINT_INFO("Populating CS Browser Resources\n");
    ...
    RES_PRINT_INFO("Populating BIP Resource\n");
#endif /* __MMI_BIP_SUPPORT__ */ 

#ifdef __MMI_DOWNLOAD_AGENT__
    RES_PRINT_INFO("Populating Download Agent Resources\n");
    PopulateDownloadAgentRes();
#endif /* __MMI_DOWNLOAD_AGENT__ */ 
#ifdef __MMI_SWFLASH__
	RES_PRINT_INFO("Populating SWFlash Resource\n");	
	PopulateSWFlashRes();
...
#ifdef __FOTA_ENABLE__
    RES_PRINT_INFO("Populating FOTA Resource\n");	
    PopulateFOTAData();
#endif /* __FOTA_ENABLE__ */

#ifdef __MMI_WEBCAM__
    RES_PRINT_INFO("Populating Webcam Resource\n");	
    PopulateWebcamData();
#endif /* __MMI_WEBCAM__ */

#ifdef __CCA_SUPPORT__
    RES_PRINT_INFO("Populating CCA Resource\n");	
    PopulateCCARes();
#endif

#ifdef __MMI_RMGR__
    RES_PRINT_INFO("Populating Rights Manager Resources\n");
    PopulateRightsMgrRes();
#endif

#ifdef __DRM_SUPPORT__
    RES_PRINT_INFO("Populating DRM Task Resources\n");
    PopulateDRMRes();
#endif
...
#ifdef __MMI_MMS_BGSR_SUPPORT__
    RES_PRINT_INFO("Populating MMS BGSR\n");
    PopulateMMSBGSRResData();
#endif /*__MMI_MMS_BGSR_SUPPORT__*/    

#ifdef SYNCML_DM_SUPPORT
    RES_PRINT_INFO("Populating DMUI Resource\n");  
    PopulateDMUIRes();
#endif

    RES_PRINT_INFO("Populating Connectivity Resource\n");	
    PopulateConnectivity();

#if defined(__MMI_LANGLN__)
    RES_PRINT_INFO("Populating Language Learning Resource\n");
    PopulateLangLnRes();
#endif /* defined(__MMI_LANGLN__) */ 

#if defined(__MMI_MAPBAR_GIS__) || defined(__MMI_SUNAVI_GIS__) || defined(__MMI_MIGO_GIS__)
    RES_PRINT_INFO("Populating GIS Resource\n");
    PopulateGISRes();
#endif 

#ifdef __MMI_CBM_CONNECTION_MANAGER__
    RES_PRINT_INFO("Populating Connection Management Resource\n");
    PopulateConnManageRes();
...
#if (defined(OBIGO_Q03C) && defined(__MMI_URI_AGENT__))
	PopulateWAPUriSchemeHdlrResource();
#endif

#if defined(__MMI_VECTOR_FONT_SUPPORT__)
    RES_PRINT_INFO("Populating Vector Font Resource\n");
    PopulateFontResource();
#endif


#if defined(__GPS_SUPPORT__) || defined(__BT_GPS_SUPPORT__)
    RES_PRINT_INFO(("Populating GPS Resource\n"));
    PopulateGPS();
#endif

#ifdef __MMI_UDX_SUPPORT__
    RES_PRINT_INFO(("Populating UDX Agent Resource"));
    PopulateUDXRes();
#endif

#ifdef __QQIM_SUPPORT__
    RES_PRINT_INFO(("Populating QQIM Resource\n"));
    PopulateQQRes();
#endif

#if defined(__UCWEB6__)
    RES_PRINT_INFO("Populating UCWEB Resource\n");
    PopulateUCWEBRes();
#endif 

#ifdef __A8BOX_SUPPORT__
    RES_PRINT_INFO(("Populating A8BOX Resource\n"));
    PopulateA8boxRes();
#endif

#ifdef __GGLIVE_SUPPORT__
    RES_PRINT_INFO(("Populating GGLive Resource\n"));
    PopulateGGLiveRes();
#endif
#ifdef __VRE__
    RES_PRINT_INFO("Populationg VRE resource\n");
    PopulateVREResData();
#endif
/* Vogins Start */
#ifdef __VRE30_AM__
    RES_PRINT_INFO("Populationg AM resource\n");
    PopulateAMResData();
#endif
/* Vogins End */
#ifdef __MMI_VUI_HOMESCREEN__
    RES_PRINT_INFO(("Populating VF home screen Resource"));
    PopulateVFHSRes();
#endif

#ifdef __MMI_SEARCH_WEB__
    RES_PRINT_INFO("Populating Search-web resource\n");
    PopulateSearchWebRes();
#endif
    ...
    MYFCLOSE(font_data_lis, "vf_obj.txt");
    MYFCLOSE(font_data_modis_lis, "vf_modis_obj.txt");
    printf("[FONT]font_data_lis close \n");
}
...
static void PopulateWebcamData(void)
{
    ...
    do
    {
        ...
        if (fp_out == NULL)
        {
            RES_PRINT_INFO("[WEBCAM] Output file failed !!\n");
            break;
        }
        ...
        for (i = 0 ; i < 3 ; i++)
        {
            ...
            if (fp_in == NULL)
            {
                RES_PRINT_INFO("[WEBCAM] Input image 1 failed,\t%s !!\n", filename);
                break;
            }
...
void PopulateGlobalData()
{
    ...
    ADD_APPLICATION_IMAGE2(
        ...
        CUST_IMG_PATH "\\\\MainLCD\\\\UIElement\\\\Softkey\\\\Common_CSK.pbm",
        "common CSK icon");
    ADD_APPLICATION_IMAGE2(
        IMG_GLOBAL_PHB_CSK,
        CUST_IMG_PATH "\\\\MainLCD\\\\UIElement\\\\Softkey\\\\Phonebook_CSK.pbm",
        "phonebook CSK icon");
    ADD_APPLICATION_IMAGE2(
        IMG_GLOBAL_CALL_CSK,
        CUST_IMG_PATH "\\\\MainLCD\\\\UIElement\\\\Softkey\\\\Call_CSK.pbm",
        "call CSK icon");
    ADD_APPLICATION_IMAGE2(
        IMG_GLOBAL_SELECT_CSK,
        CUST_IMG_PATH "\\\\MainLCD\\\\UIElement\\\\Softkey\\\\Select_CSK.pbm",
        "select CSK icon");
    ADD_APPLICATION_IMAGE2(
        IMG_GLOBAL_VIEW_CSK,
        CUST_IMG_PATH "\\\\MainLCD\\\\UIElement\\\\Softkey\\\\View_CSK.pbm",
        "view CSK icon");
    ADD_APPLICATION_IMAGE2(
        IMG_GLOBAL_READ_MSG_CSK,
        CUST_IMG_PATH "\\\\MainLCD\\\\UIElement\\\\Softkey\\\\Read_Msg_CSK.pbm",
        "read message CSK icon");
    ADD_APPLICATION_IMAGE2(
        IMG_GLOBAL_REPLY_MSG_CSK,
        CUST_IMG_PATH "\\\\MainLCD\\\\UIElement\\\\Softkey\\\\Reply_Msg_CSK.pbm",
        "reply message CSK icon");
    ADD_APPLICATION_IMAGE2(
        IMG_GLOBAL_SEND_MSG_CSK,
        CUST_IMG_PATH "\\\\MainLCD\\\\UIElement\\\\Softkey\\\\Send_Msg_CSK.pbm",
        "send message CSK icon");
    ADD_APPLICATION_IMAGE2(
        IMG_GLOBAL_FORWARD_MSG_CSK,
        CUST_IMG_PATH "\\\\MainLCD\\\\UIElement\\\\Softkey\\\\Forward_Msg_CSK.pbm",
        "forward message CSK icon");
    ADD_APPLICATION_IMAGE2(
        IMG_GLOBAL_DOWNLOAD_CSK,
        CUST_IMG_PATH "\\\\MainLCD\\\\UIElement\\\\Softkey\\\\Download_CSK.pbm",
        "download CSK icon");
    ADD_APPLICATION_IMAGE2(
        IMG_GLOBAL_WEB_BROWSER_CSK,
        CUST_IMG_PATH "\\\\MainLCD\\\\UIElement\\\\Softkey\\\\Web_Browser_CSK.pbm",
        "web browser CSK icon");
    ADD_APPLICATION_IMAGE2(
        IMG_GLOBAL_BOOKMARK_CSK,
        CUST_IMG_PATH "\\\\MainLCD\\\\UIElement\\\\Softkey\\\\Bookmark_CSK.pbm",
        "bookmark CSK icon");
    ADD_APPLICATION_IMAGE2(
        IMG_GLOBAL_SEARCH_CSK,
        CUST_IMG_PATH "\\\\MainLCD\\\\UIElement\\\\Softkey\\\\SearchWeb_CSK.pbm",
        "search CSK icon");
    ADD_APPLICATION_IMAGE2(
        IMG_GLOBAL_QUERY,
        CUST_IMG_PATH "\\\\MainLCD\\\\Warningpage\\\\PopUpPage\\\\PP_QUERY"__MMI_RES_TYPE_POPUP_SCREEN__,
        "Query Image");
