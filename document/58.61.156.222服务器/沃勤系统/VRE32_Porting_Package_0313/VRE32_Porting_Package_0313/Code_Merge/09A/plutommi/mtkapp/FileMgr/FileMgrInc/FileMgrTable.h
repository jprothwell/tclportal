...
#if defined(__MMI_FM_RADIO_RECORD__) && defined(__MMI_FMGR_SUPPORT_DEFAULT_STORAGE__)
...
extern BOOL mmi_fmgr_sound_recorder_notify_hdlr(U32 notify_flag, void* para);
#endif
...
#ifdef __MMI_RMGR__
extern void mmi_rmgr_option_enabler_more_rits(U16 menu_id, const FMGR_FILE_INFO_STRUCT* fileinfo);
#endif
...
extern BOOL mmi_wap_notify_hdlr(U32 notify_flag, void* para);
#endif

#ifdef __A8BOX_SUPPORT__
extern BOOL mmi_a8box_fmgr_notify_hdlr(U32 flag, void *para);
#endif
...
#define FMGR_FILE_TABLE_COL \
    ...
    FT_INFO_MPG \
    FT_INFO_AVI \
    FG_INFO(FMGR_TYPE_GRP_STREAM, IMG_ID_FMGR_ICON_FILE_TYPE_VDO, MENU_ID_FMGR_VID_TYPE_OPTIONS, 0, MENU_ID_FMGR_VID_FWD_SEND_OPTION, MMI_FMGR_VIDEO_FOLDER, DRM_PERMISSION_PLAY) \
    FT_INFO_SDP \
    /* Certman */ \
    FT_INFO_CERTMAN \
    /* swFlash */ \
...
#ifdef WMA_DECODE
#define FT_INFO_WMA \
    FT_INFO(FMGR_TYPE_WMA,      "WMA",          IMG_ID_FMGR_FILE_TYPE_WMA)
#else
#define FT_INFO_WMA
#endif
...
#ifdef BSAC_DECODE
#define FT_INFO_BSAC \
    FT_INFO(FMGR_TYPE_BSAC,     "BSAC",         IMG_ID_FMGR_FILE_TYPE_BSAC)
#else
#define FT_INFO_BSAC
#endif
...
#ifdef KUR_DECODE
#define FT_INFO_KUR \
	FT_INFO(FMGR_TYPE_KUR,      "KUR",          IMG_ID_FMGR_FILE_TYPE_KUR)
#else
#define FT_INFO_KUR
#endif
...
#ifdef __J2ME__
#define FT_INFO_JAVA \
    FT_INFO_D(FMGR_TYPE_JAD,    "JAD",          IMG_ID_FMGR_FILE_TYPE_JAD, IMG_ID_FMGR_ICON_FILE_TYPE_JAVA, MENU_ID_FMGR_JAD_TYPE_OPTIONS, 0, MENU_ID_FMGR_GEN_SEND_OPTION, 0, 0) \
    FT_INFO_D(FMGR_TYPE_JAR,    "JAR",          IMG_ID_FMGR_FILE_TYPE_JAR, IMG_ID_FMGR_ICON_FILE_TYPE_JAVA, MENU_ID_FMGR_JAR_TYPE_OPTIONS, 0, MENU_ID_FMGR_GEN_SEND_OPTION, 0, 0)
#else
#define FT_INFO_JAVA
#endif
...
#define FT_INFO_UDX \
    FT_INFO_D(FMGR_TYPE_UDX,      "UDX",          IMG_ID_FMGR_FILE_TYPE_UDX, IMG_ID_FMGR_ICON_FILE_TYPE_UDX, 0, MENU_ID_FMGR_UDX_FWD_USE_OPTION, MENU_ID_FMGR_UDX_FWD_SEND_OPTION, 0, 0)
#else
#define FT_INFO_UDX
#endif
/* UDX_SUPPORT */
...
#define FT_INFO_SDP \
    FT_INFO_D(FMGR_TYPE_SDP,      "SDP",          IMG_ID_FMGR_FILE_TYPE_SDP, IMG_ID_FMGR_ICON_FILE_TYPE_SDP, 0, 0xFFFF, 0, 0, 0) \
    FT_INFO_D(FMGR_TYPE_RAM,      "RAM",          IMG_ID_FMGR_FILE_TYPE_RAM, IMG_ID_FMGR_ICON_FILE_TYPE_RAM, 0, 0xFFFF, 0, 0, 0)
#else
#define FT_INFO_SDP
#endif
...
#define FT_INFO_BOOKMARK \
    ...
    FT_INFO(FMGR_TYPE_WMLC,     "WMLC",         IMG_ID_FMGR_BRW_WML_LARGE_TYPE)
#else
#define FT_INFO_BOOKMARK
#endif
...
#ifdef __MMI_IMPS__
#define FT_INFO_IMPS \
FT_INFO_D(FMGR_TYPE_IMPS_IM,   "IM",     IMG_IMPS_FMGR_IM_LARGE_TYPE, IMG_IMPS_FMGR_IM_SMALL_TYPE, MENU_ID_FMGR_IMPS_TYPE_OPTIONS, 0, MENU_ID_FMGR_GEN_SEND_OPTION, 0, 0)
#else
#define FT_INFO_IMPS
#endif
/****************************************************************************/
...
#define APP_INFO_ANSWER_MACHINE \
    APP_INFO(APP_AUTOAM,        STR_ID_AUTOAM_APP,          MENU_ID_AUTOAM_MAIN)   
#else
#define APP_INFO_ANSWER_MACHINE
#endif
...
#define FMGR_NOTIFY_COL \
    ...
    FN_INFO_MYFAVORITE \
    FN_INFO_BT \
    FN_INFO_MEDIO_PLAYER \
    FN_INFO_VIDEO_RECORDER \
    FN_INFO_IMAGEVIEWER \
    FN_INFO_VIDEO_PLAYER \
    FN_INFO_SOUND_RECORDER \
    FN_INFO_OP00_BARCODEREADER \
    FN_INFO_OP01_BARCODEREADER \
    FN_INFO_RNGC \
    FN_INFO_WAP_Q05A \
    FN_INFO_PHOTO_EDITOR \
    FN_INFO_A8BOX \
    FN_INFO_CAMCORDER \
    FN_INFO_VRE \
...
#if defined(__MMI_RING_COMPOSER__) && defined(__MMI_IMELODY_SUPPORT__)
#define FN_INFO_RNGC \
    FN_INFO(mmi_rngc_notify_hdlr, MMI_FMGR_NOTIFY_DRV_POST_UNMOUNT)
#else
#define FN_INFO_RNGC
#endif
...
#define FN_INFO_EBOOK \
    FN_INFO(mmi_fmgr_ebook_notify_hdlr, MMI_FMGR_NOTIFY_POST_DEL_ALL | \
                                        MMI_FMGR_NOTIFY_POST_DELETE | \
                                        MMI_FMGR_NOTIFY_DRV_POST_UNMOUNT | \
                                        MMI_FMGR_NOTIFY_SET_STORAGE_PRE_CHK | \
                                        MMI_FMGR_NOTIFY_SET_STORAGE | \
                                        MMI_FMGR_NOTIFY_BEFORE_DEL_ALL | \
                                        MMI_FMGR_NOTIFY_BEFORE_DELETE | \
                                        MMI_FMGR_NOTIFY_DRV_BEFORE_FORMAT)
...
#define FN_INFO_MOBILE_TV_PLAYER \
    FN_INFO(mmi_mtv_player_fmgr_notify_callback, MMI_FMGR_NOTIFY_DRV_PRE_FORMAT | MMI_FMGR_NOTIFY_SET_STORAGE_PRE_CHK | MMI_FMGR_NOTIFY_SET_STORAGE)
#else
#define FN_INFO_MOBILE_TV_PLAYER
#endif
...
#define FN_INFO_LANGLN \
    FN_INFO(mmi_fmgr_langln_notify_hdlr, MMI_FMGR_NOTIFY_DRV_POST_UNMOUNT | MMI_FMGR_NOTIFY_SET_STORAGE_PRE_CHK | MMI_FMGR_NOTIFY_SET_STORAGE)
#else
#define FN_INFO_LANGLN
#endif
...
#if defined(__MMI_FM_RADIO_RECORD__) && defined(__MMI_FMGR_SUPPORT_DEFAULT_STORAGE__)
#define FN_INFO_FMRDO \
    FN_INFO(mmi_fmgr_fmrdo_notify_hdlr, MMI_FMGR_NOTIFY_SET_STORAGE_PRE_CHK | MMI_FMGR_NOTIFY_SET_STORAGE)
#else
#define FN_INFO_FMRDO
#endif
...
#ifdef __MMI_RMGR__
#define FN_INFO_RMGR \
    FN_INFO(mmi_rmgr_format_notify_hdlr, MMI_FMGR_NOTIFY_DRV_POST_FORMAT)
#else
#define FN_INFO_RMGR
#endif

#ifdef __MMI_AB_REPEATER__
#define FN_INFO_AB_REPEATER \
    FN_INFO(mmi_fmgr_abrepeater_notify_hdlr, MMI_FMGR_NOTIFY_DRV_POST_UNMOUNT | MMI_FMGR_NOTIFY_SET_STORAGE_PRE_CHK | MMI_FMGR_NOTIFY_SET_STORAGE)
#else
#define FN_INFO_AB_REPEATER
#endif

#ifdef __MMI_MY_FAVORITE_MEMORYCARD__
#define FN_INFO_MYFAVORITE \
    FN_INFO(mmi_fmgr_myfavorite_notify_hdlr, MMI_FMGR_NOTIFY_DRV_POST_UNMOUNT)
#else
#define FN_INFO_MYFAVORITE
#endif
...
#if defined(__MMI_BT_RECV_DRV_SWITCH__) && defined(__MMI_FMGR_SUPPORT_DEFAULT_STORAGE__)
#define FN_INFO_BT \
    FN_INFO(mmi_bt_storage2card_hdlr, MMI_FMGR_NOTIFY_SET_STORAGE_PRE_CHK | MMI_FMGR_NOTIFY_SET_STORAGE)
#else
#define FN_INFO_BT
#endif

#ifdef __MMI_MEDIA_PLAYER__
#define FN_INFO_MEDIO_PLAYER \
    FN_INFO(mmi_fmgr_media_player_notify_hdlr, MMI_FMGR_NOTIFY_ALL)
#else
#define FN_INFO_MEDIO_PLAYER
#endif

#if defined(__MMI_VIDEO_RECORDER__) && !defined(__MMI_CAMCORDER__)
#define FN_INFO_VIDEO_RECORDER \
    FN_INFO(mmi_vdorec_notify_storage_change_hdlr, MMI_FMGR_NOTIFY_SET_STORAGE_PRE_CHK | MMI_FMGR_NOTIFY_SET_STORAGE)
#else
#define FN_INFO_VIDEO_RECORDER
#endif

#ifdef __MMI_IMAGE_VIEWER__
#define FN_INFO_IMAGEVIEWER \
    FN_INFO(mmi_imgview_notify_storage_change_hdlr, MMI_FMGR_NOTIFY_SET_STORAGE_PRE_CHK | MMI_FMGR_NOTIFY_SET_STORAGE)
#else
#define FN_INFO_IMAGEVIEWER
#endif /* __MMI_IMAGE_VIEWER__ */

#ifdef __MMI_VIDEO_PLAYER__
#define FN_INFO_VIDEO_PLAYER \
    FN_INFO(mmi_vdoply_notify_storage_change_hdlr, MMI_FMGR_NOTIFY_SET_STORAGE_PRE_CHK | MMI_FMGR_NOTIFY_SET_STORAGE)
#else
#define FN_INFO_VIDEO_PLAYER
#endif

#if defined(__MMI_SOUND_RECORDER__) && defined(__MMI_FMGR_SUPPORT_DEFAULT_STORAGE__)
#define FN_INFO_SOUND_RECORDER \
    FN_INFO(mmi_fmgr_sound_recorder_notify_hdlr, MMI_FMGR_NOTIFY_SET_STORAGE_PRE_CHK | MMI_FMGR_NOTIFY_SET_STORAGE)
#else
#define FN_INFO_SOUND_RECORDER
#endif

#if defined(__MMI_OP00_BARCODEREADER__) && defined(__MMI_FMGR_SUPPORT_DEFAULT_STORAGE__)
#define FN_INFO_OP00_BARCODEREADER \
FN_INFO(mmi_barcodereader_notify_hdlr, MMI_FMGR_NOTIFY_SET_STORAGE_PRE_CHK | MMI_FMGR_NOTIFY_SET_STORAGE)
#else
#define FN_INFO_OP00_BARCODEREADER
#endif
...
/* under construction !*/
#else
#define FN_INFO_OP01_BARCODEREADER
#endif

#if defined(OBIGO_Q05A)
#define FN_INFO_WAP_Q05A \
    FN_INFO(mmi_wap_notify_hdlr, MMI_FMGR_NOTIFY_DRV_POST_FORMAT)
#else
#define FN_INFO_WAP_Q05A
#endif

#ifdef __MMI_PHOTOEDITOR__
#define FN_INFO_PHOTO_EDITOR \
    FN_INFO(mmi_phoedt_notify_hdlr, MMI_FMGR_NOTIFY_DRV_POST_UNMOUNT)
#else
#define FN_INFO_PHOTO_EDITOR
#endif

#ifdef __A8BOX_SUPPORT__
#define FN_INFO_A8BOX \
    FN_INFO(mmi_a8box_fmgr_notify_hdlr, MMI_FMGR_NOTIFY_ALL)
#else
#define FN_INFO_A8BOX
#endif

#ifdef __MMI_CAMCORDER__
#define FN_INFO_CAMCORDER \
    FN_INFO(mmi_camco_notify_storage_change_hdlr, MMI_FMGR_NOTIFY_SET_STORAGE_PRE_CHK | MMI_FMGR_NOTIFY_SET_STORAGE)
#else
#define FN_INFO_CAMCORDER
...
#define FMGR_FWD_ENABLER_COL \
    ...
    FE_INFO(MENU_ID_FMGR_FWD_CALLER_PICTURE,    mmi_fmgr_forward_phb_enabler) \
    /* Use - Audio */ \
    FE_INFO_BG_SOUND \
    /* Send */ \
    FE_INFO_SMS \
    ...
    FE_INFO_BT_MUL \
    /* vCalendar */\
    FE_INFO(MENU_ID_FMGR_FWD_TODOLIST,    mmi_fmgr_option_vcalendar_enabler) \
    FE_INFO(MENU_ID_FMGR_FWD_CLNDR,    mmi_fmgr_option_vcalendar_enabler) \
...
#ifdef __MMI_AB_REPEATER__
#define FE_INFO_ABREPEAT \
    FE_INFO(MENU_ID_ABREPEAT_FMGR_OPTION,           mmi_abrepeat_option_enabler)
#else
#define FE_INFO_ABREPEAT
#endif

#ifdef __J2ME__
#define FE_INFO_JADPACKAGE \
    FE_INFO(MENU_ID_FMGR_JAD_TYPE_OPTIONS,           mmi_java_jad_option_enabler)
#else
#define FE_INFO_JADPACKAGE
#endif
...
#define FMGR_CR_MYFAV_CARD \
    CR_DRV_INFO (FMGR_REMOVABLE_STORAGE,        STR_ID_MY_FAVORITE_FOLDER_MEMORY_CARD,  IMG_ID_MY_FAVORITE_FOLDER_MEMORY_CARD)
#else
#define FMGR_CR_MYFAV_CARD
#endif

#ifdef __MMI_MY_FAVORITE_JAVABOX__
extern void mmi_my_favorite_entry_javabox_option(void);
...
#define FMGR_CR_MYFAV_GPLUSGAME \
    CR_LINK2_INFO (STR_ID_MY_FAVORITE_FOLDER_GPLUSGAME,  IMG_ID_MY_FAVORITE_FOLDER_GPLUSGAME, STR_GLOBAL_OPEN, mmi_my_favorite_open_gplusgame_wap_hdlr, NULL)
#else
#define FMGR_CR_MYFAV_GPLUSGAME
#endif
