...
#if defined(__MMI_MULTITAP_MALAYALAM__) || defined(__MMI_ZI_MALAYALAM__) 
...
#endif
#if defined(__MMI_MULTITAP_ORIYA__) || defined(__MMI_ZI_ORIYA__) 
...
//PMT HIMANSHU END 20050729
  ...
  ADD_APPLICATION_IMAGE2(IMG_VKBD_FARSI_HUNGARIAN_ARABICSYMBOL,CUST_IMG_PATH"\\\\MainLCD\\\\UIElement\\\\VirtualKeyboard\\\\V_KBD_HUNGARIAN_FARSI.PNG","Hungarian_Farsi keyboard");
	...
	defined(__MMI_LANG_CATALAN__)|| defined(__MMI_LANG_HAUSA__)|| defined(__MMI_LANG_MACEDONIAN__)|| defined(__MMI_LANG_YORUBA__) || defined(__MMI_LANG_ICELANDIC__)
...
#else
	ADD_APPLICATION_IMAGE2(IMG_TECHNO_DIGITAL_SMALL_CLOCK_0, CUST_IMG_PATH"\\\\MainLCD\\\\IdleScreen\\\\Techno\\\\SmallClock\\\\0030.pbm", " status icon bar small Digital Clock Number 0 Image");
	ADD_APPLICATION_IMAGE2(IMG_TECHNO_DIGITAL_SMALL_CLOCK_1, CUST_IMG_PATH"\\\\MainLCD\\\\IdleScreen\\\\Techno\\\\SmallClock\\\\0031.pbm", " status icon bar small Digital Clock Number 1 Image");
	ADD_APPLICATION_IMAGE2(IMG_TECHNO_DIGITAL_SMALL_CLOCK_2, CUST_IMG_PATH"\\\\MainLCD\\\\IdleScreen\\\\Techno\\\\SmallClock\\\\0032.pbm", " status icon bar small Digital Clock Number 2 Image");
	ADD_APPLICATION_IMAGE2(IMG_TECHNO_DIGITAL_SMALL_CLOCK_3, CUST_IMG_PATH"\\\\MainLCD\\\\IdleScreen\\\\Techno\\\\SmallClock\\\\0033.pbm", " status icon bar small Digital Clock Number 3 Image");
	ADD_APPLICATION_IMAGE2(IMG_TECHNO_DIGITAL_SMALL_CLOCK_4, CUST_IMG_PATH"\\\\MainLCD\\\\IdleScreen\\\\Techno\\\\SmallClock\\\\0034.pbm", " status icon bar small Digital Clock Number 4 Image");
	ADD_APPLICATION_IMAGE2(IMG_TECHNO_DIGITAL_SMALL_CLOCK_5, CUST_IMG_PATH"\\\\MainLCD\\\\IdleScreen\\\\Techno\\\\SmallClock\\\\0035.pbm", " status icon bar small Digital Clock Number 5 Image");
	ADD_APPLICATION_IMAGE2(IMG_TECHNO_DIGITAL_SMALL_CLOCK_6, CUST_IMG_PATH"\\\\MainLCD\\\\IdleScreen\\\\Techno\\\\SmallClock\\\\0036.pbm", " status icon bar small Digital Clock Number 6 Image");
	ADD_APPLICATION_IMAGE2(IMG_TECHNO_DIGITAL_SMALL_CLOCK_7, CUST_IMG_PATH"\\\\MainLCD\\\\IdleScreen\\\\Techno\\\\SmallClock\\\\0037.pbm", " status icon bar small Digital Clock Number 7 Image");
	ADD_APPLICATION_IMAGE2(IMG_TECHNO_DIGITAL_SMALL_CLOCK_8, CUST_IMG_PATH"\\\\MainLCD\\\\IdleScreen\\\\Techno\\\\SmallClock\\\\0038.pbm", " status icon bar small Digital Clock Number 8 Image");
	ADD_APPLICATION_IMAGE2(IMG_TECHNO_DIGITAL_SMALL_CLOCK_9, CUST_IMG_PATH"\\\\MainLCD\\\\IdleScreen\\\\Techno\\\\SmallClock\\\\0039.pbm", " status icon bar small Digital Clock Number 9 Image");
	ADD_APPLICATION_IMAGE2(IMG_TECHNO_DIGITAL_SMALL_CLOCK_AM, CUST_IMG_PATH"\\\\MainLCD\\\\IdleScreen\\\\Techno\\\\SmallClock\\\\am.pbm", " status icon bar small Digital Clock AM Image");
	ADD_APPLICATION_IMAGE2(IMG_TECHNO_DIGITAL_SMALL_CLOCK_PM, CUST_IMG_PATH"\\\\MainLCD\\\\IdleScreen\\\\Techno\\\\SmallClock\\\\pm.pbm", " status icon bar small Digital Clock PM Image");
	ADD_APPLICATION_IMAGE2(IMG_TECHNO_DIGITAL_SMALL_CLOCK_COLON, CUST_IMG_PATH"\\\\MainLCD\\\\IdleScreen\\\\Techno\\\\SmallClock\\\\0021.pbm", " status icon bar small Digital Clock Colon Image");
#endif
...
/* Vogins End */
    ...
    /* image resource adding for gui_draw_bg_area() */
    ADD_APPLICATION_IMAGE2(IMG_ID_BG_TOP_LEFT,CUST_IMG_PATH"\\\\MainLCD\\\\UIElement\\\\TextBG\\\\BG_TOP_LEFT.PNG","BG IMAGE.");
    ADD_APPLICATION_IMAGE2(IMG_ID_BG_TOP,CUST_IMG_PATH"\\\\MainLCD\\\\UIElement\\\\TextBG\\\\BG_TOP.PNG","BG IMAGE.");
    ADD_APPLICATION_IMAGE2(IMG_ID_BG_TOP_RIGHT,CUST_IMG_PATH"\\\\MainLCD\\\\UIElement\\\\TextBG\\\\BG_TOP_RIGHT.PNG","BG IMAGE.");
    ADD_APPLICATION_IMAGE2(IMG_ID_BG_MIDDLE_LEFT,CUST_IMG_PATH"\\\\MainLCD\\\\UIElement\\\\TextBG\\\\BG_MIDDLE_LEFT.PNG","BG IMAGE.");
    ADD_APPLICATION_IMAGE2(IMG_ID_BG_MIDDLE,CUST_IMG_PATH"\\\\MainLCD\\\\UIElement\\\\TextBG\\\\BG_MIDDLE.PNG","BG IMAGE.");
    ADD_APPLICATION_IMAGE2(IMG_ID_BG_MIDDLE_RIGHT,CUST_IMG_PATH"\\\\MainLCD\\\\UIElement\\\\TextBG\\\\BG_MIDDLE_RIGHT.PNG","BG IMAGE.");
    ADD_APPLICATION_IMAGE2(IMG_ID_BG_BOTTOM_LEFT,CUST_IMG_PATH"\\\\MainLCD\\\\UIElement\\\\TextBG\\\\BG_BOTTOM_LEFT.PNG","BG IMAGE.");
    ADD_APPLICATION_IMAGE2(IMG_ID_BG_BOTTOM,CUST_IMG_PATH"\\\\MainLCD\\\\UIElement\\\\TextBG\\\\BG_BOTTOM.PNG","BG IMAGE.");
    ADD_APPLICATION_IMAGE2(IMG_ID_BG_BOTTOM_RIGHT,CUST_IMG_PATH"\\\\MainLCD\\\\UIElement\\\\TextBG\\\\BG_BOTTOM_RIGHT.PNG","BG IMAGE.");
...
/* 101205 new icon Calvin End */
   ...
   /* Max, for IMPS */
   #ifdef __MMI_IMPS__
    ADD_APPLICATION_IMAGE_TYPE(IMG_SI_IMPS_MSG, CUST_IMG_PATH"\\\\MainLCD\\\\IdleScreen\\\\StatusIcons"STATUS_ICON_IMAGE_FILE_PATH"\\\\SI_IMPSMG.png", "Status icon in Idle Screen when new msg comes", FALSE, FORCE_ABM);
    ADD_APPLICATION_IMAGE_TYPE(IMG_SI_IMPS_LOGIN, CUST_IMG_PATH"\\\\MainLCD\\\\IdleScreen\\\\StatusIcons"STATUS_ICON_IMAGE_FILE_PATH"\\\\SI_IMPS.png", "Status icon in Idle Screen when login server", FALSE, FORCE_ABM);
    ADD_APPLICATION_IMAGE_TYPE(IMG_SI_IMPS_LOGIN_FAIL, CUST_IMG_PATH"\\\\MainLCD\\\\IdleScreen\\\\StatusIcons"STATUS_ICON_IMAGE_FILE_PATH"\\\\SI_IMPS_fail.png", "Status icon in Idle Screen when login server", FALSE, FORCE_ABM);
   #endif
