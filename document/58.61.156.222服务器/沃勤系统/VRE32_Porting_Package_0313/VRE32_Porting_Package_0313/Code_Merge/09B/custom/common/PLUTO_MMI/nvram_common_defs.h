 ...
 */
    typedef enum
    {
        ...
        NVRAM_EF_CUST_HW_LEVEL_TBL_LID = NVRAM_LID_COMMAPP_BEGIN,
...
#define NVRAM_EF_PHB_SIZE                  (sizeof(mmi_phb_entry_struct))
...
#define NVRAM_EF_PHB_RES_SIZE              (MMI_PHB_RES_FIELD_COUNT * MMI_PHB_RES_FIELD_SIZE)
#define NVRAM_EF_PHB_RES_TOTAL             ((MMI_PHB_RES_FIELD_TOTAL - 1) / MMI_PHB_RES_FIELD_COUNT + 1)
...
#define NVRAM_EF_PHB_DEFAULT_NUMBER_SIZE   1
#define NVRAM_EF_PHB_DEFAULT_NUMBER_TOTAL  MAX_PHB_PHONE_ENTRY
...
#define NVRAM_EF_PHB_SPEEDDIAL_SIZE        (sizeof(mmi_phb_speed_dial_struct)) * MMI_PHB_SPEED_DIAL_COUNT
#define NVRAM_EF_PHB_SPEEDDIAL_TOTAL       1
...
#define NVRAM_EF_PHB_EMAIL_SORT_SIZE       ((MAX_PHB_PHONE_ENTRY + MAX_PHB_SIM_ENTRY) * 2)
#else
#define NVRAM_EF_PHB_EMAIL_SORT_SIZE       MAX_PHB_PHONE_ENTRY * 2
#endif
#define NVRAM_EF_PHB_EMAIL_SORT_TOTAL      1
