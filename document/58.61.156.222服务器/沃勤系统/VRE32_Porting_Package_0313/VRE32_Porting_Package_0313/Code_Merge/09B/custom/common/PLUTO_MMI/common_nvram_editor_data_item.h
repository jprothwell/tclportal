...
#define NVRAM_WAP_PROF_MAX_STATIC_PROFILES    5
#else
...
#define NVRAM_WAP_PROF_MAX_WLAN_PROFILES      5
#else
#define NVRAM_WAP_PROF_MAX_WLAN_PROFILES      0
#endif /* (__MMI_WAP_DUAL_SIM__ ) && defined(__MMI_WLAN_FEATURES__)  */

#define NVRAM_WAP_PROF_MAX_PROFILES        ((NVRAM_WAP_PROF_NUMBER_OF_SIMS) * (NVRAM_WAP_PROF_MAX_SINGLE_SIM_PROFILES) + (NVRAM_WAP_PROF_MAX_WLAN_PROFILES) )
...
/* verno of data items */
#define NVRAM_EF_CACHE_BYTE_LID_VERNO        "003"
...
#define NVRAM_EF_PHB_FIELDS_LID_VERNO                   "005"
#else /* __MMI_PHB_OPTIONAL_FIELDS_2ND_EMAIL__ */
#define NVRAM_EF_PHB_FIELDS_LID_VERNO                   "004"
...
#define NVRAM_EF_PROFILES_LID_VERNO                     "005"
...
#define NVRAM_EF_SML_LID_VERNO                          "003"
#ifdef __SMART_PHONE_MODEM__
#define NVRAM_EF_SIM_LOCK_LID_VERNO					    "000"
#endif
/* __SYNCML_SUPPORT__ */
#define NVRAM_EF_SYNCML_ACCOUNT_LID_VERNO               "001"
...
#define NVRAM_EF_RAC_PREFERENCE_LID_VERNO               "003"
...
#define NVRAM_EF_WAP_PROF_WAP_SIM1_PROFILE_NAMES_LID_VERNO   "002"  /* USIM */
#define NVRAM_EF_WAP_PROF_WAP_SIM2_PROFILE_NAMES_LID_VERNO   "002"  /* USIM */
#define NVRAM_EF_WAP_PROF_MMS_SIM1_PROFILE_NAMES_LID_VERNO   "002"  /* USIM */
#define NVRAM_EF_WAP_PROF_MMS_SIM2_PROFILE_NAMES_LID_VERNO   "002"  /* USIM */
#define NVRAM_EF_WAP_PROF_WAP_WLAN_PROFILE_NAMES_LID_VERNO   "000"  /* USIM */
#endif /* __MMI_WAP_PROF__ */
...
#define  NVRAM_EF_VRE_USER_APN_INFO_LID_VERNO "001"
...
#define NVRAM_EF_AM_PROMPT_LID_VERNO "001"
/*vogins_20100625_end*/
#endif
/* Vogins End */
#ifdef __EMAIL__
...
#define NVRAM_EF_VENUS_HS_CNTX_LID_VERNO                "003"
...
#endif
#define NVRAM_EF_AZAAN_ALARM_LID_VERNO             "001"
...
#define NVRAM_EF_SRV_SMS_PDU_LID_VERNO                      "000"
#define NVRAM_EF_SRV_SMS_RECENT_EVENT_BITMAP_LID_VERNO      "000"
#define NVRAM_EF_SRV_SMS_SIM_CUST_DATA_LID_VERNO            "000"
...
typedef struct
{
    kal_uint8 nvram_ef_phb_email_sort[NVRAM_EF_PHB_EMAIL_SORT_SIZE];
...
typedef struct
{
    ...
    kal_uint8 gprs_transfer_preference;
#endif      
...
#if !defined(EMPTY_MMI) && !defined(EXTERNAL_MMI)
LID_BIT VER_LID(NVRAM_EF_PHB_RES_LID)
     mmi_phb_res_struct *MMI_PHB_RES_FIELD_TOTAL
     {
     };

#if !defined(__MMI_PHB_NO_OPTIONAL_FIELD__) && NVRAM_EF_PHB_FIELDS_TOTAL
...
LID_BIT VER_LID(NVRAM_EF_PHB_LID)
     mmi_phb_entry_struct *NVRAM_EF_PHB_TOTAL
     {
     };
...
LID_BIT VER_LID(NVRAM_EF_PHB_LN_ENTRY_LID)
     ...
     nvram_ef_phb_email_sort_struct *NVRAM_EF_PHB_EMAIL_SORT_TOTAL
     {
     };
 #endif /* defined(__MMI_PHB_EMAIL_SORT__) */
     ...
     mmi_phb_bday_struct *NVRAM_EF_PHB_BIRTHDAY_TOTAL
     {
     };
...
LID_BIT VER_LID(NVRAM_EF_RAC_PREFERENCE_LID)
   ...
   gprs_transfer_preference: "GPRS TRANSFER PREFERENCE"
   {
#ifdef __MONITOR_PAGE_DURING_TRANSFER__
     pf_gprs_transfer: 8 "gprs transfer preference"
     {
        0x0: "DATA_PREFER";
        0x1: "CALL_PREFER";
...
#endif /* __MMI_WAP_DUAL_SIM__ */
#if defined (__MMI_WAP_DUAL_SIM__ ) && defined(__MMI_WLAN_FEATURES__)
	 LID_BIT VER_LID (NVRAM_EF_WAP_PROF_WAP_WLAN_PROFILE_NAMES_LID)
     nvram_wap_prof_profile_name_array_struct *1
     {
	};
#endif /* (__MMI_WAP_DUAL_SIM__ ) && defined(__MMI_WLAN_FEATURES__) */
...
#ifdef __DM_SCOMO_SUPPORT__
LID_BIT VER_LID (NVRAM_EF_DM_APP_SCOMO_REPORT_INFO_LID)
    nvram_ef_dm_app_scomo_report_info_struct * NVRAM_EF_DM_APP_SCOMO_REPORT_INFO_TOTAL
    {
    };
#endif /* __DM_SCOMO_SUPPORT__ */
