...
void checkCHEKeyActionPerFix(STCHE *che_context, kal_uint8 *key);

/// execute GEN_KEY action
void run_CHE_GEN_KEY_process(STCHE *che_context, kal_uint8 *key, kal_int32 key_len);
...
void run_CHE_SET_RC4_KEY_process(STCHE *che_context, kal_uint8 *key, kal_int32 key_len);

/// execute GET_KEY action
void run_CHE_GET_KEY_process(STCHE *che_context, kal_uint8 *key, kal_int32 key_len);
      
/// execute DEL_KEY action
void run_CHE_DEL_KEY_process(STCHE *che_context, kal_uint8 *key, kal_int32 key_len);

/// execute GEN_RSA_KEY action
void run_CHE_GEN_RSA_KEY_process(STCHE *che_context, kal_uint8 *key, kal_int32 key_len);

/// execute DEL_RSA_KEY action 
void run_CHE_DEL_RSA_KEY_process(STCHE *che_context, kal_uint8 *key, kal_int32 key_len);   

/// execute SET_RSA_N key action
void run_CHE_SET_RSA_N_process(STCHE *che_context, kal_uint8 *key, kal_int32 key_len);

/// execute SET_RSA_E key action
void run_CHE_SET_RSA_E_process(STCHE *che_context, kal_uint8 *key, kal_int32 key_len);
  
/// execute SET_RSA_D key action
void run_CHE_SET_RSA_D_process(STCHE *che_context, kal_uint8 *key, kal_int32 key_len);

/// execute SET_RSA_P key action
void run_CHE_SET_RSA_P_process(STCHE *che_context, kal_uint8 *key, kal_int32 key_len);

/// execute SET_RSA_Q key action
void run_CHE_SET_RSA_Q_process(STCHE *che_context, kal_uint8 *key, kal_int32 key_len);

/// execute SET_RSA_dModPm1 key action
void run_CHE_SET_RSA_dModPm1_process(STCHE *che_context, kal_uint8 *key, kal_int32 key_len);

/// execute SET_RSA_dModQm1 key action
void run_CHE_SET_RSA_dModQm1_process(STCHE *che_context, kal_uint8 *key, kal_int32 key_len);

/// execute SET_RSA_qInvModP key action
void run_CHE_SET_RSA_qInvModP_process(STCHE *che_context, kal_uint8 *key, kal_int32 key_len);
...
void checkCHEProcessPerFix(STCHE* che_context);                                                                            
...
kal_bool run_CHE_DES_process(STCHE* che_context, CHE_TYPE type, CHE_OPERATION_MODE mode, CHE_ACTION act,
                     kal_uint8 *source, kal_uint8 *dest, kal_uint32 source_length, kal_bool last_block, STFSAL *pstFSAL);
  

/// execute 3DES cipher function
kal_bool run_CHE_3DES_process(STCHE* che_context, CHE_TYPE type, CHE_OPERATION_MODE mode, CHE_ACTION act,
                     kal_uint8 *source, kal_uint8 *dest, kal_uint32 source_length,  kal_bool last_block, STFSAL *pstFSAL);
   
/// execute AES cipher function   
kal_bool run_CHE_AES_process(STCHE* che_context, CHE_TYPE type, CHE_OPERATION_MODE mode, CHE_ACTION act,
                     kal_uint8 *source, kal_uint8 *dest, kal_uint32 source_length,  kal_bool last_block, STFSAL *pstFSAL);
   

/// execute MD5 hash function
kal_bool run_CHE_MD5_process(STCHE* che_context, CHE_TYPE type, CHE_OPERATION_MODE mode, CHE_ACTION act,
                     kal_uint8 *source, kal_uint8 *dest, kal_uint32 source_length,  kal_bool last_block, STFSAL *pstFSAL);
   


/// execute SHA1 hash function
kal_bool run_CHE_SHA1_process(STCHE* che_context, CHE_TYPE type, CHE_OPERATION_MODE mode, CHE_ACTION act,
                     kal_uint8 *source, kal_uint8 *dest, kal_uint32 source_length,  kal_bool last_block, STFSAL *pstFSAL);
   


/// execute RC4 cipher function
kal_bool run_CHE_RC4_process(STCHE* che_context, CHE_TYPE type, CHE_OPERATION_MODE mode, CHE_ACTION act,
                     kal_uint8 *source, kal_uint8 *dest, kal_uint32 source_length,  kal_bool last_block, STFSAL *pstFSAL);
   

/// execute MD4 hash function
kal_bool run_CHE_MD4_process(STCHE* che_context, CHE_TYPE type, CHE_OPERATION_MODE mode, CHE_ACTION act,
                     kal_uint8 *source, kal_uint8 *dest, kal_uint32 source_length,  kal_bool last_block, STFSAL *pstFSAL);
   


/// execute MAC_MD5 hash function
kal_bool run_CHE_MAC_MD5_process(STCHE* che_context, CHE_TYPE type, CHE_OPERATION_MODE mode, CHE_ACTION act,
                     kal_uint8 *source, kal_uint8 *dest, kal_uint32 source_length,  kal_bool last_block, STFSAL *pstFSAL);
   


/// execute MAC_SHA1 hash function
kal_bool run_CHE_MAC_SHA1_process(STCHE* che_context, CHE_TYPE type, CHE_OPERATION_MODE mode, CHE_ACTION act,
                     kal_uint8 *source, kal_uint8 *dest, kal_uint32 source_length,  kal_bool last_block, STFSAL *pstFSAL);
   

/// execute RSA cipher function
kal_bool run_CHE_RSA_process(STCHE* che_context, CHE_TYPE type, CHE_OPERATION_MODE mode, CHE_ACTION act,
                     kal_uint8 *source, kal_uint8 *dest, kal_uint32 source_length,  kal_bool last_block, STFSAL *pstFSAL);
   

/// execute DH cipher function
kal_bool run_CHE_DH_process(STCHE* che_context, CHE_TYPE type, CHE_OPERATION_MODE mode, CHE_ACTION act,
                     kal_uint8 *source, kal_uint8 *dest, kal_uint32 source_length,  kal_bool last_block, STFSAL *pstFSAL);
