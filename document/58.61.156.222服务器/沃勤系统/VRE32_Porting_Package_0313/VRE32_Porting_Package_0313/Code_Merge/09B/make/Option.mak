...
ifeq ($(strip $(call Upper,$(CUSTOM_RELEASE))),TRUE)
include make\custom_trace_config.mak 
endif
...
ifdef GPS_SUPPORT
  ifneq ($(strip $(GPS_SUPPORT)),NONE)
    ifeq ($(strip $(FINGER_TOUCH_SUPPORT)),FTE)
      $(warning ERROR: GPS_SUPPORT do not support FTE)
      DEPENDENCY_CONFLICT = TRUE
    endif
...
MP4_SW_CODEC_V1_PLATFORM = MT6225 MT6235  MT6235B MT6253 MT6253T MT6253D 
...
RV_SW_CODEC_V2_PLATFORM = MT6236 MT6236B
MP4_SW_CODEC_V2_PLATFORM = MT6236 MT6236B
MP4_HW_CODEC_V2_PLATFORM = 
H264_SW_CODEC_V2_PLATFORM = MT6236 MT6236B
...
ifdef BROWSER_SUPPORT
  ifneq ($(strip $(BROWSER_SUPPORT)),NONE)
    ifneq ($(strip $(WBXML_SUPPORT)),TRUE)
      $(call DEP_ERR_ONA_OR_OFFB,WBXML_SUPPORT,BROWSER_SUPPORT)
      DEPENDENCY_CONFLICT = TRUE
    else
...
ifdef BROWSER_SUPPORT
  ifneq ($(strip $(BROWSER_SUPPORT)),NONE)
      ifndef UNIFIED_PUSH_FEATURES
          $(call DEP_ERR_ONA_OR_OFFB,UNIFIED_PUSH_FEATURES,BROWSER_SUPPORT)
          DEPENDENCY_CONFLICT = TRUE
      endif
      ...
      COMP_TRACE_DEFS  += vendor\push\obigo_Q03C\adaptation\integration\include\push_trc.h
...
COM_DEFS_FOR_MT6253D = MT6253D __HW_DIVIDER__ MT6253D_$(strip $(CHIP_VER))
...
COM_DEFS_FOR_TRULY_WQVGA_SYNC_LCM = R61509U COLOR_LCD TRULY_WQVGA_SYNC_LCM TFT_MAINLCD
...
ifneq ($(strip $(BROWSER_SUPPORT)),NONE)
  ifeq ($(strip $(TCPIP_SUPPORT)),NONE)
    $(call DEP_ERR_ONA_OR_OFFB,TCPIP_SUPPORT,BROWSER_SUPPORT)
    DEPENDENCY_CONFLICT = TRUE
  endif
  ifeq ($(strip $(BROWSER_SUPPORT)),OBIGO_Q05A)
...
ifdef J2ME_SUPPORT
  ifneq ($(strip $(J2ME_SUPPORT)),NONE)
    ifeq ($(strip $(BROWSER_SUPPORT)),NONE)
      $(call DEP_ERR_ONA_OR_OFFB,BROWSER_SUPPORT,J2ME_SUPPORT)
      DEPENDENCY_CONFLICT = TRUE
    endif
...
ifdef DRM_SUPPORT
  ifneq ($(strip $(DRM_SUPPORT)),WS)
    ifneq ($(strip $(DRM_SUPPORT)),NONE)
      ifeq ($(strip $(BROWSER_SUPPORT)),NONE)     
        $(call DEP_ERR_ONA_OR_OFFB,BROWSER_SUPPORT,DRM_SUPPORT)
        DEPENDENCY_CONFLICT = TRUE
      endif
    endif
  endif
...
ifdef STREAM_SUPPORT
  ifneq ($(strip $(STREAM_SUPPORT)),FALSE)
    ...
    ifeq ($(strip $(BROWSER_SUPPORT)),NONE)
       $(call DEP_ERR_ONA_OR_OFFB,BROWSER_SUPPORT,STREAM_SUPPORT)
       DEPENDENCY_CONFLICT = TRUE
    endif
  endif
endif
...
ifdef 3G_VIDEO_CALL
  ifeq ($(strip $(3G_VIDEO_CALL)),TRUE)
    ifeq ($(strip $(FINGER_TOUCH_SUPPORT)),FTE)
      $(warning ERROR: 3G_VIDEO_CALL do not support FTE)
      DEPENDENCY_CONFLICT = TRUE
    endif
    COMPLIST        += 3g324m
...
ifeq ($(strip $(MTV_SUPPORT_ADD_CONDITION)),TRUE)
  COMPLIST += mtv
  ifeq ($(strip $(ATV_SUPPORT)),TRUE)
    COM_DEFS += __ATV_SUPPORT__
    COMMINCDIRS	+=  plutommi\MtkApp\MobileTVPlayer\MobileTVPlayerInc
    COMPLIST         += matv
    COMMINCDIRS    +=	custom\drv\mATV\MT5192
    COMMINCDIRS    +=	custom\drv\mATV\MT5192\hostlib
    ifneq ($(strip $(I2S_INPUT_MODE_SUPPORT)),TRUE)
      $(call DEP_ERR_ONA_OR_OFFB,I2S_INPUT_MODE_SUPPORT,ATV_SUPPORT)
      DEPENDENCY_CONFLICT = TRUE
    endif
  else
...
ifdef SYNCML_DM_SUPPORT
  ifeq ($(strip $(SYNCML_DM_SUPPORT)),TRUE)
    ifndef BROWSER_SUPPORT
      $(call DEP_ERR_ONA_OR_OFFB,BROWSER_SUPPORT,SYNCML_DM_SUPPORT)
      DEPENDENCY_CONFLICT = TRUE
    endif
    ifdef BROWSER_SUPPORT
      ifeq ($(strip $(BROWSER_SUPPORT)),NONE)
  ...
  ifneq ($(strip $(DRM_SUPPORT)),NONE)
    ...
    ifneq ($(findstring BSCI,$(strip $(DRM_SUPPORT))),)
      ...
      ifeq ($(strip $(DRM_SUPPORT)),BSCI)
        ...
        ifeq ($(strip $(COMPILER)),RVCT)
          COMPOBJS         += vendor\drm\bsci\bsci_rvct.lib
          CUS_REL_OBJ_LIST += vendor\drm\bsci\bsci_rvct.lib
        else
...
ifdef SYSTEM_DRIVE_ON_NAND
  ifeq ($(strip $(SYSTEM_DRIVE_ON_NAND)),TRUE)
    SYSTEM_DRIVE_ON_NAND_SUPPORT_PLATFORM = MT6228 MT6229 MT6230 MT6217 MT6218B MT6219 MT6227 MT6226 MT6226M MT6225 MT6253T MT6253 MT6253D MT6223 MT6227D MT6226D MT6223P MT6238 MT6239 MT6235 MT6235B MT6236 MT6236B MT6268T MT6268H MT6268A MT6268 
...
ifdef MSDC_CARD_SUPPORT_TYPE
  ifneq ($(strip $(MSDC_CARD_SUPPORT_TYPE)),NONE)
      MSDC_SUPPORT_PLATFORM = MT6217 MT6218B MT6219 MT6228 MT6229 MT6230 MT6226 MT6227 MT6226M MT6225 MT6253T MT6253 MT6253D MT6227D MT6226D MT6223P MT6238 MT6239 MT6235 MT6235B MT6236 MT6236B MT6268T MT6268H MT6268A MT6268 
...
ifeq ($(strip $(USB_SUPPORT)),TRUE)
  USB_SUPPORT_PLATFORM = MT6217 MT6218B MT6219 MT6228 MT6229 MT6230 MT6227 MT6226 MT6226M MT6225 MT6253T MT6253 MT6253D MT6227D MT6226D MT6238 MT6239 MT6235 MT6235B MT6236 MT6236B MT6268T MT6268H MT6268A MT6268 MT6516 
...
WT100K_ROM_SUPPORT_PLATFORM = MT6253 MT6253D MT6253T 
ifdef WAVETABLE_VER
    ifeq ($(strip $(WAVETABLE_VER)),WT100K_ROM)
        ifeq ($(filter $(strip $(PLATFORM)),$(WT100K_ROM_SUPPORT_PLATFORM)),)
            $(warning ERROR: PLATFORM $(strip $(PLATFORM)) does not support WAVETABLE_VER=WT100K_ROM) 
            DEPENDENCY_CONFLICT = TRUE
        endif
    endif
endif
...
ifdef VR_ENGINE
  ifneq ($(strip $(VR_ENGINE)),NONE)
    ifeq ($(strip $(FINGER_TOUCH_SUPPORT)),FTE)
      $(warning ERROR: VR_ENGINE do not support FTE)
      DEPENDENCY_CONFLICT = TRUE
    endif
    COM_DEFS	+= $(VR_ENGINE)
  endif
...
ifdef FS_SORT_MAX_ENTRY
  FS_SORT_MAX_ENTRY_PLATFORM = MT6228 MT6229 MT6230 MT6235 MT6235B MT6236 MT6236B MT6238 MT6239 MT6253 MT6253D MT6268 MT6268A
...
BLUETOOTH_SUPPORT_CHIP = BTMTK_MT6601 BTMTK_MT6611 BTMTK_MT6612 BTMTK_MT6236 BTMTK_MT6616
# NONE, BTMTK, BTMTK_MT6601, BTMTK_MT6611, BTMTK_MT6612, BTMTK_MT6236, BTMTK_MT6616
ifdef BLUETOOTH_SUPPORT
  ifneq ($(strip $(BLUETOOTH_SUPPORT)),NONE)
    ...
    ifeq ($(strip $(BLUETOOTH_SUPPORT)),BTMTK_MT6236)
      COM_DEFS    +=  __BTMTK__ __BTMODULE_MT6612__ __BTMODULE_MT6236__ __BRT_SUPPORT__
    endif
    ...
    ifeq ($(filter $(strip $(BLUETOOTH_SUPPORT)),$(BLUETOOTH_SUPPORT_CHIP)),)
      ifneq ($(strip $(BT_SPP_SERVER)),NONE)
        $(call DEP_ERR_SETA_OR_OFFB,BLUETOOTH_SUPPORT,BTMTK_MT6601/BTMTK_MT6611/BTMTK_MT6612/BTMTK_MT6236/BTMTK_MT6616,BT_SPP_SERVER)
        DEPENDENCY_CONFLICT = TRUE
      endif
      ifneq ($(strip $(BT_SPP_CLIENT)),NONE)
        $(call DEP_ERR_SETA_OR_OFFB,BLUETOOTH_SUPPORT,BTMTK_MT6601/BTMTK_MT6611/BTMTK_MT6612/BTMTK_MT6236/BTMTK_MT6616,BT_SPP_CLIENT)
        DEPENDENCY_CONFLICT = TRUE
      endif
    endif
    ...
    ifeq ($(strip $(BT_HIDD_PROFILE)),TRUE)
      ifeq ($(strip $(FINGER_TOUCH_SUPPORT)),FTE)
        $(warning ERROR: BT_HIDD_PROFILE do not support FTE)
        DEPENDENCY_CONFLICT = TRUE
      endif
    ...
    ifeq ($(strip $(BT_BIP_PROFILE)),TRUE)
      ...
      ifeq ($(strip $(FINGER_TOUCH_SUPPORT)),FTE)
        $(warning ERROR: BT_BIP_PROFILE do not support FTE)
        DEPENDENCY_CONFLICT = TRUE
      endif
...
ifneq ($(strip $(call Upper,$(PROJECT))),BASIC)
  PNG_DECODE_HW_NOT_SUPPORT_PLATFORM = MT6228 MT6229 MT6230 MT6235 MT6235B MT6236 MT6236B MT6225 MT6253T MT6253 MT6253D MT6223 MT6223P
  ifeq ($(strip $(PNG_DECODE)),PNG_HW)
  ...
  JPG_CODEC_HW_NOT_SUPPORT_PLATFORM = MT6225 MT6253T MT6253 MT6253D MT6223 MT6223P
...
ifdef GIF_DECODE
  ...
  ifdef PLATFORM
    GIF_DECODE_NOT_SUPPORT_PLATFORM = MT6205B MT6217 MT6218B MT6223 MT6223P MT6225 MT6235 MT6235B MT6236 MT6236B MT6238 MT6239 MT6253 MT6253D MT6253T
    ifeq ($(strip $(GIF_DECODE)),TRUE)
      ifneq ($(filter $(strip $(PLATFORM)),$(GIF_DECODE_NOT_SUPPORT_PLATFORM)),)
        $(warning ERROR: PLATFORM $(strip $(PLATFORM)) does not support hardware GIF decoder, please set GIF_DECODE to FALSE) 
        DEPENDENCY_CONFLICT = TRUE
      endif
      ifeq ($(strip $(PLATFORM)),MT6219)
...
ifeq ($(strip $(DAF_DECODE)),TRUE)
   DAF_DECODE_SUPPORT_PLATFORM = MT6217 MT6218B MT6219 MT6226M MT6228 MT6229 MT6230 MT6226 MT6227 MT6225 MT6253T MT6253 MT6253D MT6223 MT6227D MT6226D MT6223P MT6238 MT6239 MT6235 MT6235B MT6236 MT6236B MT6268T MT6268H MT6268A MT6268 
...
ifeq ($(strip $(AAC_DECODE)),TRUE)
   AAC_DECODE_SUPPORT_PLATFORM = MT6219 MT6226M MT6228 MT6229 MT6230 MT6226 MT6227 MT6225 MT6253T MT6253 MT6253D MT6227D MT6226D MT6238 MT6239 MT6235 MT6235B MT6236 MT6236B MT6268T MT6268H MT6268A MT6268 
...
ifdef CMOS_SENSOR
  ...
  ifeq ($(strip $(CMOS_SENSOR)),NONE)
    ifdef ISP_SUPPORT
      ifeq ($(strip $(ISP_SUPPORT)),TRUE)
        $(warning ERROR: Please set ISP_SUPPORT = FALSE when CMOS_SENSOR = NONE ) 
        DEPENDENCY_CONFLICT = TRUE
      endif
    endif
  endif
...
MJPG_SUPPORT_EXT_CAM_MODULE_DEP_PLATFORM = MT6217 MT6218B MT6225 MT6253T MT6253 MT6253D MT6235 MT6235B MT6236 MT6236B MT6223P 
...
TP_INTERNAL_SUPPORT_PLATFORM = MT6235 MT6235B MT6236 MT6236B MT6238 MT6239 MT6268 MT6268A MT6268 MT6516 MT6253 MT6253D MT6253T 
...
ifeq ($(strip $(IRDA_SUPPORT)),TRUE)
  ...
  IRDA_FULL_COMPILE_OPTION_PLATFORM = MT6228 MT6229 MT6230 MT6238 MT6239 MT6235 MT6235B MT6236 MT6236B MT6268T MT6268H 
...
ifdef NAND_FLASH_BOOTING
  ifneq ($(strip $(NAND_FLASH_BOOTING)),NONE)
    NAND_FLASH_BOOTING_SUPPORT_PLATFORM = MT6228 MT6229 MT6225 MT6230 MT6238 MT6239 MT6235 MT6235B MT6236 MT6236B MT6268A MT6268 
    NFB_ONDEMAND_SUPPORT_PLATFORM = MT6238 MT6239 MT6235 MT6235B MT6236 MT6236B MT6268A MT6268 
    ifeq ($(strip $(SMART_PHONE_CORE)),AP)
...
ifdef USB_DOWNLOAD
  ifneq ($(strip $(USB_DOWNLOAD)),NONE)
    ifeq ($(strip $(USB_SUPPORT)),TRUE)
      USB_DOWNLOAD_SUPPORT_PLATFORM = MT6227 MT6226 MT6226M MT6227D MT6226D MT6225 MT6253T MT6253 MT6253D MT6228 MT6229 MT6230 MT6235 MT6235B MT6236 MT6236B MT6238 MT6239 MT6268A MT6268 
...
ARM9_FOTA_PLATFORM = MT6238 MT6239 MT6235 MT6235B MT6236 MT6236B MT6268
ARM7_FOTA_PLATFORM = MT6223 MT6223P MT6229 MT6228 MT6230 MT6225 MT6226 MT6226M MT6226D MT6227 MT6227D MT6253 MT6253D
ifdef FOTA_ENABLE
  ifneq ($(strip $(FOTA_ENABLE)),NONE)
    ifeq ($(strip $(SYNCML_DM_SUPPORT)),TRUE)
...
ifdef SINGLE_BANK_NOR_FLASH_SUPPORT
   ifeq ($(strip $(SINGLE_BANK_NOR_FLASH_SUPPORT)),TRUE)
     ifeq ($(filter $(strip $(PLATFORM)),$(SINGLE_BANK_NOR_FLASH_SUPPORT_SUPPORT_PLATFORM)),)
       $(warning ERROR: PLATFORM $(strip $(PLATFORM)) does not support SINGLE_BANK_NOR_FLASH_SUPPORT) 
       DEPENDENCY_CONFLICT = TRUE
     endif
     ifdef EMS_SUPPORT
...
ENHANCED_SINGLE_BANK_NOR_FLASH_SUPPORT_SUPPORTED_PLATFORM = MT6205B MT6223 MT6223P MT6225 MT6253T MT6253 MT6253D MT6226 MT6226D MT6226M MT6227 MT6229 MT6230 MT6227D MT6235 MT6235B MT6253 MT6253D
ifdef ENHANCED_SINGLE_BANK_NOR_FLASH_SUPPORT
  ifeq ($(strip $(ENHANCED_SINGLE_BANK_NOR_FLASH_SUPPORT)),TRUE)
    ...
    ifneq ($(strip $(SYSGEN_ENABLE)),TRUE)
      $(warning ERROR: Please turn on SYSGEN_ENABLE when ENHANCED_SINGLE_BANK_NOR_FLASH_SUPPORT is TRUE) 
      DEPENDENCY_CONFLICT = TRUE
    endif
    ifeq ($(strip $(SYSTEM_DRIVE_ON_NAND)),TRUE)
...
ifdef SWDBG_SUPPORT
   ifeq ($(strip $(SWDBG_SUPPORT)),TRUE)
      SWDBG_SUPPORT_PLATFORM = MT6228 MT6229 MT6230 MT6223 MT6223P MT6238 MT6239 MT6235 MT6235B MT6236 MT6236B MT6268T MT6268H MT6268A MT6268 
...
ifdef UID_SUPPORT
   ifeq ($(strip $(UID_SUPPORT)),TRUE)
      UID_SUPPORT_PLATFORM = MT6228 MT6229 MT6230 MT6227 MT6226 MT6226M MT6225 MT6253T MT6253 MT6253D MT6223 MT6227D MT6226D MT6223P MT6238 MT6239 MT6235 MT6235B MT6236 MT6236B MT6268T MT6268H MT6268A MT6268 
      ifeq ($(filter $(strip $(PLATFORM)) ,$(UID_SUPPORT_PLATFORM)),)
          $(warning ERROR: PLATFORM $(strip $(PLATFORM)) does not support UID_SUPPORT.) 
          DEPENDENCY_CONFLICT = TRUE
      endif
...
ifdef WMA_DECODE
 ifeq ($(strip $(COMPILER)),ADS)
  ifeq ($(strip $(WMA_DECODE)),TRUE)
      WMA_DECODE_SUPPORT_PLATFORM = MT6228 MT6229 MT6230 MT6238 MT6239 MT6235 MT6235B MT6236 MT6236B MT6268T MT6268H MT6268A MT6268 MT6253T MT6253 MT6253D 
...
ifdef LOW_COST_SUPPORT
  ifneq ($(strip $(LOW_COST_SUPPORT)),NONE)
    ...
    ifeq ($(strip $(LOW_COST_SUPPORT)),COMMON)
      ifeq ($(strip $(MMI_VERSION)),PLUTO_MMI)
        ifneq ($(strip $(LARGE_MIDI_FILE_SUPPORT)),TRUE)
          $(call DEP_ERR_ONA_OR_OFFB,LARGE_MIDI_FILE_SUPPORT,LOW_COST_SUPPORT)
          DEPENDENCY_CONFLICT = TRUE
        endif
      endif    
    endif
...
ifdef AAC_PLUS_DECODE
   ifeq ($(strip $(AAC_PLUS_DECODE)),TRUE)
      AAC_PLUS_DECODE_SUPPORT_PLATFORM = MT6228 MT6229 MT6230 MT6226 MT6227 MT6226M MT6225 MT6253T MT6253 MT6253D MT6227D MT6226D MT6238 MT6239 MT6235 MT6235B MT6236 MT6236B MT6268T MT6268H MT6268A MT6268 
...
ifdef AAC_PLUS_PS_DECODE
   ifeq ($(strip $(AAC_PLUS_PS_DECODE)),TRUE)
      AAC_PLUS_PS_DECODE_SUPPORT_PLATFORM = MT6228 MT6229 MT6230 MT6226 MT6227 MT6226M MT6225 MT6253T MT6253 MT6253D MT6227D MT6226D MT6238 MT6239 MT6235 MT6235B MT6236 MT6236B MT6268A MT6268 
...
ifdef EDGE_SUPPORT
   ifeq ($(strip $(EDGE_SUPPORT)),TRUE)
     EDGE_SUPPORT_PLATFORM = MT6229 MT6230 MT6238 MT6239 MT6235 MT6235B MT6236 MT6236B MT6268 TK6516 MT6516 MT6268T MT6268H MT6268A MT6268 
...
ifdef R5_SUPPORT
  ...
  ifeq ($(strip $(R5_SUPPORT)),TRUE)
    ...
    ifneq ($(strip $(PLATFORM)),MT6516)
          COM_DEFS    +=   __REL5__ __ACL_SUPPORT__
    else
          COM_DEFS    +=   __REL5__    
    endif
  endif
...
ifdef TV_OUT_SUPPORT
  ...
  TV_OUT_SUPPORT_PLATFORM = MT6228 MT6229 MT6268T MT6268H MT6238 MT6239 MT6235 MT6235B MT6236 MT6236B MT6230 MT6268A MT6268 
...
BES_LIVE_SUPPORT_SUPPORT_PLATFORM = MT6228 MT6229 MT6230 MT6238 MT6239 MT6235 MT6235B MT6236 MT6236B MT6268A MT6268 
              ...
              ifeq ($(strip $(EMPTY_RESOURCE)),TRUE)
                ifneq ($(strip $(SVG_SUPPORT)),IKIVO_DEMO)
                  ifneq ($(strip $(SVG_SUPPORT)),MTK_SVG)
                    $(warning ERROR: Please set SVG_SUPPORT to be IKIVO_DEMO or MTK_SVG in customer projects) 
                    DEPENDENCY_CONFLICT = TRUE
                  endif
                endif
              endif
...
DRV_CUSTOM_TOOL_SUPPORT_PLATFORM = MT6253 MT6253D MT6268 MT6236 MT6236B 
...
ifdef MMS_SUPPORT
    ifeq ($(strip $(MMS_SUPPORT)),OBIGO_Q03C_MMS_V02)
      ifneq ($(strip $(UNIFIED_MESSAGE_FOLDER)),TRUE)
        $(call DEP_ERR_SETA_OR_ONB,MMS_SUPPORT,non OBIGO_Q03C_MMS_V02,UNIFIED_MESSAGE_FOLDER)
        DEPENDENCY_CONFLICT = TRUE
      endif
      ...
      ifneq ($(strip $(HTTP_INTERFACE_SUPPORT)),TRUE)
        $(call DEP_ERR_ONA_OR_OFFB,HTTP_INTERFACE_SUPPORT,MMS_SUPPORT)
        DEPENDENCY_CONFLICT = TRUE
      endif
    endif
endif
...
SECURE_SUPPORT_NOT_SUPPORT_NFB_PLATFORM = MT6226 MT6229 MT6225 MT6253T MT6253 MT6253D MT6223 MT6227 MT6230 MT6226M MT6223P
...
ifdef GIS_SUPPORT
  ifneq ($(strip $(GIS_SUPPORT)),NONE)
    ...
    ifeq ($(strip $(FINGER_TOUCH_SUPPORT)),FTE)
      $(warning ERROR: GIS_SUPPORT do not support FTE)
      DEPENDENCY_CONFLICT = TRUE
    endif    
    COMPLIST    += gis
...
BES_SURROUND_SUPPORT_SUPPORT_PLATFORM = MT6228 MT6229 MT6230 MT6235 MT6235B MT6236 MT6236B MT6238 MT6239 MT6268T MT6268H MT6268 MT6268A MT6268 
...
ifdef BES_EQ_SUPPORT
  ifeq ($(strip $(BES_EQ_SUPPORT)),TRUE)
    ifneq ($(filter $(strip $(PLATFORM)),MT6205 MT6205B ),)
      $(warning ERROR: BES_EQ_SUPPORT is not supported on $(PLATFORM)!)
      DEPENDENCY_CONFLICT = TRUE
    endif
...
BES_LOUDNESS_SUPPORT_SUPPORT_PLATFORM = MT6225 MT6228 MT6229 MT6230 MT6238 MT6239 MT6235 MT6235B MT6236 MT6236B MT6268A MT6268 MT6268T MT6268H MT6268 MT6253T MT6253 MT6253D MT6270A 
ifdef BES_LOUDNESS_SUPPORT
   ifneq ($(strip $(BES_LOUDNESS_SUPPORT)),NONE)
      ifeq ($(strip $(BES_LOUDNESS_SUPPORT)),LOUDSPEAKER)
         COM_DEFS += __BES_LOUDNESS_LSPK__
         COM_DEFS += __BES_LOUDNESS_SUPPORT__
      endif
      ifeq ($(strip $(BES_LOUDNESS_SUPPORT)),LOUDSPEAKER_RINGTONE)
         ifeq ($(strip $(AUDIO_COMPENSATION_ENABLE)),TRUE)
            COM_DEFS += __BES_LOUDNESS_ACF_ENABLE__
            COM_DEFS += __BES_LOUDNESS_SUPPORT__
            COM_DEFS += __BES_LOUDNESS_LSPK__
         else 
            COM_DEFS += __BES_LOUDNESS_LSPK_RINGTONE__
            COM_DEFS += __BES_LOUDNESS_SUPPORT__
         endif
      endif      
...
BES_EQ_SUPPORT_AUDIO_COMPENSATION_ENABLE_EXCLUSIVE_PLATFORM = MT6219 MT6223 MT6223P MT6225 MT6226 MT6226D MT6226M MT6227D MT6227 MT6253 MT6253D
ifdef AUDIO_COMPENSATION_ENABLE
    ifeq ($(strip $(AUDIO_COMPENSATION_ENABLE)),TRUE)
     ...
     ifeq ($(strip $(BES_LOUDNESS_SUPPORT)),NONE)
            ifneq ($(filter $(strip $(PLATFORM)) ,$(BES_LOUDNESS_SUPPORT_SUPPORT_PLATFORM)),)
               COM_DEFS += __BES_LOUDNESS_SUPPORT__
               COM_DEFS += __BES_LOUDNESS_ACF_ENABLE__            
               CONDITION_COM_DEFS_BESSOUND_SUPPORT = TRUE
...
REPEATED_ACCH_NOT_SUPPORT_FLATFORM = MT6205 MT6205B MT6208 MT6217 MT6218 MT6218B MT6219 MT6223 MT6223P MT6225 MT6226 MT6226D MT6226M MT6227 MT6227D MT6228 MT6229 MT6230 MT6235 MT6235B MT6236 MT6236B MT6238 MT6239 MT6268T MT6268H 
...
CAMCORDER_SUPPORT_PLATFORM = MT6238 MT6239 MT6268 MT6268A MT6268 MT6236 MT6236B 
CAMCORDER_LOW_END_SUPPORT_PLATFORM = MT6235 MT6235B MT6253 MT6253D MT6253T
...
ifdef MMS_SUPPORT
  ifneq ($(strip $(MMS_SUPPORT)),NONE)
    ifeq ($(strip $(BROWSER_SUPPORT)),NONE)     
      $(call DEP_ERR_ONA_OR_OFFB,BROWSER_SUPPORT,MMS_SUPPORT)
      DEPENDENCY_CONFLICT = TRUE
    endif
    ifeq ($(strip $(MMS_SUPPORT)),OBIGO_Q03C_MMS_V01)     
      ifneq ($(strip $(BROWSER_SUPPORT)),OBIGO_Q03C)     
        $(call DEP_ERR_SETA_OR_SETB,MMS_SUPPORT,non OBIGO_Q03C_MMS_V01,BROWSER_SUPPORT,OBIGO_Q03C)
        DEPENDENCY_CONFLICT = TRUE
      endif
      ifeq ($(strip $(UNIFIED_MESSAGE_FOLDER)),TRUE)     
        $(call DEP_ERR_SETA_OR_OFFB,MMS_SUPPORT,OBIGO_Q03C_MMS_V02,UNIFIED_MESSAGE_FOLDER)
        DEPENDENCY_CONFLICT = TRUE
      endif
      ifeq ($(strip $(FINGER_TOUCH_SUPPORT)),FTE)
        $(warning ERROR: MMS_SUPPORT is OBIGO_Q03C_MMS_V01 do not support FTE)
        DEPENDENCY_CONFLICT = TRUE
      endif      
    ...
    ifeq ($(strip $(MMS_SUPPORT)),OBIGO_Q03C_MMS_V02)
      ifeq ($(strip $(BROWSER_SUPPORT)),NONE)     
        $(call DEP_ERR_SETA_OR_ONB,MMS_SUPPORT,non OBIGO_Q03C_MMS_V02,BROWSER_SUPPORT)
        DEPENDENCY_CONFLICT = TRUE
      endif
...
ifdef BCR_SUPPORT
  ifneq ($(strip $(BCR_SUPPORT)),NONE)
    ...
    ifeq ($(filter $(strip $(PLATFORM)) ,$(BCR_SUPPORT_PLATFORM)),)
      $(warning ERROR: PLATFORM $(strip $(PLATFORM)) does not support BCR_SUPPORT)
      DEPENDENCY_CONFLICT = TRUE
    endif
    ...
    ifeq ($(filter $(strip $(call Upper,$(MAIN_LCD_SIZE))),$(BCR_SUPPORT_MAIN_LCD_SIZE)),)
      $(warning ERROR: BCR_SUPPORT do not support MAIN_LCD_SIZE = $(MAIN_LCD_SIZE) !)
      DEPENDENCY_CONFLICT = TRUE
    endif
...
ifdef MEDIA_PLAYER_VER
  ...
  ifeq ($(strip $(MEDIA_PLAYER_VER)),INTEGRATED_FTE)
    ifneq ($(strip $(FINGER_TOUCH_SUPPORT)),FTE)
      $(call DEP_ERR_SETA_OR_SETB,FINGER_TOUCH_SUPPORT,FTE,MEDIA_PLAYER_VER,non INTEGRATED_FTE)
      DEPENDENCY_CONFLICT = TRUE
    endif
    COM_DEFS += __INTEGRATED_PLAYER_FTE__
  endif
endif
...
ifdef DRA_DECODE
  ifeq ($(strip $(DRA_DECODE)),TRUE)
    DRA_DECODE_SUPPORT_PLATFORM = MT6235 MT6235B MT6236 MT6236B MT6238 MT6239 MT6268T MT6268H MT6268A MT6268
...
ifeq ($(strip $(BES_BASS_SUPPORT)),TRUE)
  BES_BASS_SUPPORT_SUPPORT_PLATFORM = MT6235 MT6235B MT6236 MT6236B MT6238 MT6239 MT6268T MT6268H MT6268 MT6268A MT6268 
...
ifdef MMS_FEATURES
    ...
    ifneq ($(strip $(MMS_FEATURES)),NONE)
        ...
        ifeq ($(strip $(MMS_FEATURES)),SLIM)
            ifeq ($(strip $(MMS_SUPPORT)),OBIGO_Q03C_MMS_V01)
                $(warning ERROR: MMS_FEATURES can NOT be SLIM when MMS_SUPPORT = OBIGO_Q03C_MMS_V01!)
                DEPENDENCY_CONFLICT = TRUE
            endif
...
ifdef UCWEB_SUPPORT
 ifeq ($(strip $(COMPILER)),ADS)
  ifeq ($(strip $(UCWEB_SUPPORT)),UCWEB6)
    ifeq ($(strip $(FINGER_TOUCH_SUPPORT)),FTE)
      $(warning ERROR: UCWEB_SUPPORT do not support FTE)
      DEPENDENCY_CONFLICT = TRUE
    endif  
    COM_DEFS += __UCWEB6__
    COMPLIST    += ucwebadp
...
ifeq ($(strip $(PANORAMA_VIEW_SUPPORT)),TRUE)
  PANORAMA_NOSUPPORT_PLATFORM =  MT6253 MT6253D MT6253T MT6253PMU 
...
ifdef QQIM_SUPPORT
 ifeq ($(strip $(COMPILER)),ADS)
  ...
  ifdef TCPIP_SUPPORT
    ifneq ($(findstring TCP,$(TCPIP_SUPPORT)),)
      ifeq ($(strip $(MMI_VERSION)),PLUTO_MMI)
        COMPLIST    += qqim
        CUS_REL_OBJ_LIST += vendor\qqim\lib\qq.lib
        CUS_REL_OBJ_LIST += vendor\qqim\lib\qq_slim.lib
        ifeq ($(strip $(EMPTY_RESOURCE)),FALSE)
          CUS_REL_FILES_LIST += vendor\qqim\modis_lib\qqlib.lib
          CUS_REL_FILES_LIST += vendor\qqim\modis_lib\qqlib_slim.lib
        endif
      endif
    endif
  endif
  ifneq ($(strip $(QQIM_SUPPORT)),NONE)
    ifeq ($(filter $(call Upper,$(strip $(MAIN_LCD_SIZE))),176X220 240X320 240X400),)
      $(warning ERROR: QQIM only supports 176X220, 240X320, and 240X400 MAIN_LCD_SIZE)
      DEPENDENCY_CONFLICT = TRUE
    endif
    ifndef TCPIP_SUPPORT
    ...
    ifeq ($(findstring TCP,$(TCPIP_SUPPORT)),)
      $(call DEP_ERR_SETA_OR_OFFB,TCPIP_SUPPORT,TCP/UDP_TCP,QQIM_SUPPORT)
      DEPENDENCY_CONFLICT = TRUE
    endif
    ifeq ($(strip $(FINGER_TOUCH_SUPPORT)),FTE)
      $(warning ERROR: QQIM_SUPPORT do not support FTE)
      DEPENDENCY_CONFLICT = TRUE
    endif    
    ifeq ($(strip $(QQIM_SUPPORT)),SLIM)
      ifneq ($(strip $(BROWSER_SUPPORT)),OBIGO_Q03C)
        $(call DEP_ERR_SETA_OR_SETB,BROWSER_SUPPORT,OBIGO_Q03C,QQIM_SUPPORT,non SLIM)
        DEPENDENCY_CONFLICT = TRUE
      endif
    endif
    COM_DEFS    += __QQIM_SUPPORT__
    ifeq ($(strip $(QQIM_SUPPORT)),FULL)
      COMPOBJS    += vendor\qqim\lib\qq.lib
    else
      ifeq ($(strip $(QQIM_SUPPORT)),SLIM)
        COM_DEFS    += __QQIM_SLIM_SUPPORT__
        COMPOBJS    += vendor\qqim\lib\qq_slim.lib
      endif
    endif
    ifneq ($(strip $(VENDOR)),NONE)
      ifneq ($(strip $(VENDOR)),QQIM)
        $(warning ERROR: QQIM_SUPPORT cannot be enabled in vendor release)
        DEPENDENCY_CONFLICT = TRUE
      endif
    endif
  endif
...
A8BOX_SUPPORT_PLATFORM = MT6225 MT6229 MT6235 MT6235B MT6236 MT6236B MT6238 MT6239 MT6268 MT6268A MT6268T MT6268H MT6253 MT6253D MT6253T
ifdef A8BOX_SUPPORT
...
ifdef GGLIVE_SUPPORT
  ifeq ($(strip $(GGLIVE_SUPPORT)),TRUE)
    ...
    ifeq ($(strip $(FINGER_TOUCH_SUPPORT)),FTE)
      $(warning ERROR: GGLIVE_SUPPORT do not support FTE)
      DEPENDENCY_CONFLICT = TRUE
    endif    
...
ifdef USB_HS_SUPPORT
  ifeq ($(strip $(USB_HS_SUPPORT)),TRUE)
     ifneq ($(strip $(USB_SUPPORT)),TRUE)
       ...
       USB_HS_SUPPORT_PLATFORM = MT6238 MT6239 MT6235 MT6235B MT6236 MT6236B MT6268A MT6268 MT6268H MT6253T MT6253 MT6253D MT6516 
...
ifdef KURO_SUPPORT
  ifneq ($(strip $(KURO_SUPPORT)), NONE)
    ...
    KURO_SUPPORT_MEDIA_PLAYER_VER = INTEGRATED INTEGRATED_FTE INTEGRATED_FTE_DB
    ifeq ($(filter $(strip $(MEDIA_PLAYER_VER)),$(KURO_SUPPORT_MEDIA_PLAYER_VER)),)
      $(call DEP_ERR_SETA_OR_OFFB,MEDIA_PLAYER_VER,INTEGRATED/INTEGRATED_FTE/INTEGRATED_FTE_DB,KURO_SUPPORT)
      DEPENDENCY_CONFLICT = TRUE
    endif
  endif
...
ifdef E_COMPASS_SENSOR_SUPPORT 
  ifneq ($(strip $(E_COMPASS_SENSOR_SUPPORT)),NONE) 
    ifeq ($(strip $(FINGER_TOUCH_SUPPORT)),FTE)
      $(warning ERROR: E_COMPASS_SENSOR_SUPPORT do not support FTE)
      DEPENDENCY_CONFLICT = TRUE
    endif
...
ifdef IMAGE_VIEWER_VER
  ifneq ($(strip $(IMAGE_VIEWER_VER)),NONE)
    ...
    IMAGE_VIEWER_VER_EX_SUPPORT_PLATFORM = MT6225 MT6235 MT6235B MT6236 MT6236B MT6238 MT6239 MT6268 MT6268A MT6268T MT6268H MT6253 MT6253D MT6253T 
...
ifeq ($(strip $(BITSTREAM_SUPPORT)),TRUE)
   ...
   ifdef H264_DECODE
     ifeq ($(strip $(H264_DECODE)),TRUE)
       COM_DEFS    += __BITSTREAM_VIDEO_API_SUPPORT__
     endif
   endif
endif
...
ifdef MP4_DECODE_MODE
    ...
    ifeq ($(strip $(MP4_DECODE_MODE)),SLIM)
        MP4_DECODE_MODE_SLIM_SUPPORT_PLATFORM = MT6253T MT6253 MT6253D 
...
ifdef H264_OPEN_API
  ifeq ($(strip $(H264_OPEN_API)),TRUE)
    ...
    ifeq ($(filter $(strip $(PLATFORM)),$(H264_HW_CODEC_V1_PLATFORM)),)
      $(warning ERROR: VDOEDT_SUPPORT require H264_HW which is not supported by PLATFORM=$(strip $(PLATFORM)))
      DEPENDENCY_CONFLICT = TRUE    
    endif
    COM_DEFS    += __H264_OPEN_API_SUPPORT__
  endif
endif
...
ifeq ($(strip $(MMI_VERSION)),PLUTO_MMI)
   COM_DEFS += __SMS_STORAGE_BY_MMI__ __PHB_STORAGE_BY_MMI__
   COMPLIST += smslib
endif
...
ifdef HTTP_INTERFACE_SUPPORT
  ifeq ($(strip $(HTTP_INTERFACE_SUPPORT)),TRUE)
    ifndef BROWSER_SUPPORT
      $(call DEP_ERR_ONA_OR_OFFB,BROWSER_SUPPORT,HTTP_INTERFACE_SUPPORT)
      DEPENDENCY_CONFLICT = TRUE
    endif
    ifeq ($(strip $(BROWSER_SUPPORT)),NONE)
      $(call DEP_ERR_ONA_OR_OFFB,BROWSER_SUPPORT,HTTP_INTERFACE_SUPPORT)
...
ifdef UNIFIED_PUSH_FEATURES
    ifneq ($(strip $(UNIFIED_PUSH_FEATURES)),NONE)
        ifndef BROWSER_SUPPORT
            $(call DEP_ERR_ONA_OR_OFFB,BROWSER_SUPPORT,UNIFIED_PUSH_FEATURES)
            DEPENDENCY_CONFLICT = TRUE
        endif
        ifeq ($(strip $(BROWSER_SUPPORT)),NONE)
            $(call DEP_ERR_ONA_OR_OFFB,BROWSER_SUPPORT,UNIFIED_PUSH_FEATURES)
...
ifdef WAPI_SUPPORT
  ifneq ($(strip $(WAPI_SUPPORT)),FALSE)
...
DSP_COMPRESS_SUPPORT_PLATFORM = MT6225 MT6253 MT6253D
ifdef DSP_COMPRESS
...
ifdef I2S_INPUT_MODE_SUPPORT
   ifeq ($(strip $(I2S_INPUT_MODE_SUPPORT)),TRUE)
      ...
      I2S_INPUT_SUPPORT_PLATFORM = MT6225 MT6253T MT6253 MT6238 MT6239 MT6235 MT6235B MT6236 MT6236B MT6268T MT6268H MT6268A MT6268 
      ifeq ($(filter $(strip $(PLATFORM)) ,$(I2S_INPUT_SUPPORT_PLATFORM)),)
         $(warning ERROR: PLATFORM $(strip $(PLATFORM)) does not support I2S_INPUT_SUPPORT_PLATFORM.)
         DEPENDENCY_CONFLICT = TRUE
      endif
      ifdef DAF_ENCODE
...
ifdef DAF_ENCODE
   ifeq ($(strip $(DAF_ENCODE)),TRUE)
      ...
      ifndef CUST_CODE
         $(call DEP_ERR_ONA_OR_OFFB,CUST_CODE,DAF_ENCODE)
         DEPENDENCY_CONFLICT = TRUE
      endif
...
ifdef FINGER_TOUCH_SUPPORT
    ifneq ($(strip $(FINGER_TOUCH_SUPPORT)),NONE)
        ...
        ifeq ($(findstring LISTOPTION,$(strip $(UNIFIED_MESSAGE_ADVANCE_FEATURE))),)
            $(call DEP_ERR_SETA_OR_OFFB,UNIFIED_MESSAGE_ADVANCE_FEATURE,containing LISTOPTION,FINGER_TOUCH_SUPPORT)
            DEPENDENCY_CONFLICT = TRUE
        endif
        ifeq ($(strip $(FINGER_TOUCH_SUPPORT)),FTE)
          ifneq ($(strip $(MEDIA_PLAYER_VER)),INTEGRATED_FTE)
            ifneq ($(strip $(MEDIA_PLAYER_VER)),INTEGRATED_FTE_DB)
              ifneq ($(strip $(MEDIA_PLAYER_VER)),INTEGRATED)
                $(call DEP_ERR_SETA_OR_SETB,MEDIA_PLAYER_VER,INTEGRATED_FTE or INTEGRATED_FTE_DB or INTEGRATED,FINGER_TOUCH_SUPPORT, non FTE)
                DEPENDENCY_CONFLICT = TRUE 
              endif
            endif 
          endif   
...
ifeq ($(strip $(LGE_BT_SYSTEM_SUPPORT)),TRUE)
  ifndef CUST_CODE
     $(call DEP_ERR_ONA_OR_OFFB,CUST_CODE,LGE_BT_SYSTEM_SUPPORT)
     DEPENDENCY_CONFLICT = TRUE
  endif
  ifneq ($(strip $(CUST_CODE)),TC01)
     $(call DEP_ERR_ONA_OR_OFFB,CUST_CODE,LGE_BT_SYSTEM_SUPPORT)
...
ifdef VUI_CUBE_SUPPORT
  ifeq ($(strip $(VUI_CUBE_SUPPORT)),TRUE)
    ifneq ($(strip $(FINGER_TOUCH_SUPPORT)),FTE)
      $(call DEP_ERR_SETA_OR_OFFB,FINGER_TOUCH_SUPPORT,FTE,VUI_CUBE_SUPPORT)
      DEPENDENCY_CONFLICT = TRUE
    endif    
    ifneq ($(strip $(SQLITE3_SUPPORT)),TRUE)
      $(call DEP_ERR_ONA_OR_OFFB,SQLITE3_SUPPORT,VUI_CUBE_SUPPORT)
      DEPENDENCY_CONFLICT = TRUE
    endif
    ifneq ($(strip $(MEDIA_PLAYER_VER)),INTEGRATED_FTE_DB)
      $(call DEP_ERR_SETA_OR_OFFB,MEDIA_PLAYER_VER,INTEGRATED_FTE_DB,VUI_CUBE_SUPPORT)
      DEPENDENCY_CONFLICT = TRUE
    endif
    ifneq ($(strip $(VENUS_MMI)),VENUS_LEVEL1)
      $(call DEP_ERR_SETA_OR_OFFB,VENUS_MMI,VENUS_LEVEL1,VUI_CUBE_SUPPORT)
      DEPENDENCY_CONFLICT = TRUE
    endif      
    COM_DEFS += __VUI_CUBE_SUPPORT__
  endif
endif
...
ifdef AT_COMMAND_SET
  ifeq ($(strip $(AT_COMMAND_SET)),SLIM)
    ifeq ($(strip $(MMI_VERSION)),EMPTY_MMI)
      $(call DEP_ERR_SETA_OR_SETB,MMI_VERSION,not EMPTY_MMI,AT_COMMAND_SET, non SLIM)
      DEPENDENCY_CONFLICT = TRUE
    endif
    ifneq ($(strip $(RSAT_SUPPORT)),NONE)
      $(call DEP_ERR_SETA_OR_SETB,RSAT_SUPPORT,NONE,AT_COMMAND_SET, non SLIM)
      DEPENDENCY_CONFLICT = TRUE
    endif
...
ifdef CONTOUR_IMPROVEMENT_SUPPORT
  ifeq ($(strip $(CONTOUR_IMPROVEMENT_SUPPORT)),TRUE)
    CONTOUR_IMPROVEMENT_PLATFORM = MT6235 MT6235B 
...
ifeq ($(strip $(TC01_AUD_GAIN_TYPE_SUPPORT)),TRUE)
  ifneq ($(strip $(CUST_CODE)),TC01)
     $(call DEP_ERR_SETA_OR_OFFB,CUST_CODE,TC01,TC01_AUD_GAIN_TYPE_SUPPORT)
     DEPENDENCY_CONFLICT = TRUE
  endif
  COM_DEFS += __TC01_AUD_GAIN_TYPE_SUPPORT__
endif
...
ifeq ($(strip $(RESOURCE_MANAGER)),TRUE)
    ifeq ($(filter $(strip $(PLATFORM)),$(RESOURCE_MANAGER_SUPPORT_PLATFORM)),)
      $(error PLATFORM $(strip $(PLATFORM)) does not support RESOURCE_MANAGER)
    endif
...
MPLL_SETTING_FOR_MT6253D_EXT_13M_MCU_13M  = MPLLX1
MPLL_SETTING_FOR_MT6253D_EXT_13M_MCU_26M  = MPLLX2
MPLL_SETTING_FOR_MT6253D_EXT_13M_MCU_39M  = MPLLX3
MPLL_SETTING_FOR_MT6253D_EXT_13M_MCU_52M  = MPLLX4
MPLL_SETTING_FOR_MT6253D_EXT_26M_MCU_26M  = MPLLX1
MPLL_SETTING_FOR_MT6253D_EXT_26M_MCU_52M  = MPLLX2
MPLL_SETTING_FOR_MT6253D_EXT_26M_MCU_104M  = MPLLX4
...
ifdef HAND_WRITING
  ...
  ifeq ($(strip $(HAND_WRITING)),MMI_HANWANG)
    ...
    CUS_REL_OBJ_LIST    += vendor\handwriting\hanwang\v1_official\lib\hw.a \
                           ...
                           vendor\handwriting\hanwang\v1_official\lib\hw.dll \
...
ifeq ($(strip $(PLATFORM)),MT6226)
   ifeq ($(strip $(CHIP_VER)),S02)
      $(warning ERROR: platfrom $(strip $(PLATFORM))Chip version $(strip $(CHIP_VER)) not support MCUROM_SUPPORT.)
      DEPENDENCY_CONFLICT = TRUE
   endif
      ...
      ifeq ($(strip $(PLATFORM)),MT6227D)
         ...
         ifeq ($(strip $(PLATFORM)),MT6226M)
            ...
            ifeq ($(strip $(PLATFORM)),MT6226D)
               ...
               $(warning ERROR: PLATFORM $(strip $(PLATFORM)) not support MCUROM_SUPPORT.)
               DEPENDENCY_CONFLICT = TRUE
            endif
         endif
      endif
...
COMPLIST += che image_codec image_codec16 dsp_ram image_codec_public16
CUS_REL_MTK_COMP += che image_codec dsp_ram image_codec16
...
ifdef BLUETOOTH_SUPPORT
  ...
  ifneq ($(strip $(BLUETOOTH_SUPPORT)),NONE)
    COMPLIST  += btadp btprofiles
    ifdef BTSTACK_SUPPORT
      ifeq ($(strip $(BTSTACK_SUPPORT)),LIB)
        ifneq ($(strip $(CUSTOM_RELEASE)),TRUE)
          ifeq ($(strip $(COMPILER)),RVCT)
            COMPOBJS         += custom\drv\bluetooth\$(strip $(BOARD_VER))\$(strip $(FLAVOR))\btstack_rvct.lib
            CUS_REL_OBJ_LIST += custom\drv\bluetooth\$(strip $(BOARD_VER))\$(strip $(FLAVOR))\btstack_rvct.lib
          else
            COMPOBJS         += custom\drv\bluetooth\$(strip $(BOARD_VER))\$(strip $(FLAVOR))\btstack.lib
            CUS_REL_OBJ_LIST += custom\drv\bluetooth\$(strip $(BOARD_VER))\$(strip $(FLAVOR))\btstack.lib
          endif
        else
          ifeq ($(strip $(COMPILER)),RVCT)
            COMPOBJS         += $(strip $(CUS_MTK_LIB))\btstack_rvct.lib
            CUS_REL_OBJ_LIST += $(strip $(CUS_MTK_LIB))\btstack_rvct.lib
          else
            COMPOBJS         += $(strip $(CUS_MTK_LIB))\btstack.lib
            CUS_REL_OBJ_LIST += $(strip $(CUS_MTK_LIB))\btstack.lib
          endif
        endif
      endif
      ifeq ($(strip $(BTSTACK_SUPPORT)),SOURCE)
        COMPLIST         += btstack
        CUS_REL_MTK_COMP += btstack
      endif
      ifeq ($(strip $(BTSTACK_SUPPORT)),PARTIAL_SOURCE)
        COMPLIST         += btstack
        CUS_REL_MTK_COMP += btstack
      endif
    else
      $(warning ERROR: Please set BTSTACK_SUPPORT when BLUETOOTH_SUPPORT is not NONE)
      DEPENDENCY_CONFLICT = TRUE
    endif
  endif
endif
...
ifdef WIFI_SUPPORT
  ifneq ($(strip $(WIFI_SUPPORT)),NONE)
    ifeq ($(strip $(WNDRV_SUPPORT)),SOURCE)
      ...
      ifneq ($(strip $(CUSTOM_RELEASE)),TRUE)
        ifeq ($(strip $(COMPILER)),RVCT)
          COMPOBJS         += custom\drv\wifi\$(strip $(BOARD_VER))\$(strip $(FLAVOR))\wndrv_rvct.lib
          CUS_REL_OBJ_LIST += custom\drv\wifi\$(strip $(BOARD_VER))\$(strip $(FLAVOR))\wndrv_rvct.lib
        else
        ...
        ifeq ($(strip $(COMPILER)),RVCT)
          COMPOBJS         += $(strip $(CUS_MTK_LIB))\wndrv_rvct.lib
          CUS_REL_OBJ_LIST += $(strip $(CUS_MTK_LIB))\wndrv_rvct.lib
        else
    ...
    ifeq ($(strip $(SUPC_SUPPORT)),SOURCE)
      ...
      ifneq ($(strip $(CUSTOM_RELEASE)),TRUE)
        ifeq ($(strip $(COMPILER)),RVCT)
          COMPOBJS         += custom\drv\wifi\$(strip $(BOARD_VER))\$(strip $(FLAVOR))\supc_rvct.lib
          CUS_REL_OBJ_LIST += custom\drv\wifi\$(strip $(BOARD_VER))\$(strip $(FLAVOR))\supc_rvct.lib
        else
          COMPOBJS         += custom\drv\wifi\$(strip $(BOARD_VER))\$(strip $(FLAVOR))\supc.lib
          CUS_REL_OBJ_LIST += custom\drv\wifi\$(strip $(BOARD_VER))\$(strip $(FLAVOR))\supc.lib
        endif
      else
        ifeq ($(strip $(COMPILER)),RVCT)
          COMPOBJS         += $(strip $(CUS_MTK_LIB))\supc_rvct.lib
          CUS_REL_OBJ_LIST += $(strip $(CUS_MTK_LIB))\supc_rvct.lib
        else          
          COMPOBJS         += $(strip $(CUS_MTK_LIB))\supc.lib
          CUS_REL_OBJ_LIST += $(strip $(CUS_MTK_LIB))\supc.lib
        endif
      endif
    endif
    COMPLIST += dhcp
...
ifdef FONT_RESOURCE
  ifeq ($(strip $(FONT_RESOURCE)),DEMO)
    ...
    ifeq ($(filter $(call Upper,$(strip $(MAIN_LCD_SIZE))),128X128 128X160 176X220 240X320 320X240 240X400 320X480),)
      $(warning ERROR: DEMO font only supports 128X128, 128X160, 176X220, 240X320, 320X240, 240X400 and 320X480 MAIN_LCD_SIZE, for other MAIN_LCD_SIZE, please set FONT_RESOURCE=OFFICIAL)
      DEPENDENCY_CONFLICT = TRUE
    endif
    ifneq ($(strip $(MMIDIR)),lcmmi)
...
ifdef INPUT_METHOD
  ifneq ($(strip $(INPUT_METHOD)),NONE)
    ifneq ($(strip $(INPUT_METHOD)),MMI_CSTAR_V2_DEMO)
      ifneq ($(strip $(CUSTOM_RELEASE)),TRUE)
        ifeq ($(strip $(EMPTY_RESOURCE)),TRUE)
          $(warning ERROR: Please set INPUT_METHOD to be MMI_CSTAR_V2_DEMO or NONE in customer projects)
          DEPENDENCY_CONFLICT = TRUE
        endif
      endif
    endif
...
# CSTAR Demo version
  ...
  ifeq ($(strip $(INPUT_METHOD)),MMI_T9_V7)
    $(warning ERROR: INPUT_METHOD MMI_T9_V7 is phased out. Please change INPUT_METHOD value)
    DEPENDENCY_CONFLICT = TRUE
  endif
 ...
 ifeq ($(strip $(COMPILER)),ADS)
  BARCODE_DECODER_SUPPORT_MAIN_LCD_SIZE = 176X220 240X320 320X240 240X400 320X480
    ifeq ($(strip $(BARCODE_DECODER)),MMI_ONLY)
      ifeq ($(strip $(FINGER_TOUCH_SUPPORT)),FTE)
        $(warning ERROR: BARCODE_DECODER do not support FTE)
        DEPENDENCY_CONFLICT = TRUE
      endif
      ...
      ifneq ($(strip $(BARCODE_DECODER)),NONE)
        ifneq ($(filter $(strip $(call Upper,$(MAIN_LCD_SIZE))),$(BARCODE_DECODER_SUPPORT_MAIN_LCD_SIZE)),)
          ...
          $(warning ERROR: BARCODE_DECODER do not support MAIN_LCD_SIZE = $(strip $(MAIN_LCD_SIZE)))
          DEPENDENCY_CONFLICT = TRUE
        endif
        ifeq ($(strip $(FINGER_TOUCH_SUPPORT)),FTE)
          $(warning ERROR: BARCODE_DECODER do not support FTE)
...
ifdef SYNCML_SUPPORT
  ifneq ($(strip $(SYNCML_SUPPORT)),FALSE)
    ifeq ($(strip $(BROWSER_SUPPORT)),NONE)
      $(call DEP_ERR_ONA_OR_OFFB,BROWSER_SUPPORT,SYNCML_SUPPORT)
      DEPENDENCY_CONFLICT = TRUE
    endif
    ifneq ($(strip $(HTTP_INTERFACE_SUPPORT)),TRUE)
...
ifdef UNIFIED_MESSAGE_ADVANCE_FEATURE
  ifneq ($(findstring COMPOSER,$(strip $(UNIFIED_MESSAGE_ADVANCE_FEATURE))),)
    ifneq ($(strip $(MMS_SUPPORT)),OBIGO_Q03C_MMS_V02)
      $(call DEP_ERR_SETA_OR_OFFB,MMS_SUPPORT,OBIGO_Q03C_MMS_V02,COMPOSER in UNIFIED_MESSAGE_ADVANCE_FEATURE)
      DEPENDENCY_CONFLICT = TRUE
    endif
...
SYNC_LCM_HW_SUPPORT_PLATFORM = MT6235 MT6235B MT6236 MT6236B MT6238 MT6239 MT6268 MT6253T MT6253 MT6253D MT6516 
...
L1CACHEABLE_SUPPORT_PLATFORM = MT6228 MT6229 MT6230 MT6268T MT6268H TK6516 MT6225 MT6253T MT6253 MT6253D 
...
# SIM_NEW_ARCH must be TRUE
ifneq ($(strip $(SIM_NEW_ARCH)),TRUE)
  $(warning ERROR: SIM_NEW_ARCH must be TRUE)
  DEPENDENCY_CONFLICT = TRUE
endif
...
ifneq ($(filter __VIDEO_ARCHI_V2__,$(strip $(COM_DEFS))),)
    ...
    COMMINCDIRS += media\video_v2\renderer\include
...
MEMORY_DEVICE_LST = $(strip $(FIXPATH))\tools\MemoryDeviceList\MemoryDeviceList_Since09BW1004.xls
...
ifneq ($(strip $(NAND_FLASH_BOOTING)),NONE)
  ...
  ifdef SECURE_SUPPORT
    ifeq ($(strip $(SECURE_SUPPORT)),TRUE)
      BOOTLOADER_SUPPORT_SECURE_NOR_PLATFORM = MT6253 MT6253D MT6236%
  ...
  BOOTLOADER_SUPPORT_NOR_PLATFORM = MT6235% MT6236% MT6238 MT6239 MT6253 MT6225
...
8_BIT_ENCRYPTION_PLATFORM = MT6268 MT6516 MT6253 MT6253D MT6236
...
CLEANROOM_COMP = j2me_11 j2me_hi sb51 sbpki2 sslplus5 bsci btstack wndrv supc
...
CREL_COMP_NOT_COMPLIST := $(filter-out btstack,$(CREL_COMP_NOT_COMPLIST))
