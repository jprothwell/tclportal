          ...
          void *update_screen_handle, gdi_handle display_layer)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    wgui_status_icon_bar_register_venus_update_callback(update_screen_callback, update_screen_handle);
...
void vadp_v2p_status_icon_bar_register_pen_event(S32 icon_id, FuncPtr handler)
{
    ...
    wgui_status_icon_bar_register_pen_event_handler(icon_id,  WGUI_STATUS_ICON_BAR_PEN_SELECT_ICON, handler);
#endif
}
...
MMI_BOOL vadp_v2p_status_icon_bar_execute_pen_event_handler(S32 icon_id)
{
    ...
    /*----------------------------------------------------------------*/
#ifdef __MMI_TOUCH_SCREEN__
    result = wgui_status_icon_bar_execute_pen_event_handler(icon_id, WGUI_STATUS_ICON_BAR_PEN_SELECT_ICON);
#endif
	return result;
}
            ...
            S32 *icon_id)
{
   ...
   //kal_prompt_trace(MOD_IDLE,"ltz.......vadp_v2p_status_icon_bar_translate_pen_event.....pen_event:%d..",pen_event);
    ...
    result = wgui_status_icon_bar_translate_pen_event(
