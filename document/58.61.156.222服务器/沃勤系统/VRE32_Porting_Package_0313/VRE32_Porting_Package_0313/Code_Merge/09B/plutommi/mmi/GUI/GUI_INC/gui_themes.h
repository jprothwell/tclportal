...
/* Vogins Start */
#ifdef __VRE30_AM__
    extern CONST_HARDWARE color UI_COLOR_BLUE;
#endif
/* Vogins End */
    /* System UI fillers */
    ...
    extern UI_header_information_text_theme MMI_header_information_text_theme;
    ...
    typedef struct _UI_theme
    {
        ...
        UI_header_information_text_theme *header_information_text_theme;
    } UI_theme;
	...
	extern void set_MMI_header_information_text_theme(MMI_theme *t);
