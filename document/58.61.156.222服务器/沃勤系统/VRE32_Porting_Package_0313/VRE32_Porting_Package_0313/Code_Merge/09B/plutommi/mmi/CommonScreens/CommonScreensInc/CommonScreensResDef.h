...
extern "C"
{
    ...
    typedef enum
    {
        SCR_POPUP_SCREEN = COMMON_SCREENS_BASE,
        SCR_POPUP_SCREEN_1,
        SCR_CONFIRM_SCREEN,
        ...
        /*
         * Because screen id parser can't parse the screen id that defined by offest and it cuases screen id problem in database,
         * we move this kind of screen id to the end of screen structure. 
         * refer "FAQ_FRM_FRAMEWORK_LAYER_Latest.doc", section "Screen Id naming need to follow coding convention"
         */
...
/* This part should be moved in feature file */
...
#if defined(__MMI_EDITOR_OPTION_MENU_STYLE_3__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__)
...
#if defined(__MMI_EDITOR_OPTION_MENU_STYLE_3__) &&  defined(__MMI_IME_FTE_ENHANCE__)
...
#if defined(__MMI_IME_AUTO_CAPITALIZATION_SETTING__)  || defined(__MMI_IME_AUTO_COMPLETION_SETTING__) || defined(__MMI_IME_ALPHABETIC_PREDICTION_SETTING__) || defined(__MMI_IME_PHONETIC_PREDICTION_SETTING__)
...
typedef enum
{
    ...
    COMMONSCREENS_IME_ADVANCEDOPTIONS_AUTOCAPITALIZATION,
#endif
#if defined(__MMI_IME_AUTO_COMPLETION_SETTING__)
    COMMONSCREENS_IME_ADVANCEDOPTIONS_AUTOCOMPLETION,
#endif
#if defined(__MMI_IME_ALPHABETIC_PREDICTION_SETTING__)
    COMMONSCREENS_IME_ADVANCEDOPTIONS_ALPHABETICPREDICTION,
#endif
#if  defined(__MMI_IME_PHONETIC_PREDICTION_SETTING__)
    COMMONSCREENS_IME_ADVANCEDOPTIONS_CHINESEPREDICTION,
#endif
...
typedef enum
{
    ...
    COMMONSCREENS_IME_WRITINGLANGUAGE,
#endif
#if defined (__MMI_IME_INPUT_PATTERN_SETTING__)
    COMMONSCREENS_IME_KEYBOARDTYPE,
#endif
    ...
    COMMONSCREENS_IME_NEWWORD,
#endif
#endif
#if defined(__MMI_IME_INPUT_ADVANCED_SETTING__)
    COMMONSCREENS_IME_ADVANCEDOPTIONS,
#endif
...
typedef enum
{
    ...
    COMMONSCREENS_KEYPAD_ALPHANUMERIC,
#endif
    ...
    typedef enum
    {
        ...
        STR_WRITING_LANGUAGE_MAIN,
        STR_WRITING_LANGUAGE_SUB,
        STR_INPUT_METHOD_PREFERED_MODES,
        STR_INPUT_METHOD_ADVANCED_OPTIONS,		
        STR_INPUT_METHOD_KEYBOARD_TYPE,
        STR_INPUT_METHOD_AUTO_CAPITALIZATION,
	STR_INPUT_METHOD_AUTO_COMPLETION,
	STR_INPUT_METHOD_CHINESE_PREDICTION,                           
	STR_INPUT_METHOD_ALPHABETIC_PREDICTION,
	STR_INPUT_METHOD_ALPHANUMERIC,
	STR_INPUT_METHOD_HANDWRITING,
	STR_INPUT_METHOD_KEYPAD,
