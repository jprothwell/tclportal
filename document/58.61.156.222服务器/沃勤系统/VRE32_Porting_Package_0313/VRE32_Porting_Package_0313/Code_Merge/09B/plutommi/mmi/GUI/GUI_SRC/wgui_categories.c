...
extern MMI_BOOL g_wgui_cat53_created;
...
void ExitListCategoryScreen(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    g_wgui_cat53_created = MMI_FALSE; /* temp solution for MAUI_01886810 */
 ...
 *  change_cat105_image
 * DESCRIPTION
 *  change category 105 image
 * PARAMETERS
 *  img     [IN]        Image to change
 * RETURNS
 *  void
 *****************************************************************************/
static void change_cat105_image(PU8 img)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
#if defined(__MMI_VIRTUAL_KEYBOARD__)
    wgui_virtual_keyboard_register_hide_cursor_callback(wgui_cat_stop_pop_up_description_scroll);
    wgui_virtual_keyboard_register_blink_cursor_callback(wgui_dynamic_list_show_icontext_menu);
#endif
