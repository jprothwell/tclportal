...
#define NVRAM_LID_COMMAPP_BEGIN     NVRAM_EF_LAST_LID_CORE
    ...
    extern kal_uint32 shadow_buffer_size;
    extern kal_uint16 shadow_item_total;
    extern nvram_lid_enum dirty_list[];
 ...
 */
    typedef enum
    {
        ...
        NVRAM_EF_SMS_LID,                   /* __MMI_MESSAGES_TEMPLATE__ */
        ...
        NVRAM_EF_CHAT_ROOM_INFO_LID,        /* __MMI_MESSAGES_CHAT__ */
        ...
        NVRAM_EF_CSD_PROFILE_LID,           /* __TCPIP__ */
	...
	/* 6238 camera */
		...
		NVRAM_EF_SMS_VOICEMAIL_TIME_LID,        /* __MMI_OP11_HOMESCREEN__ */
...
#define NVRAM_SMS_EMAIL_RECORD_SIZE 22
...
#define NVRAM_CALL_TIME_RECORD_TOTAL      (3 * NVRAM_DUAL_RECORD)
#ifdef __TCPIP__
/**
 * CSD profile
 */
...
#define NVRAM_EF_CSD_PROFILE_SIZE               212    
#else 
#define NVRAM_EF_CSD_PROFILE_SIZE               182    
#endif 
...
#define	NVRAM_EF_VRE_PAY_CHANNEL_A_LIST_EXT_SIZE		392
#define	NVRAM_EF_VRE_PAY_CHANNEL_A_LIST_EXT_TOTAL		2
...
#define	NVRAM_EF_VRE_OPERATOR_CODE_234_EXT_SIZE 776
#define	NVRAM_EF_VRE_OPERATOR_CODE_234_EXT_TOTAL 1

#define NVRAM_EF_VRE_LOCAL_APN_INFO_EXT_SIZE 528
#define NVRAM_EF_VRE_LOCAL_APN_INFO_EXT_TOTAL 1

#define NVRAM_EF_VRE_PAY_NOTIFICATION_EXT_SIZE 1376
#define NVRAM_EF_VRE_PAY_NOTIFICATION_EXT_TOTAL 1

#define NVRAM_EF_VRE_PAYCHANNEL_USAGE_EXT_SZIE 904
#define	NVRAM_EF_VRE_PAYCHANNEL_USAGE_EXT_TOTAL 1

#define NVRAM_EF_VRE_CHARGE_DETAIL_LIST_EXT_EXT_SIZE 1160
#define NVRAM_EF_VRE_CHARGE_DETAIL_LIST_EXT_EXT_TOTAL  1

#define NVRAM_EF_VRE_PAY_CONFIG_EXT_EXT_SIZE 48
#define NVRAM_EF_VRE_PAY_CONFIG_EXT_EXT_TOTAL 1

#define NVRAM_EF_VRE_USER_APN_INFO_SIZE 200
#define	NVRAM_EF_VRE_USER_APN_INFO_TOTAL 1
...
#define NVRAM_EF_AM_PROMPT_SIZE	sizeof(nvram_am_prompt_struct)
#define NVRAM_EF_AM_PROMPT_TOTAL 1
#endif
/* Vogins End */
/**
...
#define NVRAM_EF_ABM_GPRS_PROFILE_SIZE             260
 ...
 * TCM PDP profile
 */
#define NVRAM_EF_TCM_PDP_PROFILE_SIZE          230 //erica 20070112
...
#define NVRAM_EF_BTRADIO_MT6611_TOTAL		 1
   ...
   #define NVRAM_EF_BTRADIO_MT6611_SIZE       46
     ...
     * Black list
     */
#define NVRAM_EF_BLACK_LIST_SIZE    44*5
...
#define NVRAM_PROFILES_RECORD_SIZE     462 //406
...
#define NVRAM_EF_CUST_HW_LEVEL_TBL_TOTAL   1
    ...
    /* OBIGOQO5 */
#define NVRAM_UMMS_COMPOSE_SETTINGS_SIZE		876
...
#define	NVRAM_EF_BRW_USER_DEFINED_HOMEPAGE_SIZE		1024
 ...
 *	byte 7- last anchors
 */
#define NVRAM_EF_SYNCML_APP_NUM 4
#define NVRAM_EF_SYNCML_SETTING_SIZE     (((MAX_SYNCML_SV_PROFILES + MAX_SYNCML_PC_PROFILES) * NVRAM_EF_SYNCML_APP_NUM * 4) + 7)

#define NVRAM_EF_SYNCML_SETTING_TOTAL    1
#define NVRAM_EF_SYNCML_PROFILE_SIZE     sizeof(nvram_ef_syncml_profile_struct)
#define NVRAM_EF_SYNCML_PROFILE_TOTAL    (MAX_SYNCML_SV_PROFILES + MAX_SYNCML_PC_PROFILES) /* 4 */
...
#define VOIP_URI_LEN                        (65) /* Length of URI in bytes +	Null terminate */
#define VOIP_USERNAME_LEN                   (65) /* Length of username in bytes + Null terminate */
...
#define NVRAM_EF_VOIP_PROF_SIZE			780
...
#define NVRAM_EF_RAC_PREFERENCE_SIZE         6 /* 4+2 (3g band) */
...
#define NVRAM_BGSR_MSG_STRUCT_SIZE      28
 ...
 * GIS & GIS
 */
#define NVRAM_EF_GIS_GPS_SETTING_DATA_TOTAL       1
#define NVRAM_EF_GIS_GPS_SETTING_DATA_SIZE       92

#define NVRAM_EF_TIME_SYNC_SETTING_TOTAL  1
#define NVRAM_EF_TIME_SYNC_SETTING_SIZE   1
#endif
...
#define NVRAM_EF_AGPS_PROFILE_TOTAL       5
...
#define NVRAM_EF_CAMCO_SETTING_TOTAL 1
#define NVRAM_EF_CAMCO_SETTING_SIZE  (sizeof(nvram_ef_camco_setting_struct))

#define NVRAM_EF_CAMCO_SETTING_SCENE_SEL_TOTAL 1
#define NVRAM_EF_CAMCO_SETTING_SCENE_SEL_SIZE  (sizeof(nvram_ef_camco_setting_scene_sel_struct))
#endif /* __MMI_CAMCORDER__ */


#ifdef __MMI_AUDPLY_MULTIPLE_LIST__
#define NVRAM_EF_AUDPLY_LIST_PLAYLIST_PATH_SIZE  522
