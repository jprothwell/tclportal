...
#define MDI_AUD_VOL_EX(x)       ((x) | 0x80)  /* 16 Level*/
#define MDI_AUD_VOL_EX_MUTE(x)  ((x) | 0x40)  /* Level 0 is mute, the volume level is total 8 or 17 */
...
#define MDI_TTS_VALUE_CODEPAGE_GBK             936   /* GBK (default) */
#define MDI_TTS_VALUE_CODEPAGE_BIG5            950   /* Big5 */
#define MDI_TTS_VALUE_CODEPAGE_UTF16LE         1200  /* UTF-16 little-endian */
#define MDI_TTS_VALUE_CODEPAGE_UTF16BE         1201  /* UTF-16 big-endian */
