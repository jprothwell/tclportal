...
//FOR TWO DIMENTION MAIN MENU STYLE
	...
	U16 avzone_menu_item_count = 0, et_menu_item_count = 0;
	...
	void PopulateMainMenuRes(void)
	{
        ...
        ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MAIN_MENU_PHONEBOOK_NO_SIM_MENUID, highlight_mainmenu_phonebook);
        ...
        ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MAIN_MENU_SETTINGS_NO_SIM_MENUID, highlight_mainmenu_settings);    /* diamond, 2005/12/23 Phone setup in option menu */
#ifdef __MMI_MESSAGES_CLUB__
        ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MAIN_MENU_MSGCLUB_MENUID, highlight_mainmenu_msgclub);
#endif 
...
#else /* __MMI_UCM__ */
        ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MAIN_MENU_CALL_HISTORY, highlight_mainmenu_callhistory);
#endif /* __MMI_UCM__ */
...
/* under construction !*/
        ...
        ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MAIN_MENU_OPTION_AVZONE_MENUID, highlight_mainmenu_avzone);
#endif 
...
/* under construction !*/
		...
		/* Entertainment */
#ifdef __MMI_MESSAGES_CLUB__
        et_menu_item_count = 5;
#if defined(__MMI_MAINLCD_240X400__)
#if defined(__MMI_BT_SUPPORT__)
        et_menu_item_count ++;
#endif
#endif
		ADD_APPLICATION_MENUITEM((MAIN_MENU_ENTERTAINMENT_MENU_ID,IDLE_SCREEN_MENU_ID,et_menu_item_count,
		...
		/* System */
#ifndef __DISABLE_SHORTCUTS_MENU__
		ADD_APPLICATION_MENUITEM2((MAIN_MENU_SYSTEM_MENU_ID,IDLE_SCREEN_MENU_ID,
...
//BUG MULTIMEDIA END 20050902
	...
	ADD_APPLICATION_MENUITEM2((MAIN_MENU_OPTION_AVZONE_MENUID,MENU_SIM_OPTION_ID,

        #if defined (__MMI_CAMCORDER__)  
            MAIN_MENU_OPTION_CAMCORDER_APP,
        #endif
    ...
    #if defined(__MMI_MAINLCD_240X400__)
        #if defined(__MMI_IMAGE_VIEWER__)
            MAIN_MENU_OPTION_IMGVIEW_APP,
        #endif	
        #if defined(__MMI_SOUND_RECORDER__) 
            MAIN_MENU_OPTION_SNDREC_APP,
        #endif
    #endif
	...
	/* extra */
		ADD_APPLICATION_MENUITEM((MAIN_MENU_EXTRA_MENUID,MAIN_MENU_ENTERTAINMENT_MENU_ID,
                #if !defined(__MMI_MAINLCD_240X400__)
                    EXTRA_ENUM_TOTAL,
                #else
                #if defined(__MMI_BT_SUPPORT__)
...
/* Images */
		ADD_APPLICATION_IMAGE2(MAIN_MENU_AVZONE_ICON, CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\BI_DEGREE\\\\MM_AV" __MMI_RES_TYPE_MAINMENU_BIDEGREE__, "Icon used for avzone in mainmenu");
		ADD_APPLICATION_IMAGE2(MAIN_MENU_PIM_ICON, CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\BI_DEGREE\\\\MM_PI" __MMI_RES_TYPE_MAINMENU_BIDEGREE__, "Icon used for pim in mainmenu");
		ADD_APPLICATION_IMAGE2(MAIN_MENU_ENTERTAINMENT_ICON, CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\BI_DEGREE\\\\MM_EN" __MMI_RES_TYPE_MAINMENU_BIDEGREE__, "Icon used for entertainment in mainmenu");
		ADD_APPLICATION_IMAGE2(MAIN_MENU_SYSTEM_ICON, CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\BI_DEGREE\\\\MM_SY" __MMI_RES_TYPE_MAINMENU_BIDEGREE__, "Icon used for system in mainmenu");

		ADD_APPLICATION_IMAGE2(MAIN_MENU_AVZONE_ICON_SELECTED, CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\BI_DEGREE\\\\MM_AV_H" __MMI_RES_TYPE_MAINMENU_BIDEGREE_ANI__, "Icon used for avzone in mainmenu");
		ADD_APPLICATION_IMAGE2(MAIN_MENU_PIM_ICON_SELECTED, CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\BI_DEGREE\\\\MM_PI_H" __MMI_RES_TYPE_MAINMENU_BIDEGREE_ANI__, "Icon used for pim in mainmenu");
		ADD_APPLICATION_IMAGE2(MAIN_MENU_ENTERTAINMENT_ICON_SELECTED, CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\BI_DEGREE\\\\MM_EN_H" __MMI_RES_TYPE_MAINMENU_BIDEGREE_ANI__, "Icon used for entertainment in mainmenu");
		ADD_APPLICATION_IMAGE2(MAIN_MENU_SYSTEM_ICON_SELECTED, CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\BI_DEGREE\\\\MM_SY_H" __MMI_RES_TYPE_MAINMENU_BIDEGREE_ANI__, "Icon used for system in mainmenu");    

#if defined(__MMI_MAINLCD_240X400__)
        ADD_APPLICATION_IMAGE(MAIN_MENU_PHONEBOOK_ICON,	CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\BI_DEGREE\\\\MM_PB.png");
        ADD_APPLICATION_IMAGE(MAIN_MENU_MESSAGES_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\BI_DEGREE\\\\MM_MG.png");
        ADD_APPLICATION_IMAGE(MAIN_MENU_CALL_HISTORY_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\BI_DEGREE\\\\MM_CA.png");
        ADD_APPLICATION_IMAGE(MAIN_MENU_SETTINGS_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\BI_DEGREE\\\\MM_ST.png");
        ADD_APPLICATION_IMAGE(MAIN_MENU_MULTIMEDIA_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\BI_DEGREE\\\\MM_MM.png");
        ADD_APPLICATION_IMAGE(MAIN_MENU_FILEMNGR_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\BI_DEGREE\\\\MM_FM.png");
        ADD_APPLICATION_IMAGE(MAIN_MENU_FUNANDGAMES_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\BI_DEGREE\\\\MM_FG.png");
        ADD_APPLICATION_IMAGE(MAIN_MENU_PROFILES_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\BI_DEGREE\\\\MM_PR.png");
        ADD_APPLICATION_IMAGE(MAIN_MENU_ORGANIZER_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\BI_DEGREE\\\\MM_OR.png");
        ADD_APPLICATION_IMAGE(MAIN_MENU_SERVICES_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\BI_DEGREE\\\\MM_SV.png");
        ...
        ADD_APPLICATION_IMAGE(MAIN_MENU_CAMERA_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\BI_DEGREE\\\\MM_CM.png");
        ADD_APPLICATION_IMAGE(MAIN_MENU_VDOREC_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\BI_DEGREE\\\\MM_VR.png");
        ADD_APPLICATION_IMAGE(MAIN_MENU_VDOPLY_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\BI_DEGREE\\\\MM_VP.png");
		ADD_APPLICATION_IMAGE(MAIN_MENU_AUDPLY_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\BI_DEGREE\\\\MM_AP.png");
        ADD_APPLICATION_IMAGE2(MAIN_MENU_IMGVIEW_ICON, CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\BI_DEGREE\\\\MM_IV.png", "ImageViewer icon" );
        ADD_APPLICATION_IMAGE2(MAIN_MENU_SNDREC_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\BI_DEGREE\\\\MM_SR.png"	,"Sound Recorder icon");	
        ADD_APPLICATION_IMAGE2(MAIN_MENU_BT_ICON, CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\BI_DEGREE\\\\MM_BL.png","Bluetooth menu icon");        
        ADD_APPLICATION_IMAGE2(MAIN_MENU_CAMCO_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\BI_DEGREE\\\\MM_CM.png", "Camcorder menu icon");
#else
		...
		ADD_APPLICATION_IMAGE(MAIN_MENU_CAMCO_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\BI_DEGREE\\\\MM_CM.gif");
#endif
        ...
        ADD_APPLICATION_IMAGE(MAIN_MENU_TITLE_IMGVIEW_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\TitleBar\\\\TB_MM.PBM");
        ADD_APPLICATION_IMAGE(MAIN_MENU_TITLE_SNDREC_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\TitleBar\\\\TB_MM.PBM");
        ADD_APPLICATION_IMAGE(MAIN_MENU_TITLE_BT_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\TitleBar\\\\TB_EX.PBM");
        ADD_APPLICATION_IMAGE(MAIN_MENU_TITLE_CAMCO_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\TitleBar\\\\TB_MM.PBM");
...
/* Strings */
        ...
        ADD_APPLICATION_STRING2(MAIN_MENU_CAMCO_TEXT,"Camcorder","String for Camcorder in mainmenu");
		...
		/* images */
		ADD_APPLICATION_IMAGE(MAIN_MENU_TITLE_ICON, CUST_IMG_BASE_PATH"\\\\EmptyImage.bmp");
...
/* Vogins Start */
    ...
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MAIN_MENU_VRE_MENUID, highlight_mainmenu_vre);
#endif
/* Vogins End */
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MAIN_MENU_ORGANIZER_MENUID, highlight_mainmenu_organizer);
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MAIN_MENU_SETTINGS_MENUID, highlight_mainmenu_settings);
...
/* under construction !*/
	...
	ADD_APPLICATION_MENUITEM2((IDLE_SCREEN_MENU_ID,0,
        MAIN_MENU_FILE_MNGR_MENUID,
	    MAIN_MENU_PHONEBOOK_MENUID, 
        MAIN_MENU_FUNANDGAMES_MENUID,        
        MAIN_MENU_EXTRA_MENUID,
...
#if defined(__MMI_FILE_MANAGER__)  
#ifdef __MMI_MAINLCD_320X240__  		
#if (__MMI_MAIN_MENU_TYPE__ == __MATRIX__)
    ADD_APPLICATION_MENUITEM2((IDLE_SCREEN_MENU_ID,0,
        MAIN_MENU_FILE_MNGR_MENUID,
        MAIN_MENU_PHONEBOOK_MENUID, 
    /* Vogins Start */
...
/* Vogins Start */
#ifdef __MMI_VRE_MAIN_MENU__
	ADD_APPLICATION_MENUITEM((MAIN_MENU_VRE_MENUID,IDLE_SCREEN_MENU_ID,0,
		SHOW,MOVEABLEWITHINPARENT,1,STR_VRE_TITLE
		,MAIN_MENU_VRE_ICON));
#endif
/* Vogins End */
...
/* Vogins End */
...
#if defined(__MMI_MAINLCD_240X400__)
    ADD_APPLICATION_IMAGE(MAIN_MENU_CONTROLAREA_PHONEBOOK_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_PB_page" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
    ADD_APPLICATION_IMAGE(MAIN_MENU_CONTROLAREA_MESSAGES_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_MG_page" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
    ADD_APPLICATION_IMAGE(MAIN_MENU_CONTROLAREA_FUNANDGAMES_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_fun_page" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
    ADD_APPLICATION_IMAGE(MAIN_MENU_CONTROLAREA_ORGANIZER_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_OR_page" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
    ADD_APPLICATION_IMAGE(MAIN_MENU_CONTROLAREA_SETTINGS_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_ST_page" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
    ADD_APPLICATION_IMAGE(MAIN_MENU_CONTROLAREA_SHORTCUTS_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_SC_page" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
    ADD_APPLICATION_IMAGE(MAIN_MENU_CONTROLAREA_SERVICES_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_SV_page" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
    ADD_APPLICATION_IMAGE(MAIN_MENU_CONTROLAREA_PROFILES_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_PR_page" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
    ADD_APPLICATION_IMAGE(MAIN_MENU_CONTROLAREA_CALL_HISTORY_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_CA_page" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
    ADD_APPLICATION_IMAGE(MAIN_MENU_CONTROLAREA_MULTIMEDIA_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_MM_page" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
    ADD_APPLICATION_IMAGE(MAIN_MENU_CONTROLAREA_FILE_MNGR_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_FM_page" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
    ADD_APPLICATION_IMAGE(MAIN_MENU_CONTROLAREA_EXTRA_APP_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_EX_page" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
    ADD_APPLICATION_IMAGE(MAIN_MENU_CONTROLAREA_MESSAGE_CLUB_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_EX_page" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
#endif

#ifdef __MMI_MAINMENU_STYLE_CHANGE_EN__
    /* Matrix */
 	#ifdef __MMI_MAINMENU_MATRIX_SUPPORT__
    	ADD_APPLICATION_IMAGE(MAIN_MENU_MATRIX_PHONEBOOK_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_PB" __MMI_RES_TYPE_MAINMENU_MATRIX__);
    	ADD_APPLICATION_IMAGE(MAIN_MENU_MATRIX_MESSAGES_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_MG" __MMI_RES_TYPE_MAINMENU_MATRIX__);
    	ADD_APPLICATION_IMAGE(MAIN_MENU_MATRIX_FUNANDGAMES_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_FG" __MMI_RES_TYPE_MAINMENU_MATRIX__);
    	ADD_APPLICATION_IMAGE(MAIN_MENU_MATRIX_ORGANIZER_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_OR" __MMI_RES_TYPE_MAINMENU_MATRIX__);
    	ADD_APPLICATION_IMAGE(MAIN_MENU_MATRIX_SETTINGS_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_ST" __MMI_RES_TYPE_MAINMENU_MATRIX__);
    	ADD_APPLICATION_IMAGE(MAIN_MENU_MATRIX_SHORTCUTS_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_SC" __MMI_RES_TYPE_MAINMENU_MATRIX__);
    	ADD_APPLICATION_IMAGE(MAIN_MENU_MATRIX_SERVICES_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_SV" __MMI_RES_TYPE_MAINMENU_MATRIX__);
    	ADD_APPLICATION_IMAGE(MAIN_MENU_MATRIX_PROFILES_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_PR" __MMI_RES_TYPE_MAINMENU_MATRIX__);
    	ADD_APPLICATION_IMAGE(MAIN_MENU_MATRIX_CALL_HISTORY_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_CA" __MMI_RES_TYPE_MAINMENU_MATRIX__);
    	ADD_APPLICATION_IMAGE(MAIN_MENU_MATRIX_MULTIMEDIA_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_MM" __MMI_RES_TYPE_MAINMENU_MATRIX__);
    	ADD_APPLICATION_IMAGE(MAIN_MENU_MATRIX_FILEMNGR_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_FM" __MMI_RES_TYPE_MAINMENU_MATRIX__);
    	ADD_APPLICATION_IMAGE(MAIN_MENU_MATRIX_EXTRA_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_EX" __MMI_RES_TYPE_MAINMENU_MATRIX__);
    
    	ADD_APPLICATION_IMAGE(MAIN_MENU_MATRIX_PHONEBOOK_ANIMATION,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_PB_ANI" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
    	ADD_APPLICATION_IMAGE(MAIN_MENU_MATRIX_MESSAGES_ANIMATION,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_MG_ANI" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
    	ADD_APPLICATION_IMAGE(MAIN_MENU_MATRIX_FUNANDGAMES_ANIMATION,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_FG_ANI" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
    	ADD_APPLICATION_IMAGE(MAIN_MENU_MATRIX_ORGANIZER_ANIMATION,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_OR_ANI" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
    	ADD_APPLICATION_IMAGE(MAIN_MENU_MATRIX_SETTINGS_ANIMATION,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_ST_ANI" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
    	ADD_APPLICATION_IMAGE(MAIN_MENU_MATRIX_SHORTCUTS_ANIMATION,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_SC_ANI" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
    	ADD_APPLICATION_IMAGE(MAIN_MENU_MATRIX_SERVICES_ANIMATION,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_SV_ANI" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
    	ADD_APPLICATION_IMAGE(MAIN_MENU_MATRIX_PROFILES_ANIMATION,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_PR_ANI" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
    	ADD_APPLICATION_IMAGE(MAIN_MENU_MATRIX_CALL_HISTORY_ANIMATION,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_CA_ANI" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
    	ADD_APPLICATION_IMAGE(MAIN_MENU_MATRIX_MULTIMEDIA_ANIMATION,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_MM_ANI" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
    	ADD_APPLICATION_IMAGE(MAIN_MENU_MATRIX_FILEMNGR_ANIMATION,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_FM_ANI" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
    	ADD_APPLICATION_IMAGE(MAIN_MENU_MATRIX_EXTRA_ANIMATION,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_EX_ANI" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
    /* Vogins Start */
    #ifdef __MMI_VRE_MAIN_MENU__
        ADD_APPLICATION_IMAGE(MAIN_MENU_MATRIX_VRE_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_VRE" __MMI_RES_TYPE_MAINMENU_MATRIX__);
        ADD_APPLICATION_IMAGE(MAIN_MENU_MATRIX_VRE_ANIMATION,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\MATRIX\\\\MM_VRE_ANI" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
    #endif
    /* Vogins End */
	...
	ADD_APPLICATION_IMAGE(MAIN_MENU_FILEMNGR_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\"IMG_DIR(__MMI_MAINMENU_TYPE__)"\\\\MM_FM" __MMI_RES_TYPE_MAINMENU_MATRIX__);
	ADD_APPLICATION_IMAGE(MAIN_MENU_EXTRA_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\"IMG_DIR(__MMI_MAINMENU_TYPE__)"\\\\MM_EX" __MMI_RES_TYPE_MAINMENU_MATRIX__);

	ADD_APPLICATION_IMAGE(MAIN_MENU_PHONEBOOK_ANIMATION,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\"IMG_DIR(__MMI_MAINMENU_TYPE__)"\\\\MM_PB_ANI" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
	ADD_APPLICATION_IMAGE(MAIN_MENU_MESSAGES_ANIMATION,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\"IMG_DIR(__MMI_MAINMENU_TYPE__)"\\\\MM_MG_ANI" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
	ADD_APPLICATION_IMAGE(MAIN_MENU_FUNANDGAMES_ANIMATION,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\"IMG_DIR(__MMI_MAINMENU_TYPE__)"\\\\MM_FG_ANI" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
	ADD_APPLICATION_IMAGE(MAIN_MENU_ORGANIZER_ANIMATION,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\"IMG_DIR(__MMI_MAINMENU_TYPE__)"\\\\MM_OR_ANI" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
	ADD_APPLICATION_IMAGE(MAIN_MENU_SETTINGS_ANIMATION,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\"IMG_DIR(__MMI_MAINMENU_TYPE__)"\\\\MM_ST_ANI" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
	ADD_APPLICATION_IMAGE(MAIN_MENU_SHORTCUTS_ANIMATION,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\"IMG_DIR(__MMI_MAINMENU_TYPE__)"\\\\MM_SC_ANI" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
	ADD_APPLICATION_IMAGE(MAIN_MENU_SERVICES_ANIMATION,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\"IMG_DIR(__MMI_MAINMENU_TYPE__)"\\\\MM_SV_ANI" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
	ADD_APPLICATION_IMAGE(MAIN_MENU_PROFILES_ANIMATION,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\"IMG_DIR(__MMI_MAINMENU_TYPE__)"\\\\MM_PR_ANI" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
	ADD_APPLICATION_IMAGE(MAIN_MENU_CALL_HISTORY_ANIMATION,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\"IMG_DIR(__MMI_MAINMENU_TYPE__)"\\\\MM_CA_ANI" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
	ADD_APPLICATION_IMAGE(MAIN_MENU_MULTIMEDIA_ANIMATION,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\"IMG_DIR(__MMI_MAINMENU_TYPE__)"\\\\MM_MM_ANI" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
	ADD_APPLICATION_IMAGE(MAIN_MENU_FILEMNGR_ANIMATION,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\"IMG_DIR(__MMI_MAINMENU_TYPE__)"\\\\MM_FM_ANI" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
	ADD_APPLICATION_IMAGE(MAIN_MENU_EXTRA_ANIMATION,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\"IMG_DIR(__MMI_MAINMENU_TYPE__)"\\\\MM_EX_ANI" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
	/* Vogins Start */
    #ifdef __MMI_VRE_MAIN_MENU__
    ADD_APPLICATION_IMAGE(MAIN_MENU_VRE_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\"IMG_DIR(__MMI_MAINMENU_TYPE__)"\\\\MM_VRE" __MMI_RES_TYPE_MAINMENU_MATRIX__);
    ADD_APPLICATION_IMAGE(MAIN_MENU_VRE_ANIMATION,CUST_IMG_PATH"\\\\MainLCD\\\\MainMenu\\\\"IMG_DIR(__MMI_MAINMENU_TYPE__)"\\\\MM_VRE_ANI" __MMI_RES_TYPE_MAINMENU_MATRIX_ANI__);
    #endif
    /* Vogins End */
...
/* Vogins Start */
#ifdef __MMI_VRE_MAIN_MENU__
    ADD_APPLICATION_IMAGE(MAIN_MENU_TITLE_VRE_ICON,CUST_IMG_PATH"\\\\MainLCD\\\\TitleBar\\\\TB_VRE.pbm");
#endif
/* Vogins End */
