...
#define BT_SCO_CONNECT_TIMEOUT_DURATION 3000 /* Timeout to disconnect duration */
...
/* under construction !*/
            ...
            {
            #ifdef __MMI_DUAL_PROFILE_SUPPORT__
                /* treak EMAIL_TONE as success tone in dual profile case*/
                break;
            #else
...
void stopRequestedTone(ALL_TONE_ENUM playtone)
{
    ...
    switch (playtone)
    {
        ...
        case WARNING_TONE:
        {
            //if (gcurrentprofile.extraTone.warningTone == 1)//kinse: for MAUI_01114718
            //{
            #ifdef __MMI_OP11_PROF_SOUND__
/* under construction !*/
/* under construction !*/
...
void mmi_profiles_bt_enable_sco_connection(U8 app_id)
{
    ...
    {
        /* Connect SCO if the audio path is "forward to BT"*/
        if(mmi_bt_is_aud2hf())
        {
            StartTimer(BT_SCO_ENABLE_CONNECT_DELAY_TIMER, 3000, mmi_profiles_bt_enable_sco_connect_delay_timer_callback);
        }
    }
}
