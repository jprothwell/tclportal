...
/*****************************************************************************
 * FUNCTION
 *  mmi_bootup_get_imsi_value
 * DESCRIPTION
 *  This function returns the IMSI of the specified SIM card.
 * PARAMETERS
 *  sim_interface   : [IN]      The SIM card
 * RETURNS
 *  The IMSI of the SIM card.
 *****************************************************************************/
extern U8* mmi_bootup_get_imsi_value(sim_interface_enum sim_interface);

/*****************************************************************************
 * FUNCTION
 *  mmi_bootup_get_imei_value
 * DESCRIPTION
 *  This function returns the IMEI associated with the specified SIM card.
 * PARAMETERS
 *  sim_interface   : [IN]      The SIM card
 * RETURNS
 *  The IMEI.
 ...
 *  mmi_bootup_get_imsi_value
 * DESCRIPTION
 *  This function returns the IMSI of the SIM card.
 * PARAMETERS
 *  void
 * RETURNS
 *  The IMSI of the SIM card.
 ...
 *  mmi_bootup_get_imei_value
 * DESCRIPTION
 *  This function returns the IMEI.
 * PARAMETERS
 *  void
 * RETURNS
 *  The IMEI.
...
extern void mmi_sim_cancel_pin_lock_poweron_req_hdlr(void);
extern void mmi_sim_cancel_pin_lock(void);
#endif
...
#ifdef __REL5__
extern void NwECCInfoSave(void *);
#endif
...
extern void mmi_bootup_entry_nand_sanity_check(void);
extern void mmi_bootup_shutdown_nand_sanity_check(void);
#endif 
...
extern MMI_BOOL mmi_bootup_is_dualsim_disconnected(void);
...
#ifdef __ENS__
extern void mmi_netset_replace_hplmm_by_ens_acting_hplmn(U8 *ens_acting_hplmn);
#endif

extern void mmi_ecc_prepare_number(U8 *bcd_ecc, U8 *digit_ecc);
extern void mmi_ecc_prepare_identifier(U8 *ecc_identifier, U8 ecc_length, U8 ecc_dcs, U8 *ecc_output);
#ifdef __MMI_DUAL_SIM_MASTER__
extern MMI_BOOL mmi_ecc_is_ecc_number_with_identifier(S8 *eccnumber, S8 *eccname, U8 simInterface);
#else
extern MMI_BOOL mmi_ecc_is_ecc_number_with_identifier(S8 *eccnumber, S8 *eccname);
#endif
