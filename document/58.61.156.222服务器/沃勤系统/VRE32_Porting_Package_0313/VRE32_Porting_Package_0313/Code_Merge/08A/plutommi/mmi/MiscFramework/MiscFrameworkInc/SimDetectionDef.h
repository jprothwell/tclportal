...
#define ENTER_NSP_PENDING           19
#define ENTER_SP_PENDING            20
#define ENTER_CP_PENDING            21
#define ENTER_SIMP_PENDING          22
#define ENTER_NS_SP_PENDING         23
#define ENTER_SIM_C_PENDING         24
#endif
#else
...
#define WELCOME_SCR_TIME                        2000
    ...
    !defined(__MMI_UNIT_CONVERTER__) && !defined(__MMI_EXTENDED_UNIT_CONVERTER__) && \
    !defined(__MMI_CURRENCY_CONVERTER__) && !defined(__MMI_EXTENDED_CURRENCY_CONVERTER__) && \
    !defined(__MMI_BMI__) && !defined(__MMI_MENSTRUAL__) && !defined(__MMI_CALORIE__) && \
    !defined( __MMI_STOPWATCH__) && \
    !defined(__MMI_APHORISM__) && \
    !defined(__MMI_DICTIONARY__) && \
    !defined(__MMI_EBOOK_READER__) && \
    !defined(__MMI_IRDA_SUPPORT__) && \
    !defined(__MMI_BT_SUPPORT__) && \
    !defined(__MMI_LANGLN__) && \
    !defined(__MMI_MAPBAR_GIS__) && !defined(__MMI_SUNAVI_GIS__)
    #define __MMI_SIM_OPTION_MENU_NO_EXTRA__
#endif

#if !defined(__J2ME__) && \
    !defined(__MMI_GAME__) && \
    !defined(__MMI_3D_GAME__) && \
    !defined(__MMI_MOTION_APP__) && \
    !defined (__MMI_THEMES_APPLICATION__) && \
    !defined(__MMI_PICTURE_EDITOR_SUPPORT__) && \
    !defined(__MMI_AVATAR__)
    #define __MMI_SIM_OPTION_MENU_NO_GAME__
#endif

#ifdef __MMI_BI_DEGREE_MAIN_MENU_STYLE__
#if !defined(__MMI_MOBILE_TV_PLAYER__) && \
    !defined(__MMI_IMAGE_VIEWER__) && \
    !defined(__MMI_VIDEO_EDITOR__) && \
    !defined(__MMI_BARCODEREADER__) && \
    !defined(__MMI_PHOTOEDITOR__) && \
    !defined(__MMI_AB_REPEATER__) && \
    !defined(__MMI_SOUND_RECORDER__) && \
    !defined(__MMI_FM_RADIO__) && \
    !defined(__MMI_FM_RADIO_SCHEDULE_REC__) && \
    !(defined(__MMI_RING_COMPOSER__) && defined(__MMI_IMELODY_SUPPORT__)) && \
    !defined(__MMI_VOICE_MEMO__) && \
    !defined(__MMI_VRSD__) && \
    !defined(__MMI_VRSI__) && \
    !defined(__MMI_SLIDESHOW__)
    #define __MMI_SIM_OPTION_MENU_NO_MULTIMEDIA__
#endif
#else /* __MMI_BI_DEGREE_MAIN_MENU_STYLE__ */
#if !defined(__MMI_MOBILE_TV_PLAYER__) && \
    !defined(__MMI_CAMERA__) && \
    !defined(__MMI_IMAGE_VIEWER__) && \
    !defined(__MMI_VIDEO_RECORDER__) && \
    !defined(__MMI_VIDEO_PLAYER__) && \
    !defined(__MMI_VIDEO_EDITOR__) && \
    !defined(__MMI_BARCODEREADER__) && \
    !defined(__MMI_PHOTOEDITOR__) && \
...
typedef struct
{
    ...
    U8 cancel_pin_lock_state;   /* l4c_cancel_lock_poweron_type_enum */
#endif

    /* diamond, 2005/08/15 bootup revise */
    U8  PowerOnMMIStatus;
    U16 PowerOnSIMStatus;
    U8  PowerOnNWStatus;
