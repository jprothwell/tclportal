...
static const mmi_frm_int_event_convert_struct mmi_frm_int_event_convert_table[] = 
{
    ...
    {MSG_ID_WAP_PMG_NEW_MSG_IND,                MMI_FRM_INT_WAP_PMG_NEW_MSG},
    {MSG_ID_WAP_PMG_DLG_PUSH_STORAGE_FULL_IND,  MMI_FRM_INT_WAP_PMG_DLG_PUSH_STORAGE_FULL},
    {MSG_ID_WAP_PMG_REPLACE_IND,                MMI_FRM_INT_WAP_PMG_REPLACE},
    {MSG_ID_WAP_PMG_DLG_SIA_CONFIRM_REQ,        MMI_FRM_INT_WAP_PMG_DLG_SIA_CONFIRM},
    {MSG_ID_WAP_PMG_DLG_UNKNOWN_ADDR_REQ,       MMI_FRM_INT_WAP_PMG_DLG_UNKNOWN_ADDR_REQ},
...
/* Vogins Start */
#ifdef __VRE_V30__
/* avoid protocol conflict multi-register */
int vre_protocolEventHandler = 0;
vreFuncPtr vre_protocolEvent_result;

MMI_BOOL vre_mmi_frm_execute_current_protocol_result(void)
{
	if (NULL != vre_protocolEvent_result)
	{
		return (*vre_protocolEvent_result)();
	}
	return MMI_FALSE;
}
#endif
...
/* Vogins Start */
#ifdef __VRE_V30__
    PsExtPeerFuncPtr currFuncPtr2 = NULL;
    MMI_BOOL ret2 = MMI_FALSE;
#endif
/* Vogins End */
...
/* Vogins Start */
#ifdef __VRE_V30__
                currFuncPtr2 = (PsExtPeerFuncPtr) protocolEventHandler[count].entryFuncPtr2;
#endif
/* Vogins End */
...
/* Vogins Start */
#ifdef __VRE_V30__
                    protocolEventHandler[count].entryFuncPtr2 = protocolEventHandler[count - 1].entryFuncPtr2;
#endif
/* Vogins End */
...
/* Vogins Start */
#ifdef __VRE_V30__
                    protocolEventHandler[count - 1].entryFuncPtr2 = (PsFuncPtr) currFuncPtr2;
#endif
/* Vogins End */
...
#if defined (MMI_EVENT_PROFILING)
    MMI_TRACE(MMI_FW_TRC_G1_FRM, MMI_TM_TRC_EXE_CURR_PROTOCOL_HDLR, count);
    accu_count += count;
#endif /* defined (MMI_EVENT_PROFILING) */ 
...
/* Vogins Start */
#ifdef __VRE_V30__
     if ((currFuncPtr2) && (currFuncPtr2 != currFuncPtr) && (!interrup_result) && (!execute_result))
    {
        (*currFuncPtr2) (MsgStruct, mod_src, peerBuf);
        ret2 = vre_mmi_frm_execute_current_protocol_result();
    }
...
/* Vogins End */
    ...
    MMI_TRACE(MMI_FW_TRC_G6_FRM_DETAIL, MMI_EVENT_TRC_EVENT_PROFILING_MAX, maxProtocolEvent);
...
void mmi_frm_set_protocol_event_handler(PsFuncPtr funcPtr, U16 eventID)
{
    ...
    MMI_TRACE(MMI_FW_TRC_G6_FRM_DETAIL, MMI_FRM_INFO_EVENT_SETPTO_HDLR, eventID, funcPtr, usedProtocolEvent,
               maxProtocolEvent);
...
/* Vogins Start */
			...
			/* avoid protocol conflict multi-register */
            if (1 == vre_protocolEventHandler)
    	    {
	            vre_protocolEventHandler = 0;
	            protocolEventHandler[pos].entryFuncPtr2 = funcPtr;
	        }
	        else
	        {
...
/* Vogins Start */
    	    ...
    	    {
	            vre_protocolEventHandler = 0;
	            protocolEventHandler[pos].entryFuncPtr2 = NULL;
	        }
	        else
	        {
            ...
            if ((NULL == protocolEventHandler[pos].entryFuncPtr) && (NULL == protocolEventHandler[pos].entryFuncPtr2))
            {
...
/* Vogins End */
    ...
    {
        MMI_TRACE(MMI_FW_TRC_G6_FRM_DETAIL, MMI_EVENT_TRC_SET_PROTOCOL_EVENT_HDLR_MAX_1, maxUsedInHistory);
        maxUsedInHistory = maxProtocolEvent;
        MMI_TRACE(MMI_FW_TRC_G6_FRM_DETAIL, MMI_EVENT_TRC_SET_PROTOCOL_EVENT_HDLR_MAX_2, maxUsedInHistory);
    }
...
void mmi_frm_clear_protocol_event_handler(U16 eventID)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    MMI_TRACE(MMI_FW_TRC_G6_FRM_DETAIL, MMI_FRM_INFO_EVENT_CLRPTO_HDLR, eventID);
...
void mmi_frm_clear_all_protocol_event_handler(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    MMI_TRACE(MMI_FW_TRC_G6_FRM_DETAIL, MMI_FRM_INFO_EVENT_CLRALLPTO_HDLR);
...
/* avoid protocol conflict multi-register */
void vre_mmi_frm_set_protocol_event_handler(PsFuncPtr funcPtr, U16 eventID, vreFuncPtr vrePtr)
{
	vre_protocolEventHandler = 1;
	mmi_frm_set_protocol_event_handler(funcPtr, eventID);
	vre_protocolEvent_result = vrePtr;
}

void vre_mmi_frm_clear_protocol_event_handler(U16 eventID)
{
	vre_protocolEventHandler = 1;
    mmi_frm_clear_protocol_event_handler(eventID);
	vre_protocolEvent_result = NULL;
}
#endif
/* Vogins End */
