...
typedef enum {
    ...
    APP_JATAAYU_PROFILE,
	APP_MMI_CERTMAN,
	APP_MMI_WAPURIAGENT,	/* __MMI_URI_AGENT__ */
    /* Added for __MMI_WAP_PROF__  */
    APP_MMI_WAP_PROF,
...
typedef enum 
{
    ...
    RESOURCE_BASE_RANGE(TO_DO_LIST,                 200),
    ...
    RESOURCE_BASE_RANGE(INDICAL,                    500), 
    ...
    RESOURCE_BASE_RANGE(MMI_CERTMAN,		        120),
    /*DCD App*/
    RESOURCE_BASE_RANGE(DCD,                         100),  
/* Vogins Start */
#ifdef __VRE__
...
/* Vogins End */
    ...
    RESOURCE_BASE_RANGE(CONNECT_MANAGE,   100),
    /*GPS*/
    RESOURCE_BASE_RANGE(GPS,                        1000),
    RESOURCE_BASE_RANGE(CAMCORDER,                  1000),
    /* please add new resource base above this line */
//#ifdef __MMI_DUAL_SIM_MASTER__
	RESOURCE_BASE_RANGE(MERCURY,	1000),
	    RESOURCE_BASE_RANGE(SOFTWARE_TRACER,            100),  
//#endif  /* __MMI_DUAL_SIM_MASTER__ */
    RESOURCE_BASE_RANGE(MMI_WAPURIAGENT,            5),  

    /* Added for __MMI_WAP_PROF__  */
    RESOURCE_BASE_RANGE(MMI_WAP_PROF,                        100),
    /* __MMI_WAP_PROF__ ends */
...
#define GPS_BASE                       ((U16) RESOURCE_BASE_GPS)
#define GPS_BASE_MAX                   ((U16) RESOURCE_BASE_GPS_END)
RESOURCE_BASE_TABLE_ITEM(GPS)
...
*****************************************************************************/
#define  INDICAL_BASE							((U16) RESOURCE_BASE_INDICAL)
#define  INDICAL_BASE_MAX              		((U16) RESOURCE_BASE_INDICAL_END)
RESOURCE_BASE_TABLE_ITEM(INDICAL)
...
* GIS
*****************************************************************************/
#define  GIS_BASE				((U16) RESOURCE_BASE_GIS)
#define  GIS_BASE_MAX		       ((U16) RESOURCE_BASE_GIS_END)
RESOURCE_BASE_TABLE_ITEM(GIS)

/****************************************************************************
* Camcorder
*****************************************************************************/
#define  CAMCORDER_BASE				((U16) RESOURCE_BASE_CAMCORDER)
#define  CAMCORDER_BASE_MAX		    ((U16) RESOURCE_BASE_CAMCORDER_END)
RESOURCE_BASE_TABLE_ITEM(CAMCORDER)
...
* DCD
*****************************************************************************/
#define  DCD_BASE		((U16) RESOURCE_BASE_DCD)
#define	DCD_BASE_MAX	((U16) RESOURCE_BASE_DCD_END)
RESOURCE_BASE_TABLE_ITEM(DCD)
/* Vogins Start */
#ifdef __VRE__
/**************************************************************************
* VRE module
*************************************************************************/
#define VRE_BASE                    ((U16) RESOURCE_BASE_APP_VRE)
#define VRE_BASE_MAX               ((U16) RESOURCE_BASE_APP_VRE_END)
...
* AM module
*****************************************************************************/
#define AM_BASE                              ((U16) RESOURCE_BASE_APP_AM)
#define AM_BASE_MAX                          ((U16) RESOURCE_BASE_APP_AM_END)
...
* Software Tracer
*****************************************************************************/
#define  SOFTWARE_TRACER_BASE		((U16) RESOURCE_BASE_SOFTWARE_TRACER)
#define	SOFTWARE_TRACER_BASE_MAX	((U16) RESOURCE_BASE_SOFTWARE_TRACER_END)
RESOURCE_BASE_TABLE_ITEM(SOFTWARE_TRACER)

/****************************************************************************
* Connection Management
*****************************************************************************/
#define CONNECT_MANAGE_BASE                   ((U16) RESOURCE_BASE_CONNECT_MANAGE)
#define CONNECT_MANAGE_BASE_MAX               ((U16) RESOURCE_BASE_CONNECT_MANAGE_END)
RESOURCE_BASE_TABLE_ITEM(CONNECT_MANAGE)

/****************************************************************************
* __MMI_URI_AGENT__
*****************************************************************************/
#define MMI_WAPURIAGENT_BASE                   ((U16) RESOURCE_BASE_MMI_WAPURIAGENT)
#define MMI_WAPURIAGENT_BASE_MAX               ((U16) RESOURCE_BASE_MMI_WAPURIAGENT_END)
RESOURCE_BASE_TABLE_ITEM(MMI_WAPURIAGENT)

/****************************************************************************
* WAP PROF module
*****************************************************************************/
/* APP_MMI_WAP_PROF */
#define MMI_WAP_PROF_BASE                ((U16) RESOURCE_BASE_MMI_WAP_PROF)
#define MMI_WAP_PROF_BASE_MAX            ((U16) RESOURCE_BASE_MMI_WAP_PROF_END)
RESOURCE_BASE_TABLE_ITEM(MMI_WAP_PROF) 
