...
/* under construction !*/
    ...
    RES_PRINT_INFO("Populating BPP Resource\n");
#endif
...
#if defined(__FOTA_ENABLE__)
    RES_PRINT_INFO("Populating Device Management Resources\n");
    PopulateDMMenuRes();
#endif /* __FOTA_ENABLE__ */ 
...
static void PopulateFOTAImage(char* filename_in, char* output_array)
{
    ...
    if (ret == 0)
    {
        fprintf(stderr, "[FOTA] %s BMPLoader failed !!\n", filename_in);
        return ;
    }
    ...
    if (fp_temp == NULL)
    {
        fprintf(stderr, "[FOTA] %s Read raw data file failed !!\n", filename_in);
        return ;
    }
    if (test == 0)
    {
...
static void PopulateFOTAData(void)
{
    ...
    char output_array_update_background[] = "const U8 FOTA_PBAR_IMG_DATA[] = ";
    char output_array_update_fail[] = "const U8 FOTA_FAIL_IMG_DATA[] = ";
    /*----------------------------------------------------------------*/
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
