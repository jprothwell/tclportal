...
void SSCHandleLngKannada(void)
{
    ...
    for (count = 0; count < MAX_LANGUAGES; count++)
    {
        if (strcmp((PS8) gLanguageArray[count].aLangSSC, SSC_KANNADA) == 0)
        {
            ...
            DisplayPopup(
                (U8*) GetString(SSC_SCR_LANGUAGE_KANNADA_STR_ID),
                IMG_GLOBAL_ACTIVATED,
                1,
                SSC_POP_UP_TIME,
                (U8) SUCCESS_TONE);
    ...
    DisplayPopup((U8*) GetString(SSC_STR_ERR_SET_KANNADA), IMG_GLOBAL_WARNING, 0, SSC_POP_UP_TIME, (U8) ERROR_TONE);
}
...
void SSCHandleLngGujarati(void)
{
    ...
    for (count = 0; count < MAX_LANGUAGES; count++)
    {
        if (strcmp((PS8) gLanguageArray[count].aLangSSC, SSC_GUJARATI) == 0)
        {
            ...
            DisplayPopup(
                (U8*) GetString(SSC_SCR_LANGUAGE_GUJARATI_STR_ID),
                IMG_GLOBAL_ACTIVATED,
                1,
                SSC_POP_UP_TIME,
                (U8) SUCCESS_TONE);
    ...
    DisplayPopup((U8*) GetString(SSC_STR_ERR_SET_GUJARATI), IMG_GLOBAL_WARNING, 0, SSC_POP_UP_TIME, (U8) ERROR_TONE);
}
...
void SSCHandleLngXhosa(void)
{
    ...
    for (count = 0; count < MAX_LANGUAGES; count++)
    {
        if (strcmp((PS8) gLanguageArray[count].aLangSSC, SSC_XHOSA) == 0)
        {
            ...
            DisplayPopup(
                (U8*) GetString(SSC_SCR_LANGUAGE_XHOSA_STR_ID),
                IMG_GLOBAL_ACTIVATED,
                1,
                SSC_POP_UP_TIME,
                (U8) SUCCESS_TONE);
    ...
    DisplayPopup((U8*) GetString(SSC_STR_ERR_SET_XHOSA), IMG_GLOBAL_WARNING, 0, SSC_POP_UP_TIME, (U8) ERROR_TONE);
}
...
void SSCHandleLngSwahili(void)
{
    ...
    for (count = 0; count < MAX_LANGUAGES; count++)
    {
        if (strcmp((PS8) gLanguageArray[count].aLangSSC, SSC_SWAHILI) == 0)
        {
            ...
            DisplayPopup(
                (U8*) GetString(SSC_SCR_LANGUAGE_SWAHILI_STR_ID),
                IMG_GLOBAL_ACTIVATED,
                1,
                SSC_POP_UP_TIME,
                (U8) SUCCESS_TONE);
    ...
    DisplayPopup((U8*) GetString(SSC_STR_ERR_SET_SWAHILI), IMG_GLOBAL_WARNING, 0, SSC_POP_UP_TIME, (U8) ERROR_TONE);
}
...
void SSCHandleLngAfrikaans(void)
{
    ...
    for (count = 0; count < MAX_LANGUAGES; count++)
    {
        if (strcmp((PS8) gLanguageArray[count].aLangSSC, SSC_AFRIKAANS) == 0)
        {
            ...
            DisplayPopup(
                (U8*) GetString(SSC_SCR_LANGUAGE_AFRIKAANS_STR_ID),
                IMG_GLOBAL_ACTIVATED,
                1,
                SSC_POP_UP_TIME,
                (U8) SUCCESS_TONE);
    ...
    DisplayPopup((U8*) GetString(SSC_STR_ERR_SET_AFRIKAANS), IMG_GLOBAL_WARNING, 0, SSC_POP_UP_TIME, (U8) ERROR_TONE);
}
...
void SSCHandleLngZulu(void)
{
    ...
    for (count = 0; count < MAX_LANGUAGES; count++)
    {
        if (strcmp((PS8) gLanguageArray[count].aLangSSC, SSC_ZULU) == 0)
        {
            ...
            DisplayPopup(
                (U8*) GetString(SSC_SCR_LANGUAGE_ZULU_STR_ID),
                IMG_GLOBAL_ACTIVATED,
                1,
                SSC_POP_UP_TIME,
                (U8) SUCCESS_TONE);
    ...
    DisplayPopup((U8*) GetString(SSC_STR_ERR_SET_ZULU), IMG_GLOBAL_WARNING, 0, SSC_POP_UP_TIME, (U8) ERROR_TONE);
}
...
void SSCHandleLngLithuanian(void)
{
    ...
    for (count = 0; count < MAX_LANGUAGES; count++)
    {
        if (strcmp((PS8) gLanguageArray[count].aLangSSC, SSC_LITHUANIAN) == 0)
        {
            ...
            DisplayPopup(
                (U8*) GetString(SSC_SCR_LANGUAGE_LITHUANIAN_STR_ID),
                IMG_GLOBAL_ACTIVATED,
                1,
                SSC_POP_UP_TIME,
                (U8) SUCCESS_TONE);
    ...
    DisplayPopup((U8*) GetString(SSC_STR_ERR_SET_LITHUANIAN), IMG_GLOBAL_WARNING, 0, SSC_POP_UP_TIME, (U8) ERROR_TONE);
}
...
void SSCHandleLngLatvian(void)
{
    ...
    for (count = 0; count < MAX_LANGUAGES; count++)
    {
        if (strcmp((PS8) gLanguageArray[count].aLangSSC, SSC_LATVIAN) == 0)
        {
            ...
            DisplayPopup(
                (U8*) GetString(SSC_SCR_LANGUAGE_LATVIAN_STR_ID),
                IMG_GLOBAL_ACTIVATED,
                1,
                SSC_POP_UP_TIME,
                (U8) SUCCESS_TONE);
    ...
    DisplayPopup((U8*) GetString(SSC_STR_ERR_SET_LATVIAN), IMG_GLOBAL_WARNING, 0, SSC_POP_UP_TIME, (U8) ERROR_TONE);
}
...
void SSCHandleLngEstonian(void)
{
    ...
    for (count = 0; count < MAX_LANGUAGES; count++)
    {
        if (strcmp((PS8) gLanguageArray[count].aLangSSC, SSC_ESTONIAN) == 0)
        {
            ...
            DisplayPopup(
                (U8*) GetString(SSC_SCR_LANGUAGE_ESTONIAN_STR_ID),
                IMG_GLOBAL_ACTIVATED,
                1,
                SSC_POP_UP_TIME,
                (U8) SUCCESS_TONE);
    ...
    DisplayPopup((U8*) GetString(SSC_STR_ERR_SET_ESTONIAN), IMG_GLOBAL_WARNING, 0, SSC_POP_UP_TIME, (U8) ERROR_TONE);
}
...
void SSCHandleLngArmenian(void)
{
    ...
    for (count = 0; count < MAX_LANGUAGES; count++)
    {
        if (strcmp((PS8) gLanguageArray[count].aLangSSC, SSC_ARMENIAN) == 0)
        {
            ...
            DisplayPopup(
                (U8*) GetString(SSC_SCR_LANGUAGE_ARMENIAN_STR_ID),
                IMG_GLOBAL_ACTIVATED,
                1,
                SSC_POP_UP_TIME,
                (U8) SUCCESS_TONE);
    ...
    DisplayPopup((U8*) GetString(SSC_STR_ERR_SET_ARMENIAN), IMG_GLOBAL_WARNING, 0, SSC_POP_UP_TIME, (U8) ERROR_TONE);
}
...
void SSCHandleLngGeorgian(void)
{
    ...
    for (count = 0; count < MAX_LANGUAGES; count++)
    {
        if (strcmp((PS8) gLanguageArray[count].aLangSSC, SSC_GEORGIAN) == 0)
        {
            ...
            DisplayPopup(
                (U8*) GetString(SSC_SCR_LANGUAGE_GEORGIAN_STR_ID),
                IMG_GLOBAL_ACTIVATED,
                1,
                SSC_POP_UP_TIME,
                (U8) SUCCESS_TONE);
    ...
    DisplayPopup((U8*) GetString(SSC_STR_ERR_SET_GEORGIAN), IMG_GLOBAL_WARNING, 0, SSC_POP_UP_TIME, (U8) ERROR_TONE);
}
...
void SSCHandleLngMoldovan(void)
{
    ...
    for (count = 0; count < MAX_LANGUAGES; count++)
    {
        if (strcmp((PS8) gLanguageArray[count].aLangSSC, SSC_MOLDOVAN) == 0)
        {
            ...
            DisplayPopup(
                (U8*) GetString(SSC_SCR_LANGUAGE_MOLDOVAN_STR_ID),
                IMG_GLOBAL_ACTIVATED,
                1,
                SSC_POP_UP_TIME,
                (U8) SUCCESS_TONE);
    ...
    DisplayPopup((U8*) GetString(SSC_STR_ERR_SET_MOLDOVAN), IMG_GLOBAL_WARNING, 0, SSC_POP_UP_TIME, (U8) ERROR_TONE);
}
...
void SendReqPIN1Status(void)
{
    ...
    {
        DisplayPopup((U8*) GetString(STR_INCORRECT_SSC), IMG_GLOBAL_WARNING, 0, SSC_POP_UP_TIME, (U8) WARNING_TONE);
    }
    else
    {
...
void SSCChangePIN2(void *info)
{
    ...
    {
        DisplayPopup((PU8) GetString(STR_SETTING_PIN2_BLOCK_TITLE), IMG_GLOBAL_WARNING, 0, SSC_POP_UP_TIME, WARNING_TONE);
    }
