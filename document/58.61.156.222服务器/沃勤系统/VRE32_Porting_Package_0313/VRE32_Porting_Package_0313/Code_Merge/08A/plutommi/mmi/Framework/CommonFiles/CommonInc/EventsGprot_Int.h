...
typedef MMI_BOOL (*vreFuncPtr)(void);
extern void vre_mmi_frm_set_protocol_event_handler(PsFuncPtr funcPtr, U16 eventID, vreFuncPtr vrePtr);
extern void vre_mmi_frm_clear_protocol_event_handler(U16 eventID);
#endif
/* Vogins End */
