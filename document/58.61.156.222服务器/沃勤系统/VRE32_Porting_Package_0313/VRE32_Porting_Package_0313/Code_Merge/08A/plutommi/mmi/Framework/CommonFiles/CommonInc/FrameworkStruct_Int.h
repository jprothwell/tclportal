...
/* Vogins Start */
#ifdef __VRE_V30__
    PsFuncPtr entryFuncPtr2; //avoid multi-register conflict 
#endif
/* Vogins End */
...
typedef struct
{
    ...
    U8  end_key_flag;                           /* Keep END_KEY handlers' flag if full control by applications */
    
    U16 currKeyCode;    /* Keep the current key code */
    U16 currKeyType;    /* Keep the current key type */
