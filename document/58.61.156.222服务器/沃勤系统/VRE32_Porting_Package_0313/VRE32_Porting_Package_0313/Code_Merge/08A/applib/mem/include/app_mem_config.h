...
/********* INSERT NEW APPLICATION HERE *********/
         ...
         #define APPMEM_PHOEDT_POOL_SIZE (240*400*2*2)
     #else
         #error "[photo editor]Please add new memory configuration according to new LCD resolution"
     #endif
    ...
    #define APPMEM_MMS_VIEWER_POOL_SIZE (MMI_MV_ASM_MEM_POOL_SIZE)
...
/* Camera */
    ...
    #define APPMEM_CAMCO_POOL_SIZE  MMI_CAMCO_APP_MEM_SIZE
...
#endif
/* Vogins Start */
#if defined(__VRE_V2X__) && !defined(__VRE_MEDIA_BUF__)
	#include "vmopt.h"
	#define APPMEM_VRE_POOL_SIZE	VRE_SYS_MEMPOOL_SIZE
#endif
#if defined(__VRE_V30__)
	#include "vmopt.h"
	#include "AMGprot.h"
	#define APPMEM_VRE_POOL_SIZE	VRE_SYS_ASM_MEMPOOL_SIZE
#endif
 ...
 *****************************************************************************/
/* Vogins Start */
#if !defined(APPMEM_VRE_POOL_SIZE)
	#define APPMEM_VRE_POOL_SIZE  (0)
#endif
/* Vogins End */
...
#if !defined(APPMEM_CAMCO_POOL_SIZE)
    #define APPMEM_CAMCO_POOL_SIZE (0)
#endif
...
/* Vogins Start */
#if defined(__VRE_V2X__) && !defined(__VRE_MEDIA_BUF__)
    kal_uint8 APP_VRE[APPLIB_MEM_AP_POOL_SIZE_CONFIG(APPMEM_VRE_POOL_SIZE)];
#endif
#if defined(__VRE_V30__)
    kal_uint8 APP_VRE[APPLIB_MEM_AP_POOL_SIZE_CONFIG(APPMEM_VRE_POOL_SIZE)];
#endif
#if defined(__VRE30_AM__)
	kal_uint8 APP_AM[APPLIB_MEM_CONC2_AP_POOL_SIZE(APPMEM_AM_POOL_SIZE, APPMEM_VRE_POOL_SIZE)];
#endif
/* Vogins End */
} app_asm_pool_union;
...
#define APPLIB_MEM_AP_POOL_SIZE sizeof(app_asm_pool_union)
    ...
    #define APPLIB_MEM_AP_FBBR_TOTAL_POOL_SIZE sizeof(app_asm_pool_union) + APPMEM_JAVA_POOL_SIZE
#endif
