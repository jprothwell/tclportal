...
typedef enum
{
    VA_XG_DOCTYPE_PUBLIC = 0,  /* used to generate PUBLIC mark */
    VA_XG_DOCTYPE_SYSTEM = 1   /* used to generate SYSTEM mark */
}va_xg_doctype_mark_enum;

/* define element start or end mark */
typedef enum 
{
    VA_START_TAG_TYPE = 0, /* used to generate the start mark of element */
    VA_END_TAG_TYPE,       /* used to generate the end mark of element */
    VA_TOTAL_TAG_TYPE      /* used to check validity */
}va_search_type_enum;

/* file handle */
typedef kal_int8 VA_XG_HANDLE;


/*****************************************************************************
 * FUNCTION
 *  va_xml_new_generator
 * DESCRIPTION
 ...
 *****************************************************************************/
extern VA_XG_HANDLE va_xml_new_generator(kal_char* dest, kal_uint32 length);


/*****************************************************************************
 * FUNCTION
 *  va_xml_close_generator
 * DESCRIPTION
 ...
 *****************************************************************************/
extern kal_int32 va_xml_close_generator(VA_XG_HANDLE hd);


/*****************************************************************************
 * FUNCTION
 *  va_xml_generate_xmldecl
 * DESCRIPTION
 ...
 *  encode:  [IN]    encoding type, is a value of VA_XML_ENCODING_TYPE_ENUM
 * RETURN VALUES
 *  <0: means failed, returns error code;
 *  0 :  means succeed;
 *****************************************************************************/
extern kal_int32 va_xml_generate_xmldecl(
                    VA_XG_HANDLE hd,
                    const kal_char *verstr,
                    VA_XML_ENCODING_TYPE_ENUM encode);


/*****************************************************************************
 * FUNCTION
 *  va_xml_generate_doctypedecl
 * DESCRIPTION
 ...
 *  0 :  means succeed;
 *****************************************************************************/
extern kal_int32 va_xml_generate_doctypedecl(
                    VA_XG_HANDLE hd,
                    const kal_char* name,
                    va_xg_doctype_mark_enum mark,
                    const kal_char* externalid);


/*****************************************************************************
 * FUNCTION
 *  va_xml_generate_doctypedecl_ex
 * DESCRIPTION
 ...
 *  0 :  means succeed;
 *****************************************************************************/
extern kal_int32 va_xml_generate_doctypedecl_ex(
                    VA_XG_HANDLE hd,
                    const kal_char* name,
                    kal_char* dtd,
                    kal_uint32 len_dtd);
 ...
 *  0 :  means succeed;
 *****************************************************************************/
extern kal_int32 va_xml_generate_stag(
                    VA_XG_HANDLE hd,
                    const kal_char* el,
 ...
 *  0 :  means succeed;
 *****************************************************************************/
extern kal_int32 va_xml_generate_data(VA_XG_HANDLE hd, kal_char* data, kal_uint32 datalen);


/*****************************************************************************
 * FUNCTION
 *  va_xml_generate_Cdata
 * DESCRIPTION
 ...
 *  0 :  means succeed;
 *****************************************************************************/
extern kal_int32 va_xml_generate_Cdata(VA_XG_HANDLE hd, kal_char* cdata, kal_uint32 datalen);


/*****************************************************************************
 * FUNCTION
 *  va_xml_generate_etag
 * DESCRIPTION
 ...
 *  0 :  means succeed;
 *****************************************************************************/
extern kal_int32 va_xml_generate_etag(VA_XG_HANDLE hd, const kal_char* el);
 ...
 *  0 :  means succeed;
 *****************************************************************************/
extern kal_int32 va_xml_generate_inline_element(
                    VA_XG_HANDLE hd,
                    const kal_char* el,
                    kal_char* data,
                    kal_uint32 datalen);
 ...
 *  0 :  means succeed;
 *****************************************************************************/
extern kal_int32 va_xml_generate_empty_element(
                    VA_XG_HANDLE hd,
                    const kal_char* el,
                    va_xg_attr_struct* attrlist,
                    kal_uint32 num_attr);
 ...
 *  0 or >0:  means succeed;
 *****************************************************************************/
VA_XG_HANDLE va_xml_new_generator_file(FS_HANDLE fh);
