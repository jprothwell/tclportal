...
#include "vaxmlgen_common.h"

/* define data type */
typedef enum{
    VA_WBXML_DATA_TYPE_STRING, /* string */
    VA_WBXML_DATA_TYPE_OPAQUE  /* qpaque */
}va_wbxml_data_type_enum;

/* define charset type */
typedef enum{
    VA_WBXML_CHARSET_ISO_8859_1,   /* iso-8859-1 */
    VA_WBXML_CHARSET_ISO_8859_2,   /* iso-8859-2 */
    VA_WBXML_CHARSET_ISO_8859_3,   /* iso-8859-3 */
    VA_WBXML_CHARSET_ISO_8859_4,   /* iso-8859-4 */
    VA_WBXML_CHARSET_ISO_8859_5,   /* iso-8859-5 */
    VA_WBXML_CHARSET_ISO_8859_6,   /* iso-8859-6 */
    VA_WBXML_CHARSET_ISO_8859_7,   /* iso-8859-7 */
    VA_WBXML_CHARSET_ISO_8859_8,   /* iso-8859-8 */
    VA_WBXML_CHARSET_ISO_8859_9,   /* iso-8859-9 */
    VA_WBXML_CHARSET_SHIFT_JIS,    /* shift-jis */
    VA_WBXML_CHARSET_US_ASCII,     /* us-ascii */
    VA_WBXML_CHARSET_UTF_8         /* utf-8 */
}va_wbxml_charset_type_enum;

/* file handle */
typedef kal_int8 VA_WG_HANDLE;
 ...
 *  >0: success
 *****************************************************************************/
typedef kal_int32 (*va_wbxml_get_token_by_tagname)(
 ...
 *
 * FUNCTION
 *  va_wbxml_get_token_by_attrname
 * DESCRIPTION
 ...
 *  >0: success
 *****************************************************************************/
typedef kal_int32 (*va_wbxml_get_token_by_attrname)(
 ...
 *
 * FUNCTION
 *  va_wbxml_get_token_by_attrvalue
 * DESCRIPTION
 *  this function is used to get attrname by token 
 * PARAMETERS
 ...
 *  >0: success
 *****************************************************************************/
typedef kal_int32 (*va_wbxml_get_token_by_attrvalue)(
 ...
 *****************************************************************************/
extern VA_WG_HANDLE va_wbxml_new_generator(kal_char* dest, kal_uint32 length);


/*****************************************************************************
 * FUNCTION
 *  va_wbxml_close_generator
 * DESCRIPTION
 ...
 *****************************************************************************/
extern kal_int32 va_wbxml_close_generator(VA_WG_HANDLE hd);


/*****************************************************************************
* FUNCTION
*  va_wbxml_register_get_token_handler
* DESCRIPTION
...
*  void
*****************************************************************************/
extern void va_wbxml_register_get_token_handler(
                VA_WG_HANDLE  handle,
                va_wbxml_get_token_by_tagname get_token_by_tagname,
                va_wbxml_get_token_by_attrname get_token_by_attrname,
                va_wbxml_get_token_by_attrvalue get_token_by_attrvalue);


/*****************************************************************************
 * FUNCTION
 *  va_wbxml_generate_header
 * DESCRIPTION
 ...
 *  0 :  means succeed;
 *****************************************************************************/
extern kal_int32 va_wbxml_generate_header(
                    VA_WG_HANDLE hd,
                    kal_uint8 mainver,
                    kal_uint8 subver,
                    const kal_char* publicid,
                    va_wbxml_charset_type_enum charset);


/*****************************************************************************
 * FUNCTION
 *  va_wbxml_generate_stag
 * DESCRIPTION
 ...
 *  0 :  means succeed;
 *****************************************************************************/
extern kal_int32 va_wbxml_generate_stag(
                    VA_WG_HANDLE hd,
                    const kal_char* el,
                    va_xg_attr_struct* attrlist,
                    kal_uint32 num_attr,
                    kal_bool iscontent);
...
*  0 :  means succeed;
 *****************************************************************************/
extern kal_int32 va_wbxml_generate_data(
                    VA_WG_HANDLE hd,
                    kal_char* data,
                    kal_uint32 datalen,
                    va_wbxml_data_type_enum data_type);


/*****************************************************************************
 * FUNCTION
 *  va_wbxml_generate_empty_element
 * DESCRIPTION
 ...
 *  0 :  means succeed;
 *****************************************************************************/
extern kal_int32 va_wbxml_generate_empty_element(
                    VA_WG_HANDLE hd,
                    const kal_char* el,
                    va_xg_attr_struct* attrlist,
                    kal_uint32 num_attr);
...
/*****************************************************************************
 * FUNCTION
 *  va_xml_generate_inline_element
 * DESCRIPTION
 ...
 *  0 :  means succeed;
 *****************************************************************************/
extern kal_int32 va_wbxml_generate_inline_element(
                    VA_WG_HANDLE hd,
                    const kal_char* el,
                    kal_char* data,
                    kal_uint32 datalen,
 ...
 *  0 :  means succeed;
 *****************************************************************************/
extern kal_int32 va_wbxml_generate_etag(VA_WG_HANDLE hd, const kal_char* el);
