...
#define VA_WBXML_GT_SWITCH_PAGE        0x00
#define VA_WBXML_GT_END                0x01
#define VA_WBXML_GT_ENTITY             0x02
#define VA_WBXML_GT_STR_I              0x03
#define VA_WBXML_GT_LITERAL            0x04
#define VA_WBXML_GT_EXT_I_0            0x40
#define VA_WBXML_GT_EXT_I_1            0x41
#define VA_WBXML_GT_EXT_I_2            0x42
#define VA_WBXML_GT_PI                 0x43
#define VA_WBXML_GT_LITERAL_C          0x44
#define VA_WBXML_GT_EXT_T_0            0x80
#define VA_WBXML_GT_EXT_T_1            0x81
#define VA_WBXML_GT_EXT_T_2            0x82
#define VA_WBXML_GT_STR_T              0x83
#define VA_WBXML_GT_LITERAL_A          0x84
#define VA_WBXML_GT_EXT_0              0xC0
#define VA_WBXML_GT_EXT_1              0xC1
#define VA_WBXML_GT_EXT_2              0xC2
#define VA_WBXML_GT_OPAQUE             0xC3
#define VA_WBXML_GT_LITERAL_AC         0xC4


#define VA_WBXML_MAX_BUFFER_SIZE   (2048)
#define VA_WBXML_MAX_ATTR_COUNT    (20)
#define VA_WBXML_MAX_ELEM_DEPTH    (10)
#define VA_WBXML_MAX_HANDLE_NUM    (10)

#define VA_WBXML_NUM_PUBLICID      (14)
/* DOM-NOT_FOR_SDK-END */

/* this struct is used to parse wbxml */
typedef struct 
{
    va_wbxml_header_hdlr  header_hdlr;             /* header handler */
    va_wbxml_stag_hdlr    stag_hdlr;               /* Start tag handler */
    va_wbxml_end_elem_hdlr    end_elem_hdlr;       /* end tag handler */
    va_wbxml_data_hdlr    data_hdlr;               /* data handler */
    va_wbxml_get_tagname_by_token get_tagname_by_token;    /* Get tagname through tagtoken */
    va_wbxml_get_attrname_by_token get_attrname_by_token;  /* Get attrstart and attrvalue through tagtoken */
    va_wbxml_malloc_buffer_ptr get_buffer_ptr;     /* Malloc function */ 
    va_wbxml_free_buffer_ptr free_buffer_ptr;      /* Free function */
    ...
    kal_char    *tagstack[VA_WBXML_MAX_ELEM_DEPTH];/* tag stack to be parsed */
