...
#define     VA_XG_MAX_HANDLE_NUM   (10)
#define     VA_XG_MAX_ELEM_DEPTH   (20)
#define     VA_XG_BUFFER_SIZE      (512)

#define     VA_XG_MAX_CHARSET_LEN  (20)
#define     VA_XG_MAX_VERSTR_LEN   (8)
#define     VA_XG_MAX_DISK_NAME    (20)
#define     VA_XG_MAX_NAME_EXTERNALID_LEN   (VA_XG_BUFFER_SIZE-100)

#define    VA_CONVERT_BUF_SIZE     (128)
/* DOM-NOT_FOR_SDK-END */
...
typedef struct
{
    ...
    kal_char    * tagstack[VA_XG_MAX_ELEM_DEPTH];  /* Tag stack */
...
extern kal_uint32 va_xml_generate_convert_named_char(
                    va_xml_generator_struct *p,
                    char **dest,
                    kal_uint32 len);
/* DOM-NOT_FOR_SDK-END */
