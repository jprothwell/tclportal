...
//vogins_20100630_start
#define AM_DOWNLOAD_QUERY
//vogins_20100630_end
/***************************************************************************** 
* Typedef 
*****************************************************************************/
...
typedef struct
{
    ...
    sml_list_t *app_list;           /* current page apps - mmi_am_ms_app_struct */
...
typedef struct
{
    ...
    U16 bg_memory_size;          /*is background app memroy size *kb*/
...
extern MMI_BOOL mmi_am_ms_is_rom_app_by_path(U16 *app_path);
/*Vogins_20100710_end*/
...
extern S32 mmi_am_ms_get_actual_index(S32 idx);
extern U32 mmi_am_binary_search(S32 low, S32 high, FS_DOSDateTime *modify_time);
/*Vogins_20100625_end*/
/*Vogins_20100710_start*/
extern void mmi_am_shortcut_reorder(S32 index);
extern void mmi_am_get_sc_and_rom_bg_num(S32* num_sc_bg_run, S32* num_rom_bg_run);
/*Vogins_20100710_end*/
